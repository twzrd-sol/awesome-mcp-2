...
1. **[everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 176,912
   The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.

2. **[dify](https://github.com/langgenius/dify)** - ⭐ 140,746
   Production-ready platform for agentic workflow development.

3. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 136,344
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

4. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 103,559
   An open-source AI agent that brings the power of Gemini directly into your terminal.

5. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 86,581
   A collection of MCP servers.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 85,346
   Model Context Protocol Servers

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 78,943
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[netdata](https://github.com/netdata/netdata)** - ⭐ 78,760
   The fastest path to AI-powered full stack observability, even for lean teams.

9. **[lobehub](https://github.com/lobehub/lobehub)** - ⭐ 76,772
...
11. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 65,144
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode, openclaw & Gemini CLI.

12. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 59,786
   The all-in-one AI productivity accelerator. On device and privacy first with no annoying setup or configuration.

13. **[awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** - ⭐ 58,983
   A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows

14. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 57,139
   ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS, and smart alerts.🎯 告别信息过载，你的 AI 舆情监控助手与热点筛选工具！聚合多平台热点 +  RSS 订阅，支持关键词精准筛选。AI 智能筛选新闻 + AI 翻译 +  AI 分析简报直推手机，也支持接入 MCP 架构，赋能 AI 自然语言对话分析、情感洞察与趋势预测等。支持 Docker ，数据本地/云端自持。集成微信/飞书/钉钉/Telegram/邮件/ntfy/bark/slack 等渠道智能推送。

15. **[context7](https://github.com/upstash/context7)** - ⭐ 54,895
   Context7 Platform -- Up-to-date code documentation for LLMs and AI code editors

16. **[mempalace](https://github.com/MemPalace/mempalace)** - ⭐ 51,784
   The best-benchmarked open-source AI memory system. And it's free.

17. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 48,305
   🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!

18. **[ruflo](https://github.com/ruvnet/ruflo)** - ⭐ 47,946
...
19. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 46,147
   AI低代码平台，支持「低代码 + 零代码」双模式：零代码 5 分钟搭建业务系统，低代码模式一键生成前后端代码。 内置AI 应用，支持AI聊天、知识库、流程编排、MCP与插件，支持各种模型。Skills能力实现：一句话画流程图、设计表单、生成系统。 引领 AI生成→在线配置→代码生成→手工合并的开发模式，解决Java项目80%的重复工作，快速提高效率，又不失灵活性。

20. **[mempalace](https://github.com/milla-jovovich/mempalace)** - ⭐ 40,200
   The highest-scoring AI memory system ever benchmarked. And it's free.

21. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 38,894
...
24. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 36,977
   Installable GitHub library of 1,400+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and more. Includes installer CLI, bundles, workflows, and official/community skill collections.

25. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 36,793
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

26. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 34,858
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

27. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 33,624
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

28. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 33,113
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

29. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,931
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

30. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 32,277
   Playwright MCP server

31. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 31,742
   AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨

32. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 31,542
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

33. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 29,668
   GitHub's official MCP Server

34. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 28,134
   Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you build AI agents that turn intent into action.

35. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 26,962
   An autonomous agent that conducts deep research on any data using any LLM providers

36. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 26,289
   An MCP-based chatbot | 一个基于MCP的聊天机器人

37. **[fastmcp](https://github.com/PrefectHQ/fastmcp)** - ⭐ 25,093
   🚀 The fast, Pythonic way to build MCP servers and clients.

38. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 24,766
   Build and run agents you can see, understand and trust.

39. **[gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin)** - ⭐ 24,663
...
40. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 24,551
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

41. **[serena](https://github.com/oraios/serena)** - ⭐ 24,018
   A powerful MCP toolkit for coding, providing semantic retrieval and editing capabilities  - the IDE for your agent

42. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 23,728
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

43. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 22,928
   The official Python SDK for Model Context Protocol servers and clients

44. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,902
   🚀 The fast, Pythonic way to build MCP servers and clients

45. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 22,123
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

46. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 21,495

47. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 20,906
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

48. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 20,462
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

49. **[Agent-Reach](https://github.com/Panniantong/Agent-Reach)** - ⭐ 19,087
   Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.

50. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 18,981
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

51. **[page-agent](https://github.com/alibaba/page-agent)** - ⭐ 17,708
   JavaScript in-page GUI agent. Control web interfaces with natural language.

52. **[nuclear](https://github.com/nukeop/nuclear)** - ⭐ 17,505
   Streaming music player that finds free music for you

53. **[openfang](https://github.com/RightNow-AI/openfang)** - ⭐ 17,325
   Open-source Agent Operating System

54. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 16,286
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

55. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 16,057
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

56. **[code-review-graph](https://github.com/tirth8205/code-review-graph)** - ⭐ 15,976
   Local knowledge graph for Claude Code. Builds a persistent map of your codebase so Claude reads only what matters — 6.8× fewer tokens on reviews and up to 49× on daily coding tasks.

57. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 15,103
   🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade architecture, distributed swarm intelligence, RAG integration, and native Claude Code / Codex Integration

58. **[mcp-toolbox](https://github.com/googleapis/mcp-toolbox)** - ⭐ 15,100
   MCP Toolbox for Databases is an open source MCP server for databases.

59. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 14,844
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

60. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 14,691
   MCP server to provide Figma layout information to AI coding agents like Cursor

61. **[context-mode](https://github.com/mksglu/context-mode)** - ⭐ 14,186
   Context window optimization for AI coding agents. Sandboxes tool output, 98% reduction. 14 platforms

62. **[electerm](https://github.com/electerm/electerm)** - ⭐ 14,064
...
64. **[casdoor](https://github.com/casdoor/casdoor)** - ⭐ 13,578
   An open-source Agent-first Identity and Access Management (IAM) /LLM MCP & agent gateway and auth server with web UI supporting OpenClaw, MCP, OAuth, OIDC, SAML, CAS, LDAP, SCIM, WebAuthn, TOTP, MFA, Face ID, Google Workspace, Azure AD

65. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 13,574
   Memory for 24/7 proactive agents like OpenClaw.

66. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 13,435
   MCP for xiaohongshu.com

67. **[filestash](https://github.com/mickael-kerjean/filestash)** - ⭐ 13,423
   :file_folder: What Dropbox should have been if it was based on SFTP, S3, FTP, SMB, NFS, WebDAV, Git, and more

68. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 13,388
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

69. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 12,389
   The official TypeScript SDK for Model Context Protocol servers and clients

70. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 12,059
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

71. **[kubeshark](https://github.com/kubeshark/kubeshark)** - ⭐ 11,895
   eBPF-powered network observability for Kubernetes. Indexes L4/L7 traffic with full K8s context, decrypts TLS without keys. Queryable by AI agents via MCP and humans via dashboard.

72. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,855
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

73. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 11,658
   A blazing fast AI Gateway with integrated guardrails. Route to 1,600+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

74. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 11,573
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

75. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 11,525
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

76. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 11,130
   Yet another WebUI for Nginx

77. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 11,111
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书作品文件

78. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 10,903
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

79. **[superset](https://github.com/superset-sh/superset)** - ⭐ 10,539
   Code Editor for the AI Agents Era - Run an army of Claude Code, Codex, etc. on your machine

80. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 9,918
   The fullstack MCP framework to develop MCP Apps for ChatGPT / Claude & MCP Servers for AI Agents.

81. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

82. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 9,702
   Visual testing tool for MCP servers

83. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 9,490
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

84. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 9,426
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

85. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 9,009
   Open source MCP Servers for AWS

86. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 8,998
   Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% token savings

87. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 8,812
   MCP Server for Ghidra

88. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 8,731
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

89. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 8,680
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

90. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 8,647
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

91. **[Auto-claude-code-research-in-sleep](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep)** - ⭐ 8,589
   ARIS ⚔️ (Auto-Research-In-Sleep) — Lightweight Markdown-only skills for autonomous ML research: cross-model review loops, idea discovery, and experiment automation. No framework, no lock-in — works with Claude Code, Codex, OpenClaw, or any LLM agent.

92. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 8,371
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

93. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 8,313
   Build effective agents using Model Context Protocol and simple workflow patterns

94. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 8,268
   A polyglot document intelligence framework with a Rust core. Extract text, metadata, images, and structured information from PDFs, Office documents, images, and 97+ formats. Available for Rust, Python, Ruby, Java, Go, PHP, Elixir, C#, R, C, TypeScript (Node/Bun/Wasm/Deno)- or use via CLI, REST API, or MCP server.

95. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 8,251
   🧑‍🚀 全世界最好的LLM资料总结（多模态生成、Agent、辅助编程、AI审稿、数据处理、模型训练、模型推理、o1 模型、MCP、小语言模型、视觉语言模型） | Summary of the world's best LLM resources. 

96. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 8,056
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

97. **[webiny-js](https://github.com/webiny/webiny-js)** - ⭐ 7,973
   Open-source, self-hosted CMS platform on AWS serverless (Lambda, DynamoDB, S3). TypeScript framework with multi-tenancy, lifecycle hooks, GraphQL API, and AI-assisted development via MCP server. Built for developers at large organizations.

98. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,841
   Build autonomous AI agents in Python.

99. **[oh-my-opencode](https://github.com/code-yeongyu/oh-my-opencode)** - ⭐ 7,289
...
100. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 7,213
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

101. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 7,038
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

102. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,792
   A community driven registry service for Model Context Protocol (MCP) servers.

103. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,741
   TalkToFigma: MCP integration between AI Agent (Cursor, Claude Code) and Figma, allowing Agentic AI to communicate with Figma for reading designs and modifying them programmatically.

104. **[ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch)** - ⭐ 6,635
   Learn it. Build it. Ship it for others.

105. **[Vibe-Trading](https://github.com/HKUDS/Vibe-Trading)** - ⭐ 6,596
   "Vibe-Trading: Your Personal Trading Agent"

106. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 6,477
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

107. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,418
   A collection of MCP clients.

108. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 6,259
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

109. **[Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills)** - ⭐ 6,146
   754 structured cybersecurity skills for AI agents · Mapped to 5 frameworks: MITRE ATT&CK, NIST CSF 2.0, MITRE ATLAS, D3FEND & NIST AI RMF · agentskills.io standard · Works with Claude Code, GitHub Copilot, Codex CLI, Cursor, Gemini CLI & 20+ platforms · 26 security domains · Apache 2.0

110. **[refly](https://github.com/refly-ai/refly)** - ⭐ 6,135
   The first open-source agent skills builder. 🦞

111. **[open-multi-agent](https://github.com/open-multi-agent/open-multi-agent)** - ⭐ 6,086
...
112. **[open-multi-agent](https://github.com/JackChen-me/open-multi-agent)** - ⭐ 6,083
   From a goal to a task DAG, automatically. TypeScript-native multi-agent orchestration with MCP and live tracing. Three runtime dependencies.

113. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 6,018
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

114. **[microsandbox](https://github.com/superradcompany/microsandbox)** - ⭐ 6,008
   🧱 secure, local and programmable sandboxes for AI agents

115. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,931
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

116. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 5,828
   A model-driven approach to building AI agents in just a few lines of code.

117. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,734
   Klavis AI:  MCP integration platforms that let AI agents use tools reliably at any scale

118. **[CodePilot](https://github.com/op7418/CodePilot)** - ⭐ 5,658
...
119. **[jscpd](https://github.com/kucherenko/jscpd)** - ⭐ 5,619
   Copy/paste detector for programming source code. 

120. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,594
   WhatsApp MCP server

121. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 5,538
   [GitHub Trending #2] A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

122. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,527
   Awesome MCP Servers - A curated list of Model Context Protocol servers

123. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 5,522
   MCP Server for Computer Use in Windows

124. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,503
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

125. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 5,466
   Learn AI and LLMs from scratch using free resources

126. **[XcodeBuildMCP](https://github.com/getsentry/XcodeBuildMCP)** - ⭐ 5,465
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

127. **[jcode](https://github.com/1jehuang/jcode)** - ⭐ 5,373
   Coding Agent Harness

128. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 5,354
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

129. **[stitch-skills](https://github.com/google-labs-code/stitch-skills)** - ⭐ 5,308
   A library of Agent Skills designed to work with the Stitch MCP server. Each skill follows the Agent Skills open standard, for compatibility with coding agents such as Antigravity, Gemini CLI, Claude Code, Cursor.

130. **[osaurus](https://github.com/osaurus-ai/osaurus)** - ⭐ 5,213
   Own your AI. The native macOS harness for AI agents -- any model, persistent memory, autonomous execution, cryptographic identity. Built in Swift. Fully offline. Open source.

131. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 5,206
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

132. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 5,174
   opensource secure local-first sandboxes for ai agents

133. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 5,136
   MCP server for Atlassian tools (Confluence, Jira)

134. **[hooker](https://github.com/CreditTone/hooker)** - ⭐ 5,113
...
135. **[bb-browser](https://github.com/epiral/bb-browser)** - ⭐ 5,036
   Your browser is the API. CLI + MCP server for AI agents to control Chrome with your login state.

136. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,001
   Install, run and deploy your own decentralized AI agent service

137. **[unidbg](https://github.com/zhkl0228/unidbg)** - ⭐ 4,952
   Allows you to emulate an Android native library, and an experimental  iOS emulation

138. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,854
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

139. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 4,841
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

140. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,807
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

141. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,792
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

142. **[aci](https://github.com/aipotheosis-labs/aci)** - ⭐ 4,764
   ACI.dev is the open source tool-calling platform that hooks up 600+ tools into any agentic IDE or custom AI agent through direct function calling or a unified MCP server. The birthplace of VibeOps.

143. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 4,747
   Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

144. **[mission-control](https://github.com/builderz-labs/mission-control)** - ⭐ 4,734
   Self-hosted AI agent orchestration platform: dispatch tasks, run multi-agent workflows, monitor spend, and govern operations from one mission control dashboard.

145. **[byterover-cli](https://github.com/campfirein/byterover-cli)** - ⭐ 4,715
   ByteRover CLI (brv) - The portable memory layer for  autonomous coding agents (formerly Cipher)

146. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 4,687
   Tutorials, Guides and Agent Skills Directories

147. **[openagent](https://github.com/the-open-agent/openagent)** - ⭐ 4,625
   ⚡️next-generation personal AI assistant powered by LLM, RAG and agent loops, supporting computer-use, browser-use and coding agent, demo: https://demo.openagentai.org

148. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 4,594
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

149. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,580
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

150. **[EverOS](https://github.com/EverMind-AI/EverOS)** - ⭐ 4,541
   Build, evaluate, and integrate long-term memory for self-evolving agents.

151. **[Olares](https://github.com/beclab/Olares)** - ⭐ 4,529
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

152. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,503
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

153. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 4,502
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

154. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 4,437
   RikkaHub is an Android APP that supports for multiple LLM providers.

155. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 4,404
   Exa MCP for web search and web crawling!

156. **[claude-seo](https://github.com/AgriciDaniel/claude-seo)** - ⭐ 4,396
   Universal SEO skill for Claude Code. 19 sub-skills, 12 subagents, 3 extensions (DataForSEO, Firecrawl, Banana). Technical SEO, E-E-A-T, schema, GEO/AEO, backlinks, local SEO, maps intelligence, Google APIs, and PDF/Excel reporting.

157. **[excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp)** - ⭐ 4,369
   Fast and streamable Excalidraw MCP App

158. **[mcporter](https://github.com/openclaw/mcporter)** - ⭐ 4,351
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

159. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 4,309
   Official Notion MCP Server

160. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 4,293
   An Agentic Framework for Reflective PowerPoint Generation

161. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 4,284
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

162. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,276
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

163. **[notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli)** - ⭐ 4,274

164. **[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** - ⭐ 4,258
...
165. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 4,253
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

166. **[oh-my-pi](https://github.com/can1357/oh-my-pi)** - ⭐ 4,209
   ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more

167. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 4,180
   A simple, secure MCP-to-OpenAPI proxy server

168. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 4,164
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

169. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 4,145
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

170. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 4,119
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

171. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 4,097
   Claude Code Guide - Setup, Commands, workflows, agents, skills & tips-n-tricks go from beginner to power user!

172. **[mcp](https://github.com/google/mcp)** - ⭐ 4,054
   Google 💚 MCP

173. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 4,050
   🤖 A visualization mcp & skills contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

174. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 4,049
   A curated list of Model Context Protocol (MCP) servers

175. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 4,020
...
176. **[directories](https://github.com/leerob/directories)** - ⭐ 3,929
   Find rules and MCP servers

177. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,898
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP, and Chatwoot. Built with Golang for efficient memory use. 

178. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,896
   The Cursor & Windsurf community, find rules and MCPs

179. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 3,877
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

180. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,866
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

181. **[ouroboros](https://github.com/Q00/ouroboros)** - ⭐ 3,849
   Agent OS: Stop prompting. Start specifying.

182. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,812
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

183. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,802
   A Model Context Protocol server for Excel file manipulation

184. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,784
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

185. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,770
   Code, Build and Evaluate agents - excellent Model and Skills/MCP/ACP Support

186. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,766
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

187. **[atmosphere](https://github.com/Atmosphere/atmosphere)** - ⭐ 3,764
...
188. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 3,727
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

189. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,726

190. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,676
   An AI Gateway, registry, and proxy that sits in front of any MCP, A2A, or REST/gRPC APIs, exposing a unified endpoint with centralized discovery, guardrails and management. Optimizes Agent & Tool calling, and supports plugins.

191. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 3,641
   A full-stack AI Red Teaming platform securing AI ecosystems via OpenClaw Security Scan, Agent Scan, Skills Scan, MCP scan, AI Infra scan and LLM jailbreak evaluation.

192. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 3,640
   Enterprise AI Platform with guardrails, MCP registry, gateway & orchestrator

193. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,637
...
194. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 3,633
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

195. **[core](https://github.com/opensumi/core)** - ⭐ 3,630
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

196. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 3,585
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

197. **[claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar)** - ⭐ 3,585
...
198. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,548
...
199. **[EverMemOS](https://github.com/EverMind-AI/EverMemOS)** - ⭐ 3,546
   A memory OS that makes your OpenClaw agents more personal while saving tokens.

200. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 3,542
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

201. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,520
   LangChain 🔌 MCP

202. **[drawio-mcp](https://github.com/jgraph/drawio-mcp)** - ⭐ 3,516

203. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,485
   Model Context Protocol(MCP) 编程极速入门

204. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 3,485
...
205. **[boost](https://github.com/laravel/boost)** - ⭐ 3,457
   Laravel-focused MCP server for augmenting your AI powered local development experience.

206. **[AionUi](https://github.com/iOfficeAI/AionUi)** - ⭐ 3,452
...
207. **[swarmpit](https://github.com/swarmpit/swarmpit)** - ⭐ 3,437
   Lightweight AI-friendly Docker Swarm management

208. **[Peekaboo](https://github.com/openclaw/Peekaboo)** - ⭐ 3,419
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

209. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,403
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

210. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 3,396
   The official Rust SDK for the Model Context Protocol

211. **[engram](https://github.com/Gentleman-Programming/engram)** - ⭐ 3,376
   Persistent memory system for AI coding agents. Agent-agnostic Go binary with SQLite + FTS5, MCP server, HTTP API, CLI, and TUI.

212. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,328
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

213. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,325
   Allow LLMs to control a browser with Browserbase and Stagehand

214. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,303
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

215. **[awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents)** - ⭐ 3,302
   162 production-ready AI agent templates for OpenClaw. SOUL.md configs across 19 categories. Submit yours!

216. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,267
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

217. **[Horizon](https://github.com/Thysrael/Horizon)** - ⭐ 3,250
   📡 Your own AI-powered news radar. Generates daily briefings in English & Chinese. | 用 AI 构建你专属的新闻雷达

218. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 3,244
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

219. **[SimpleMem](https://github.com/aiming-lab/SimpleMem)** - ⭐ 3,237
   SimpleMem: Efficient Lifelong Memory for LLM Agents — Text & Multimodal

220. **[Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills)** - ⭐ 3,209
   Multi-modal Generative Media Skills for AI Agents (Claude Code, Cursor, Gemini CLI). High-quality image, video, and audio generation powered by muapi.ai.

221. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 3,205
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

222. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 3,128
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

223. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 3,106
   A TypeScript framework for building MCP servers.

224. **[vitemcp](https://github.com/punkpeye/vitemcp)** - ⭐ 3,056
   A TypeScript framework for building MCP servers.

225. **[goclaw](https://github.com/nextlevelbuilder/goclaw)** - ⭐ 3,053
   GoClaw - GoClaw is OpenClaw rebuilt in Go — with multi-tenant isolation, 5-layer security, and native concurrency. Deploy AI agent teams at scale without compromising on safety.

226. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 3,038
   AI agent microservice

227. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 3,012
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

228. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 3,010
   n8n custom node for MCP

229. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,998
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

230. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,978
   MCP server for Grafana

231. **[m_flow](https://github.com/FlowElement-ai/m_flow)** - ⭐ 2,954
   A bio-inspired cognitive memory engine — a new paradigm for Graph RAG.

232. **[OB1](https://github.com/NateBJones-Projects/OB1)** - ⭐ 2,935
...
233. **[harbor](https://github.com/av/harbor)** - ⭐ 2,917
...
234. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 2,917
   This is the official website for TuriX Computer-use-Agent

235. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,899
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code, Claude Desktop, Agent SDK and OpenClaw

236. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 2,780
   The Unofficial and Awesome Home Assistant MCP Server

237. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,764
   A mcp server to allow LLMS gain context about shadcn ui component structure,usage and installation,compaitable with react,svelte 5,vue & React Native

238. **[tradingview-mcp](https://github.com/tradesdontlie/tradingview-mcp)** - ⭐ 2,724
   AI-assisted TradingView chart analysis — connect Claude Code to your TradingView Desktop for personal workflow automation

239. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 2,723
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

240. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 2,717
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

241. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,716
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

242. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,682
   A Model Context Protocol server for searching and analyzing arXiv papers

243. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,672
   Connect Supabase to your AI assistants

244. **[moltis](https://github.com/moltis-org/moltis)** - ⭐ 2,668
...
245. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 2,660
   AI Skills, MCP Tools, and CLI for Unity Engine. Full AI develop and test loop. Use cli for quick setup. Efficient token usage, advanced tools. Any C# method may be turned into a tool by a single line. Works with Claude Code, Gemini, Copilot, Cursor and any other absolutely for free.

246. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 2,655
   Next Generation Agentic Proxy for AI Agents and MCP servers

247. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,649
   A Model Context Protocol server for converting almost anything to Markdown

248. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,614
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

249. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,612
   A metasearch library that aggregates results from diverse web search services

250. **[FireRed-OpenStoryline](https://github.com/FireRedTeam/FireRed-OpenStoryline)** - ⭐ 2,588
...
251. **[slackdump](https://github.com/rusq/slackdump)** - ⭐ 2,582
   Save or export your private and public Slack messages, threads, files, and users locally without admin privileges.

252. **[openpencil](https://github.com/ZSeven-W/openpencil)** - ⭐ 2,569
   The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.

253. **[kreuzberg](https://github.com/Goldziher/kreuzberg)** - ⭐ 2,561
...
254. **[nunu](https://github.com/go-nunu/nunu)** - ⭐ 2,557
   A CLI tool for building Go applications.

255. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,531

256. **[claude-context-mode](https://github.com/mksglu/claude-context-mode)** - ⭐ 2,522
   MCP is the protocol for tool access. We're the virtualization layer for context.

257. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 2,513
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

258. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,501
   A bridge between Streamable HTTP and stdio MCP transports

259. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,460
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

260. **[SocratiCode](https://github.com/giancarloerra/SocratiCode)** - ⭐ 2,460
...
261. **[design-extract](https://github.com/Manavarya09/design-extract)** - ⭐ 2,404
   Extract any website's complete design system with one command. DTCG tokens, semantic+primitive+composite, MCP server for Claude Code/Cursor/Windsurf, multi-platform emitters (iOS SwiftUI, Android Compose, Flutter, WordPress), Tailwind v4, Figma variables, shadcn/ui, CSS health audit, WCAG remediation, Chrome extension. MIT, Playwright, Node 20+.

262. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 2,402
...
263. **[superpowers-zh](https://github.com/jnMetaCode/superpowers-zh)** - ⭐ 2,396
   🦸 AI 编程超能力 · 中文增强版 — superpowers（116k+ ⭐）完整汉化 + 6 个中国原创 skills，让 Claude Code / Copilot CLI / Hermes Agent / Cursor / Windsurf / Kiro / Gemini CLI 等 16 款 AI 编程工具真正会干活

264. **[fli](https://github.com/punitarani/fli)** - ⭐ 2,380
   Google Flights MCP and Python Library

265. **[agent-scan](https://github.com/snyk/agent-scan)** - ⭐ 2,368
   Security scanner for AI agents, MCP servers and agent skills.

266. **[anything-analyzer](https://github.com/Mouseww/anything-analyzer)** - ⭐ 2,366
...
267. **[agent-deck](https://github.com/asheshgoplani/agent-deck)** - ⭐ 2,359
   Terminal session manager for AI coding agents. One TUI for Claude, Gemini, OpenCode, Codex, and more.

268. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 2,353
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

269. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 2,341
   Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tasks, Search & Drive with AI - Comprehensive Google Workspace / G Suite MCP Server & CLI Tool

270. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 2,340
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

271. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 2,308
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

272. **[code-graph-rag](https://github.com/vitali87/code-graph-rag)** - ⭐ 2,286
   The ultimate RAG for your monorepo. Query, understand, and edit multi-language codebases with the power of AI and knowledge graphs

273. **[skills](https://github.com/microsoft/skills)** - ⭐ 2,271
   Skills, MCP servers, Custom Agents, Agents.md for SDKs to ground Coding Agents

274. **[sentrux](https://github.com/sentrux/sentrux)** - ⭐ 2,270
...
275. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 2,240
   ⭐ All-in-one AI companion! Super Agent Party = Self hosted neuro sama + openclaw! ⭐ 全能AI伴侣！超级智能体派对 = 自托管neuro sama + openclaw!

276. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,229
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

277. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 2,226
...
278. **[ext-apps](https://github.com/modelcontextprotocol/ext-apps)** - ⭐ 2,226
   Official repo for spec & SDK of MCP Apps protocol - standard for UIs embedded AI chatbots, served by MCP servers

279. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 2,200
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

280. **[codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)** - ⭐ 2,199
...
281. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,195
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

282. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 2,167
   The official MCP server implementation for the Perplexity API Platform

283. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 2,153
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

284. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 2,145
   425 plugins, 2,810 skills, 200 agents for Claude Code. Open-source marketplace at tonsofskills.com with the ccpi CLI package manager.

285. **[onecli](https://github.com/onecli/onecli)** - ⭐ 2,114
   Open-source credential vault, give your AI agents access to services without exposing keys.

286. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,108
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

287. **[Aix-DB](https://github.com/apconw/Aix-DB)** - ⭐ 2,106
   Aix-DB 基于 LangChain/LangGraph 框架，结合 MCP Skills 多智能体协作架构，实现自然语言到数据洞察的端到端转换。

288. **[mcp2cli](https://github.com/knowsuchagency/mcp2cli)** - ⭐ 2,100
   Turn any MCP, OpenAPI, or GraphQL server into a CLI — at runtime, with zero codegen

289. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

290. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 2,097
   An MCP server for interacting with the Financial Datasets stock market API.

291. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 2,095
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

292. **[carbon](https://github.com/crbnos/carbon)** - ⭐ 2,092
...
293. **[fusio](https://github.com/apioo/fusio)** - ⭐ 2,085
   Self-Hosted API Management for Builders

294. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 2,069
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies.

295. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,063
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

296. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 2,035

297. **[vexa](https://github.com/Vexa-ai/vexa)** - ⭐ 2,020
   Open-source meeting transcription API for Google Meet, Microsoft Teams & Zoom. Auto-join bots, real-time WebSocket transcripts, MCP server for AI agents. Self-host or use hosted SaaS.

298. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 2,009
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

299. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 2,004
   directory for Awesome MCP Servers

300. **[rocketride-server](https://github.com/rocketride-org/rocketride-server)** - ⭐ 2,003
   High-performance AI pipeline engine with a C++ core and 50+ Python-extensible nodes. Build, debug, and scale LLM workflows with 13+ model providers, 8+ vector databases, and agent orchestration, all from your IDE. Includes VS Code extension, TypeScript/Python SDKs, and Docker deployment.

301. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 2,002
   A Unified MCP Server Management App (MCP Manager).

302. **[claude-peers-mcp](https://github.com/louislva/claude-peers-mcp)** - ⭐ 1,988
   Allow all your Claude Codes to message each other ad-hoc!

303. **[beelzebub](https://github.com/beelzebub-labs/beelzebub)** - ⭐ 1,986
   A secure low code deception runtime framework, leveraging AI for System Virtualization.

304. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,981
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

305. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,980
   Plugin for JADX to integrate MCP server

306. **[witsy](https://github.com/Kochava-Studios/witsy)** - ⭐ 1,969
   Witsy: desktop AI assistant / universal MCP client

307. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,961
   MCP server for interacting with the iOS simulator

308. **[mcp-cli](https://github.com/IBM/mcp-cli)** - ⭐ 1,957

309. **[esp32_nat_router](https://github.com/martin-ger/esp32_nat_router)** - ⭐ 1,945
   An AI-enabled NAT Router/Firewall for the ESP32

310. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,940
   Production ready MCP server with real-time search, extract, map & crawl.

311. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,929
   Development platform to debug, chat, inspect, and evaluate MCP servers, MCP apps, and ChatGPT apps.

312. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,928
   Witsy: desktop AI assistant / universal MCP client

313. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,927
   Asynchronous coordination layer for AI coding agents: identities, inboxes, searchable threads, and advisory file leases over FastMCP + Git + SQLite

314. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,908
   Desktop Extensions: One-click local MCP server installation in desktop apps

315. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,904
   A secure low code honeypot framework, leveraging AI for System Virtualization.

316. **[toprank](https://github.com/nowork-studio/toprank)** - ⭐ 1,904
   Open-source Claude Code skills for SEO, GEO, Google Ads, Meta Ads

317. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,903
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

318. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 1,894
...
319. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,891

320. **[contextplus](https://github.com/forloopcodes/contextplus)** - ⭐ 1,863
   Semantic Intelligence for Large-Scale Engineering. Context+ is an MCP server designed for developers who demand 99% accuracy. By combining RAG, Tree-sitter AST, Spectral Clustering, and Obsidian-style linking, Context+ turns a massive codebase into a searchable, hierarchical feature graph.

321. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,855
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

322. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 1,831
...
323. **[dembrandt](https://github.com/dembrandt/dembrandt)** - ⭐ 1,823
   Extract any website’s design system into tokens in seconds: logo, colors, typography, borders & more. One command.

324. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,817
...
325. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,816
   Open-source persistent memory for AI agent pipelines (LangGraph, CrewAI, AutoGen) and Claude. REST API + knowledge graph + autonomous consolidation.

326. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,808
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

327. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,800
...
328. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,800
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

329. **[jcodemunch-mcp](https://github.com/jgravelle/jcodemunch-mcp)** - ⭐ 1,800
   The leading, most token-efficient MCP server for GitHub source code exploration via tree-sitter AST parsing

330. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,789
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

331. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,781
   ToolHive is an enterprise-grade platform for running and managing Model Context Protocol (MCP) servers.

332. **[contextplus](https://github.com/ForLoopCodes/contextplus)** - ⭐ 1,780
   Semantic Intelligence for Large-Scale Engineering. Context+ is an MCP server designed for developers who demand 99% accuracy. By combining RAG, Tree-sitter AST, Spectral Clustering, and Obsidian-style linking, Context+ turns a massive codebase into a searchable, hierarchical feature graph.

333. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,774
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

334. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,766
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

335. **[radar](https://github.com/skyhook-io/radar)** - ⭐ 1,763
...
336. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 1,755
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

337. **[plik](https://github.com/root-gg/plik)** - ⭐ 1,754
   Plik is a temporary file upload system (Wetransfer like) in Go.

338. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,718
   Interactive User Feedback MCP

339. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,718
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

340. **[headroom](https://github.com/chopratejas/headroom)** - ⭐ 1,707
   The Context Optimization Layer for LLM Applications

341. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,705
...
342. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,688
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

343. **[korean-law-mcp](https://github.com/chrisryugj/korean-law-mcp)** - ⭐ 1,687
...
344. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,675
   Make RSS 📰 great again with AI 🧠✨!! [gpt-5.5 -> https://pay.ldxp.cn/shop/8465P8HU 0.2 倍率, 0.2元当1刀花，比官方便宜35倍]

345. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,674
   Model Context Protocol (MCP) plugin to connect with Unity Editor — designed for Cursor, Claude Code, Codex, Windsurf and other IDEs

346. **[grepai](https://github.com/yoanbernabeu/grepai)** - ⭐ 1,673
   Semantic Search & Call Graphs for AI Agents (100% Local)

347. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,666
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

348. **[pilot-shell](https://github.com/maxritter/pilot-shell)** - ⭐ 1,665
   Make Claude Code production-ready — spec-driven plans, enforced quality gates, persistent knowledge

349. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 1,655
   Your design system as an API. Connect AI to Figma for extraction, creation, and debugging.

350. **[awesome-claude-plugins](https://github.com/ComposioHQ/awesome-claude-plugins)** - ⭐ 1,644
...
351. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,627
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

352. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,619
   MCP server that provides tools and resources for interacting with n8n API

353. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,615
   Coding assistant MCP for Claude Desktop

354. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,615
...
355. **[cocoindex-code](https://github.com/cocoindex-io/cocoindex-code)** - ⭐ 1,601
...
356. **[qiaomu-anything-to-notebooklm](https://github.com/joeseesun/qiaomu-anything-to-notebooklm)** - ⭐ 1,597
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

357. **[awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit)** - ⭐ 1,593
...
358. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,586
   The most powerful MCP Slack Server with no permission requirements, Apps support, GovSlack, DMs, Group DMs and smart history fetch logic.

359. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,579
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

360. **[blitz-mac](https://github.com/blitzdotdev/blitz-mac)** - ⭐ 1,577
   Native macOS App Store Connect tool with MCP. Submit iOS apps to App Store with AI agents 

361. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

362. **[claude-code-rust](https://github.com/lorryjovens-hub/claude-code-rust)** - ⭐ 1,554
...
363. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,550
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

364. **[mcp-brasil](https://github.com/Mcp-Brasil/mcp-brasil)** - ⭐ 1,546
   MCP Server para 70 APIs públicas brasileiras

365. **[GrokSearch](https://github.com/GuDaStudio/GrokSearch)** - ⭐ 1,542
   Integrate Grok's powerful real-time search capabilities into Claude via the MCP protocol!

366. **[ai](https://github.com/stripe/ai)** - ⭐ 1,541
   One-stop shop for building AI-powered products and businesses with Stripe.

367. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,526
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

368. **[executor](https://github.com/RhysSullivan/executor)** - ⭐ 1,524
...
369. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,521
   Standards for building agents, better

370. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,518
   An MCP server that installs other MCP servers for you

371. **[NagaAgent](https://github.com/RTGS2017/NagaAgent)** - ⭐ 1,516
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

372. **[PrismerCloud](https://github.com/Prismer-AI/PrismerCloud)** - ⭐ 1,509
   Prismer Cloud

373. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,503
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

374. **[ai-engineering-interview-questions](https://github.com/amitshekhariitbhu/ai-engineering-interview-questions)** - ⭐ 1,502
   Your Cheat Sheet for AI Engineering Interview – Questions and Answers.

375. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,501
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

376. **[claudian](https://github.com/YishenTu/claudian)** - ⭐ 1,493
   An Obsidian plugin that embeds Claude Code as an AI collaborator in your vault

377. **[mcp-brasil](https://github.com/jxnxts/mcp-brasil)** - ⭐ 1,487
   MCP Server para 41 APIs públicas brasileiras

378. **[tavily-key-generator](https://github.com/skernelx/tavily-key-generator)** - ⭐ 1,485
   Multi-service toolkit for Tavily and Firecrawl signup automation, key validation, and isolated proxy pools.

379. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,479
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

380. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,477
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

381. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 1,473
   First gitlab mcp for you, building together

382. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,471
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

383. **[hotpath-rs](https://github.com/pawurb/hotpath-rs)** - ⭐ 1,460
   Quickly find bottlenecks in Rust - one profiler for CPU, time, memory, and async code.

384. **[jshookmcp](https://github.com/vmoranv/jshookmcp)** - ⭐ 1,460
   js hook toolkit that all you need

385. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,458
   Security scanner for AI agents, MCP servers and agent skills.

386. **[ghost-os](https://github.com/ghostwright/ghost-os)** - ⭐ 1,447
   Full computer-use for AI agents. Self-learning workflows. Native macOS. No screenshots required.

387. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,444
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

388. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,440
   Make your own story. User-friendly software for LLM roleplaying

389. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 1,438
   Official data.gouv.fr Model Context Protocol (MCP) server that allows AI chatbots to search, explore, and analyze datasets from the French national Open Data platform, directly through conversation.

390. **[nixopus](https://github.com/nixopus/nixopus)** - ⭐ 1,430
   Run production apps without thinking about infrastructure. On your server or ours. Fully agentic.

391. **[lean-ctx](https://github.com/yvgude/lean-ctx)** - ⭐ 1,429
...
392. **[repowise](https://github.com/repowise-dev/repowise)** - ⭐ 1,425
...
393. **[claude-pilot](https://github.com/maxritter/claude-pilot)** - ⭐ 1,418
...
394. **[phantom](https://github.com/ghostwright/phantom)** - ⭐ 1,417
...
395. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 1,415
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

396. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,414

397. **[paperbanana](https://github.com/llmsresearch/paperbanana)** - ⭐ 1,406
   Open source implementation and extension of Google Research’s PaperBanana for automated academic figures, diagrams, and research visuals, expanded to new domains like slide generation.

398. **[data-api-builder](https://github.com/Azure/data-api-builder)** - ⭐ 1,402
   Data API builder provides modern REST, GraphQL endpoints and MCP tools to your Azure Databases and on-prem stores.

399. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,390
   An official Qdrant Model Context Protocol (MCP) server implementation

400. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,389
   MCP Server for kubernetes management commands

401. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,385
   docker mcp CLI plugin / MCP Gateway

402. **[ShipSwift](https://github.com/signerlabs/ShipSwift)** - ⭐ 1,381
   AI-native SwiftUI component library with full-stack recipes — connect via MCP for instant access.

403. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 1,380
   MCP, CLI, Skills for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

404. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 1,378
   A guide on how to use the Figma MCP server

405. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,373
   A connector for Claude Desktop to read and search an Obsidian vault.

406. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,373
   The official Swift SDK for Model Context Protocol servers and clients.

407. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,370
   告别AI提前终止烦恼，助力AI更加持久

408. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,361
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

409. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,356
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

410. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,353
   The official ElevenLabs MCP server

411. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,344
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

412. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,333
   The python library for research and development in NLP, multimodal LLMs, Agents, ML, Knowledge Graphs, and more.

413. **[tabularis](https://github.com/TabularisDB/tabularis)** - ⭐ 1,330
...
414. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 1,321
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

415. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 1,320
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

416. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 1,316
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

417. **[nanobot](https://github.com/obot-platform/nanobot)** - ⭐ 1,310
   Build MCP Agents

418. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 1,309
   Build MCP Agents

419. **[OpenContracts](https://github.com/Open-Source-Legal/OpenContracts)** - ⭐ 1,309
...
420. **[sourcey](https://github.com/sourcey/sourcey)** - ⭐ 1,293
   Precision documentation from OpenAPI, MCP, Doxygen, and Markdown guides. Static HTML you own.

421. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,291
   Damn Vulnerable MCP Server

422. **[relaticle](https://github.com/relaticle/relaticle)** - ⭐ 1,290
   Open-source CRM with native AI agent support. 30 MCP tools, REST API, self-hosted. Built with Laravel & Filament

423. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 1,276
   Model Context Protocol for WinDBG

424. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,275
   Claude Code as one-shot MCP server to have an agent in your agent.

425. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,263
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

426. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 1,263
...
427. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,260
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

428. **[open-cowork](https://github.com/OpenCoworkAI/open-cowork)** - ⭐ 1,255
   Open-source AI agent desktop app for Windows & macOS. One-click install Claude Code, MCP tools, and Skills — with sandbox isolation, multi-model support, and Feishu/Slack integration.

429. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,252
   The TypeScript MCP framework

430. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 1,249
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

431. **[cli](https://github.com/TanStack/cli)** - ⭐ 1,249
   The official TanStack CLI - Project Scaffolding, MCP Server, Agent Skills Installation, etc

432. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,248
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

433. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,243
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

434. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,239
   An MCP server that autonomously evaluates web applications. 

435. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,233
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

436. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

437. **[mcpvault](https://github.com/bitbonsai/mcpvault)** - ⭐ 1,224
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

438. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,222
   Make your own story. User-friendly software for LLM roleplaying

439. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,219
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

440. **[antigravity-workspace-template](https://github.com/study8677/antigravity-workspace-template)** - ⭐ 1,216
...
441. **[opennews-mcp](https://github.com/6551Team/opennews-mcp)** - ⭐ 1,214
   News Aggregation · AI Ratings · Trading Signals · Real-time Updates

442. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 1,213
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

443. **[aso-skills](https://github.com/Eronred/aso-skills)** - ⭐ 1,210
...
444. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 1,207
   Connect AI models like Claude & GPT with robots using MCP and ROS.

445. **[amical](https://github.com/amicalhq/amical)** - ⭐ 1,206
   🎙️ AI Dictation App - Open Source and Local-first ⚡ Type 3x faster, no keyboard needed. 🆓 Powered by open source models, works offline, fast and accurate.

446. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 1,204
   Draw.io Model Context Protocol (MCP) Server

447. **[js-reverse-mcp](https://github.com/zhizhuodemao/js-reverse-mcp)** - ⭐ 1,203
   为 AI Agent 设计的 JS 逆向 MCP Server，内置反检测，基于 chrome-devtools-mcp 重构 | JS reverse engineering MCP server with agent-first tool design and built-in anti-detection. Rebuilt from chrome-devtools-mcp.

448. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 1,202
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

449. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,200
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

450. **[sceneview](https://github.com/sceneview/sceneview)** - ⭐ 1,195
...
451. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 1,186
...
452. **[minutes](https://github.com/silverstein/minutes)** - ⭐ 1,179
   Every meeting, every idea, every voice note — searchable by your AI. Open-source, privacy-first conversation memory layer.

453. **[open-webSearch](https://github.com/Aas-ee/open-webSearch)** - ⭐ 1,175
   Multi-engine MCP server, CLI, and local daemon for agent web search and content retrieval — skill-guided workflows, no API keys.

454. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,171
   A Ruby Implementation of the Model Context Protocol

455. **[llm-for-zotero](https://github.com/yilewang/llm-for-zotero)** - ⭐ 1,171
   A research agent system deeply rooted in your own Zotero library.

456. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 1,165
...
457. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,161
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

458. **[tabularis](https://github.com/debba/tabularis)** - ⭐ 1,153
   A lightweight, cross-platform database client for developers. Supports MySQL, PostgreSQL and SQLite. Hackable with plugins. Built for speed, security, and aesthetics.

459. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 1,152
...
460. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 1,150
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

461. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,147
   Programmable Context for the AI Stack. Build. Version. Deploy. The full lifecycle platform for Context Graphs.

462. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,144
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

463. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 1,138
   OpenAI and Anthropic compatible server for Apple Silicon. Run LLMs and vision-language models (Llama, Qwen-VL, LLaVA) with continuous batching, MCP tool calling, and multimodal support. Native MLX backend, 400+ tok/s. Works with Claude Code.

464. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 1,133
   Lighweight CLI to interact with MCP servers

465. **[agents](https://github.com/inkeep/agents)** - ⭐ 1,132
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

466. **[skybridge](https://github.com/alpic-ai/skybridge)** - ⭐ 1,128
   Skybridge is a full-stack TypeScript framework for MCP Apps and ChatGPT Apps. Type-safe. React-powered. Platform-agnostic.

467. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,127
...
468. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 1,122
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

469. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 1,113
   MCP integration for Google Calendar to manage events.

470. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 1,101
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

471. **[webclaw](https://github.com/0xMassi/webclaw)** - ⭐ 1,100
   Fast, local-first web content extraction for LLMs. Scrape, crawl, extract structured data — all from Rust. CLI, REST API, and MCP server.

472. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 1,096
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

473. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 1,092
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

474. **[burp-ai-agent](https://github.com/six2dez/burp-ai-agent)** - ⭐ 1,092
   Burp Suite extension that adds built-in MCP tooling, AI-assisted analysis, privacy controls, passive and active scanning and more

475. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 1,089
...
476. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 1,087
   A repository of servers and clients from the Model Context Protocol tutorials

477. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 1,079
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

478. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 1,077
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

479. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,072
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

480. **[LangAlpha](https://github.com/ginlix-ai/LangAlpha)** - ⭐ 1,063
   Claude Code for Finance

481. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 1,058
   Remote MCP Servers

482. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 1,056
   Bringing the power of MCP to the web

483. **[keeper.sh](https://github.com/ridafkih/keeper.sh)** - ⭐ 1,056
   Calendar sync tool & universal calendar MCP server. Aggregate, sync and control calendars on Google, Outlook, Office 365, iCloud, CalDAV or ICS.

484. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,054
   MCP Python Tutorial 

485. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 1,049
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

486. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,049
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

487. **[tools](https://github.com/strands-agents/tools)** - ⭐ 1,048
   A set of tools that gives agents powerful capabilities.

488. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,047
   On-premises conversational RAG with configurable containers

489. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 1,046
   MCP server for fetch web page content using Playwright headless browser.

490. **[nocturne_memory](https://github.com/Dataojitori/nocturne_memory)** - ⭐ 1,045
   A lightweight, rollbackable, and visual Long-Term Memory Server for MCP Agents. Say goodbye to Vector RAG and amnesia. Empower your AI with persistent, graph-like structured memory across any model, session, or tool. Drop-in replacement for OpenClaw.

491. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,043
   A curated list of Model Context Protocol (MCP) servers 

492. **[mirobody](https://github.com/thetahealth/mirobody)** - ⭐ 1,039
   Your Data, Your AI — Health, Finance & More. Open Source, Privacy-First.

493. **[codesight](https://github.com/Houseofmvps/codesight)** - ⭐ 1,036
   Universal AI context generator. Saves thousands of tokens per conversation in Claude Code, Cursor, Copilot, Codex, and more.

494. **[mcp-server-chatsum](https://github.com/chatmcp/mcp-server-chatsum)** - ⭐ 1,034
   Query and Summarize your chat messages.

495. **[LetsFG](https://github.com/LetsFG/LetsFG)** - ⭐ 1,034
...
496. **[devops-ai-guidelines](https://github.com/VersusControl/devops-ai-guidelines)** - ⭐ 1,032
   First AI Journey for DevOps - with comprehensive learning paths, practical tips, and enterprise guidelines

497. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 1,032
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

498. **[ai-setup](https://github.com/caliber-ai-org/ai-setup)** - ⭐ 1,031
...
499. **[xiaoyaosearch](https://github.com/dtsola/xiaoyaosearch)** - ⭐ 1,027
...
500. **[search_with_ai](https://github.com/yokingma/search_with_ai)** - ⭐ 1,025
...
501. **[724-office](https://github.com/wangziqi06/724-office)** - ⭐ 1,023
...
502. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 1,022
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

503. **[iwe](https://github.com/iwe-org/iwe)** - ⭐ 1,022
   Markdown memory system for you and your AI agent

504. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 1,020
   One place to manage & connect to all your MCP servers

505. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 1,017
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

506. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 1,007
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

507. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 1,003
   MCP server integration for DaVinci Resolve

508. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 1,000

509. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 998
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

510. **[better-icons](https://github.com/better-auth/better-icons)** - ⭐ 995
   Skill and MCP server for searching and retrieving icons

511. **[muapi-cli](https://github.com/SamurAIGPT/muapi-cli)** - ⭐ 992
   Official CLI for muapi.ai — generate images, videos & audio from the terminal. MCP server, 14 AI models, npm + pip installable.

512. **[weave](https://github.com/Ataraxy-Labs/weave)** - ⭐ 991
...
513. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 983
   Expose llms-txt to IDEs for development

514. **[MeiGen-AI-Design-MCP](https://github.com/jau123/MeiGen-AI-Design-MCP)** - ⭐ 981
...
515. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 980
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

516. **[reactuse](https://github.com/childrentime/reactuse)** - ⭐ 976
...
517. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 972
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

518. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 971
...
519. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 967
...
520. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 965
   A security scanner for your LLM agentic workflows

521. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 965
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

522. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 954
   OpenAPI Tool Servers

523. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 953
   Delegate tasks to Codex and Gemini directly from within Claude Code.

524. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 951
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

525. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 946
   Neo4j Labs Model Context Protocol servers

526. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 946
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

527. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 945
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

528. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 940
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

529. **[google-meta-ads-ga4-mcp](https://github.com/irinabuht12-oss/google-meta-ads-ga4-mcp)** - ⭐ 938
...
530. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 936
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

531. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 932

532. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 928
...
533. **[cs](https://github.com/boyter/cs)** - ⭐ 927
...
534. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 925
   A middleware to provide an openAI compatible endpoint that can call MCP tools

535. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 922
...
536. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 917
   FreeCAD MCP(Model Context Protocol) server

537. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 916
   The Typescript MCP Framework

538. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 916
...
539. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 916
   Scan MCP servers for potential threats & security findings.

540. **[awesome-openclaw](https://github.com/SamurAIGPT/awesome-openclaw)** - ⭐ 911
   A curated list of OpenClaw resources, tools, skills, tutorials & articles. OpenClaw (formerly Moltbot / Clawdbot) — open-source self-hosted AI agent for WhatsApp, Telegram, Discord & 50+ integrations.

541. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 909
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

542. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 906
   MCP server helping models to understand your Vite/Nuxt app better.

543. **[kordoc](https://github.com/chrisryugj/kordoc)** - ⭐ 905
   모두 파싱해버리겠다 — HWP, HWPX, PDF, XLSX, DOCX → Markdown. CLI + MCP Server

544. **[shellfirm](https://github.com/kaplanelad/shellfirm)** - ⭐ 904
   Safety guardrails for ai coding agents and human terminal commands

545. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 902
...
546. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 901
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

547. **[azure-skills](https://github.com/microsoft/azure-skills)** - ⭐ 899
   Official agent plugin providing skills and MCP server configurations for Azure scenarios.

548. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 898

549. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 894
...
550. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 893
   MCP Server For Turkish Legal Databases

551. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 892
   Allow AI to wade through complex OpenAPIs using Simple Language

552. **[hister](https://github.com/asciimoo/hister)** - ⭐ 892
   Your own search engine

553. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 891

554. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 888
   A Model Context Protocol server for connecting Notion to MCP-compatible clients

555. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 886
   MCP Server Framework and Tool Development library for building custom capabilities into agents. 

556. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 885
   A library for communication with a Minecraft client/server.

557. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 884
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

558. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 883
...
559. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 881
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

560. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 879
   A concise list for mcp servers

561. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 879
   Published in CNCF Landscape: A MCP server for Kubernetes.

562. **[agent-teams-ai](https://github.com/777genius/agent-teams-ai)** - ⭐ 879
...
563. **[MODULAR-RAG-MCP-SERVER](https://github.com/jerry-ai-dev/MODULAR-RAG-MCP-SERVER)** - ⭐ 879
...
564. **[excalidraw-mcp-app](https://github.com/antonpk1/excalidraw-mcp-app)** - ⭐ 876
   Excalidraw MCP App Server — hand-drawn diagrams for Claude

565. **[restheart](https://github.com/SoftInstigate/restheart)** - ⭐ 874
   The Agent-Ready Backend for MongoDB.

566. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 872
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

567. **[routa](https://github.com/phodal/routa)** - ⭐ 869
...
568. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 862
   原 [chatlog]项目（一个微信数据库解密读取及提供mcp服务、http服务的开源软件），现已支持通过微信clawbot接口推送消息，可以实时转发全部或指定消息到clawbot

569. **[claude_agent_teams_ui](https://github.com/777genius/claude_agent_teams_ui)** - ⭐ 860
   You're the CTO, agents are your team. They handle tasks on their own, message each other, and review each other's work. You just watch the kanban board and give high-level commands. Codex/Claude/OpenCode(75+ LLM providers). Build your AI company.

570. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 858
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

571. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 855
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

572. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 854
   Flow-Like: Strongly Typed Enterprise Scale Workflows. Built for scalability, speed, seamless AI integration and rich customization.

573. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 851
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

574. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 851
   A simple, locally hosted Web Search MCP server for use with Local LLMs

575. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 849
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

576. **[stitch-mcp](https://github.com/davideast/stitch-mcp)** - ⭐ 847
   A CLI for moving AI-generated UI designs from Google’s Stitch platform into your development workflow.

577. **[llmwiki](https://github.com/lucasastorian/llmwiki)** - ⭐ 846
...
578. **[server](https://github.com/php-mcp/server)** - ⭐ 838
   Core PHP implementation for the Model Context Protocol (MCP) server

579. **[nekro-agent](https://github.com/KroMiose/nekro-agent)** - ⭐ 838
...
580. **[tradememory-protocol](https://github.com/mnemox-ai/tradememory-protocol)** - ⭐ 836
...
581. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

582. **[Foundry](https://github.com/promptise-com/Foundry)** - ⭐ 835
   The foundation layer for agentic intelligence.

583. **[hyper-mcp](https://github.com/joseph-wortmann/hyper-mcp)** - ⭐ 834
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

584. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 834
   Simple, modular, and observable Go framework for backend applications.

585. **[ai-agents-from-zero](https://github.com/didilili/ai-agents-from-zero)** - ⭐ 833
...
586. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 831
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

587. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 830
   A minimalistic MCP client with a good feature set.

588. **[awesome-harness-engineering](https://github.com/ai-boost/awesome-harness-engineering)** - ⭐ 829
...
589. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 827
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

590. **[token-savior](https://github.com/Mibayy/token-savior)** - ⭐ 826
...
591. **[jarvis](https://github.com/isair/jarvis)** - ⭐ 826
...
592. **[opentwitter-mcp](https://github.com/6551Team/opentwitter-mcp)** - ⭐ 825
   Twitter/X Data · User Profiles · Tweet Search · Follower Events · KOL Tracking

593. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 824
   A local sandbox for your AI agents

594. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 823
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

595. **[browser-use-mcp-server](https://github.com/kontext-security/browser-use-mcp-server)** - ⭐ 822
   Browse the web, directly from Cursor etc.

596. **[LaunchStack](https://github.com/Deodat-Lawson/LaunchStack)** - ⭐ 821
...
597. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 819
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

598. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 818
   Browse the web, directly from Cursor etc.

599. **[figma-mcp-go](https://github.com/vkhanhqui/figma-mcp-go)** - ⭐ 816
   Figma MCP for free users — no rate limits, full read/write, text to designs, designs to code

600. **[glean](https://github.com/LeslieLeung/glean)** - ⭐ 815
   A self-hosted RSS reader and personal knowledge management tool.

601. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 815
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

602. **[fim-one](https://github.com/fim-ai/fim-one)** - ⭐ 815
   Open-source agent platform for Global × China enterprises — wire every system through one agent core. Self-hosted, any LLM.

603. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 814
   The official Ruby SDK for the Model Context Protocol.

604. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 813
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

605. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 811
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

606. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 811
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

607. **[gemini-skill](https://github.com/WJZ-P/gemini-skill)** - ⭐ 810
...
608. **[context-space](https://github.com/context-space/context-space)** - ⭐ 809
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

609. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 809
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

610. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 809
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

611. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 809
   Google Search Console Insights with Claude AI for SEOs

612. **[Proxima](https://github.com/Zen4-bit/Proxima)** - ⭐ 805
   Multi-AI MCP Server - Connect ChatGPT, Claude, Gemini & Perplexity to your coding tools without any API

613. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 804
   一个将ACE(Augment Context Engine) 做成MCP的项目

614. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 803
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

615. **[Context](https://github.com/indragiek/Context)** - ⭐ 797
   Native macOS client for Model Context Protocol (MCP)

616. **[vllora](https://github.com/vllora/vllora)** - ⭐ 795
   Debug your AI agents

617. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 793
   🤖 Automatically collected AI repos, tools, websites, papers & tutorials. 实用AI百宝箱 💎

618. **[work-iq](https://github.com/microsoft/work-iq)** - ⭐ 792
   MCP Server and CLI for accessing Work IQ

619. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 790
   Vibetest MCP - automated QA testing using Browser-Use agents

620. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 786
   gcloud MCP server

621. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 786
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

622. **[codedb](https://github.com/justrach/codedb)** - ⭐ 784
...
623. **[drift](https://github.com/dadbodgeoff/drift)** - ⭐ 778
   Codebase intelligence for AI. Detects patterns & conventions + remembers decisions across sessions. MCP server for any IDE. Offline CLI.

624. **[universal-db-mcp](https://github.com/Anarkh-Lee/universal-db-mcp)** - ⭐ 778
...
625. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 776
...
626. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 775
   Connect ClickHouse to your AI assistants.

627. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 774
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

628. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 773
...
629. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 767
...
630. **[xmcp](https://github.com/xdevplatform/xmcp)** - ⭐ 767
   MCP server for the X API

631. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 764
   MCP Server for SearXNG

632. **[runno](https://github.com/taybenlor/runno)** - ⭐ 763
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

633. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 763
...
634. **[semble](https://github.com/MinishLab/semble)** - ⭐ 763
   Fast and Accurate Code Search for Agents. Uses ~98% fewer tokens than grep+read

635. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 762
...
636. **[obot](https://github.com/obot-platform/obot)** - ⭐ 762
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

637. **[agency-orchestrator](https://github.com/jnMetaCode/agency-orchestrator)** - ⭐ 762
...
638. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 761
   A MCP server implementation for hyperbrowser

639. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 760
   MCP Server for Burp

640. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 757
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

641. **[samples](https://github.com/strands-agents/samples)** - ⭐ 756
   Agent samples built using the Strands Agents SDK.

642. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 756
...
643. **[tapo](https://github.com/mihai-dinculescu/tapo)** - ⭐ 754
   🦀 Rust API, 🐍 Python API, and 🤖 MCP Server for TP-Link Tapo smart devices

644. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 753
   A flexible HTTP fetching Model Context Protocol server.

645. **[room](https://github.com/quoroom-ai/room)** - ⭐ 751
...
646. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 750
   LLDB MCP Integration + other helpful commands

647. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 750
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

648. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 748
   An MCP server that provides control over Android devices via adb

649. **[ThinkWatch](https://github.com/ThinkWatchProject/ThinkWatch)** - ⭐ 746
...
650. **[openmcp-client](https://github.com/LSTM-Kirigaya/openmcp-client)** - ⭐ 745
   All in one vscode plugin for mcp developer

651. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 744
   Clojure MCP

652. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 741
   Next.js Development for Coding Agent

653. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 741
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

654. **[mcp](https://github.com/laravel/mcp)** - ⭐ 739
   Rapidly build MCP servers for your Laravel applications.

655. **[Wax](https://github.com/christopherkarani/Wax)** - ⭐ 730
...
656. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 729
...
657. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 725
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

658. **[anything-to-notebooklm](https://github.com/joeseesun/anything-to-notebooklm)** - ⭐ 724
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

659. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 722
...
660. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 719
...
661. **[MemoMind](https://github.com/24kchengYe/MemoMind)** - ⭐ 717
...
662. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 716
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

663. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 716
...
664. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 716
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

665. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 714
...
666. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 713
   Install, manage and develop MCP servers and skills for agents

667. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 713
   MCP server for Docker

668. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 711
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

669. **[jarvis-registry](https://github.com/ascending-llc/jarvis-registry)** - ⭐ 706
...
670. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 705
   A local Apple Documentation crawler and MCP server. Written in Swift.

671. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 704
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

672. **[langgraph-mcp-agents](https://github.com/braincrew-lab/langgraph-mcp-agents)** - ⭐ 703
...
673. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 702
   A simple MCP server for Obsidian

674. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 700
   LangGraph-powered ReAct agent with Model Context Protocol (MCP) integration. A Streamlit web interface for dynamically configuring, deploying, and interacting with AI agents capable of accessing various data sources and APIs through MCP tools.

675. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 700
...
676. **[generative-ui](https://github.com/CopilotKit/generative-ui)** - ⭐ 699
   Generative UI examples for: AG-UI, A2UI/Open-JSON-UI, and MCP Apps.

677. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 699
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

678. **[ship-safe](https://github.com/asamassekou10/ship-safe)** - ⭐ 695
   CLI security scanner built for the agentic era. Detects CI/CD misconfigs, agent permission risks, MCP tool injection, hardcoded secrets, and DMCA-flagged AI dependencies.

679. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 695
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

680. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 692
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

681. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 692
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

682. **[axon](https://github.com/harshkedia177/axon)** - ⭐ 690
...
683. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 690
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

684. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 689
   飞书/Lark官方 OpenAPI MCP

685. **[mcp-proxy](https://github.com/tbxark/mcp-proxy)** - ⭐ 688
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

686. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 682
   An MCP server for interacting with Sentry via LLMs.

687. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 681
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

688. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 679
   MCP configuration to connect AI agent to a Linux machine.

689. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 675
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

690. **[stash](https://github.com/alash3al/stash)** - ⭐ 675
...
691. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 673
   Laravel API for Ai Agents and humans.

692. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 673
   Official Jina AI Remote MCP Server

693. **[argo](https://github.com/xark-argo/argo)** - ⭐ 673
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

694. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 672
   A simple CLI to run LLM prompt and implement MCP client.

695. **[codexia](https://github.com/milisp/codexia)** - ⭐ 672
   Agent Workstation for Codex CLI + Claude Code — with task scheduler, git worktree & remote control, skills management

696. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 669
...
697. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 668
   A comprehensive collection of Model Context Protocol (MCP) servers

698. **[agent-kit](https://github.com/KeyID-AI/agent-kit)** - ⭐ 668
   Give Claude/Cursor email powers. 27 MCP tools — inbox, send, reply, contacts, search. Free, no signup.

699. **[clihub](https://github.com/thellimist/clihub)** - ⭐ 666
   Turn any MCP server into CLI

700. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 663
...
701. **[idea-reality-mcp](https://github.com/mnemox-ai/idea-reality-mcp)** - ⭐ 662
   Pre-build reality check for AI coding agents. Scans GitHub, HN, npm, PyPI, Product Hunt. MCP server. 290+ stars.

702. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 661
   Shell and coding agent on mcp clients

703. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 660
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

704. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 659
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

705. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 659
...
706. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 656
   Querying local documents, powered by LLM

707. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 656

708. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
   The YaCy Grid Master Connect Program

709. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 654
...
710. **[oxideterm](https://github.com/AnalyseDeCircuit/oxideterm)** - ⭐ 653
...
711. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 652
   A model-driven approach to building AI agents in just a few lines of code. 

712. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 646
   "AnyTool: Universal Tool-Use Layer for AI Agents"

713. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 644
   EnrichMCP is a python framework for building data driven MCP servers

714. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 644
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

715. **[JSReverser-MCP](https://github.com/NoOne-hub/JSReverser-MCP)** - ⭐ 644
...
716. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 643

717. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 643
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

718. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 642
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

719. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 642
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

720. **[k-dense-byok](https://github.com/K-Dense-AI/k-dense-byok)** - ⭐ 642
   An AI co-scientist powered by Scientific Agent Skills running on your desktop.

721. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
722. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 641
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

723. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 639
...
724. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 635
   Talk to a Cloudflare Worker from Claude Desktop!

725. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 635
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

726. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 633
   MCP-NixOS - Model Context Protocol Server for NixOS resources

727. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 630
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

728. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 630
    Feishu / Lark 飞书文档与任务管理工具，支持 MCP 服务器和 CLI + Skill 两种使用方式，可无缝集成 Cursor、Claude Code、Cline 等 AI 编码工具

729. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 627
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

730. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 627
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

731. **[pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter)** - ⭐ 626
   Token-efficient MCP adapter for Pi coding agent

732. **[ScienceClaw](https://github.com/beita6969/ScienceClaw)** - ⭐ 625
   🔬🦞 A self-evolving AI research colleague for scientists. 285 skills, zero hallucination, persistent memory.

733. **[docsagent](https://github.com/docsagent/docsagent)** - ⭐ 625
...
734. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 624
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

735. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 624

736. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 624
   mem-agent mcp server

737. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 620
   GitOps on Autopilot Mode

738. **[Overture](https://github.com/SixHq/Overture)** - ⭐ 620
   Overture is an open-source, locally running web interface delivered as an MCP (Model Context Protocol) server that visually maps out the execution plan of any AI coding agent as an interactive flowchart/graph before the agent begins writing code. 

739. **[codeg](https://github.com/xintaofei/codeg)** - ⭐ 617
...
740. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 617
   A coding agent and general agent harness for building and orchestrating agentic applications.

741. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 616
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

742. **[tome](https://github.com/runebookai/tome)** - ⭐ 614
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

743. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 609
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

744. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 609
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

745. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 609
   Making docling agentic through MCP

746. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 608
...
747. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 607
   MCP Server for Metasploit

748. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 607
   MCP server to deploy apps to Cloud Run

749. **[colab-mcp](https://github.com/googlecolab/colab-mcp)** - ⭐ 607
   An MCP server for interacting with Google Colab

750. **[agentshield](https://github.com/affaan-m/agentshield)** - ⭐ 607
   AI agent security scanner. Detect vulnerabilities in agent configurations, MCP servers, and tool permissions. Available as CLI, GitHub Action, ECC plugin, and GitHub App integration. 🛡️

751. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 605
   Convert Any OpenAPI V3 API to MCP Server

752. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 605
   The .NET library to build AI agents with 30+ built-in connectors.

753. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 604
   Daydreams is a set of tools for building agents for commerce

754. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 601

755. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 600
   MCP to connect your LLM with Spotify.

756. **[GhidrAssistMCP](https://github.com/symgraph/GhidrAssistMCP)** - ⭐ 599
   An native MCP server extension for Ghidra

757. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 598
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

758. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 596
   A comprehensive Model Context Protocol (MCP) server that enables AI assistants to control Unreal Engine through the native C++ Automation Bridge plugin. Built with TypeScript and C++.

759. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 595
   MCP server for interacting with Neon Management API and databases

760. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 594
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

761. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 593

762. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 593
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

763. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 592
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

764. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 592
   MCP Server for interacting with Android Devices.

765. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 591
...
766. **[evo-ai](https://github.com/evolution-foundation/evo-ai)** - ⭐ 589
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

767. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 589
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

768. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 588
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

769. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 588
   A Model Context Protocol (MCP) that allows Claude Desktop and other AI tools (Claude Code, Cursor, Antigravity, etc.) to read, analyze, and modify Figma designs

770. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 587
   AI-based stock analysis and trading system

771. **[UnrealClaude](https://github.com/Natfii/UnrealClaude)** - ⭐ 587
   Claude Code CLI integration for Unreal Engine 5.7 - Get AI coding assistance with built-in UE5.7 documentation context directly in the editor.

772. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 586
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

773. **[probe](https://github.com/probelabs/probe)** - ⭐ 585
   AI-friendly semantic code search engine for large codebases. Combines ripgrep speed with tree-sitter AST parsing. Powers AI coding assistants with precise, context-aware code understanding.

774. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 584
...
775. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 584
...
776. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 583
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

777. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 581
   LangGraph solution template for MCP

778. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 580
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

779. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 580
   A tool that converts OpenAPI specifications to MCP server

780. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 579
   A simple OIDC / OAuth Identity Provider (IdP) server for your tailnet.

781. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 577
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

782. **[zerobox](https://github.com/afshinm/zerobox)** - ⭐ 576
...
783. **[pipelock](https://github.com/luckyPipewrench/pipelock)** - ⭐ 576
   Open-source AI agent firewall for MCP security: agent egress control, DLP, SSRF, and prompt injection defense.

784. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 574
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

785. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 574
   MCP to allow AI agents to control Unreal

786. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 574
   MCP Server for Turkish & American Stock Exchange and Fund Data

787. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 573
   更好用的 Markdown 排版助手｜一键适配微信公众号、网页与图片。

788. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 572
   A MCP server for Home Assistant

789. **[kraken-cli](https://github.com/krakenfx/kraken-cli)** - ⭐ 571
   The first AI-native CLI for trading crypto, stocks, forex, and derivatives.

790. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 570
   A personal context store for AI agents and assistants—reuse your existing coding agent CLI (Codex/Claude/OpenCode) with built‑in Skills/tools and a desktop GUI to capture, search, and reuse project knowledge across agents and repos.

791. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 570
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

792. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 568
   An Mcp client inside Emacs

793. **[MindOS](https://github.com/GeminiLight/MindOS)** - ⭐ 568
...
794. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 566
   Open Source Voice Agent Platform

795. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 565
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

796. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 561
...
797. **[awesome-agentic-ai-zh](https://github.com/WenyuChiou/awesome-agentic-ai-zh)** - ⭐ 559
   AI Agent 中文學習地圖 — 從零開始的結構化學習路徑，每階段有必做練習跟必修閱讀。三語對照（繁中／简中／English）。歡迎社群一起貢獻、優化內容。

798. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 558
   A MCP (Model Context Protocol) server for interacting with dbt.

799. **[mda](https://github.com/sno-ai/mda)** - ⭐ 558
...
800. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 555
   An MCP Multimodal AI Agent with eyes and ears!

801. **[caswaf](https://github.com/casbin/caswaf)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

802. **[casbin-gateway](https://github.com/casbin/casbin-gateway)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

803. **[cve-mcp-server](https://github.com/mukul975/cve-mcp-server)** - ⭐ 555
   Production-grade MCP server giving Claude 27 security intelligence tools across 21 APIs — CVE lookup, EPSS scoring, CISA KEV, MITRE ATT&CK, Shodan, VirusTotal, and more.

804. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 554
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

805. **[MimikaStudio](https://github.com/BoltzmannEntropy/MimikaStudio)** - ⭐ 553
   MimikaStudio - A local-first application for macOS (Apple Silicon) + Agentic MCP Support

806. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 552
   Security scanner for MCP servers

807. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 551
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

808. **[opencode-studio](https://github.com/Microck/opencode-studio)** - ⭐ 551
   web GUI for securely managing local OpenCode configuration

809. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 549
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

810. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 547
   SonarQube MCP Server

811. **[claude-video-vision](https://github.com/jordanrendric/claude-video-vision)** - ⭐ 547
   Give Claude the ability to watch and understand videos — Claude Code plugin with frame extraction and multimodal audio analysis

812. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 546
   A structural code search engine for Al agents.

813. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 545
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

814. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 544
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

815. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 544
...
816. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 543
   A Model Context Protocol server for IDA

817. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 543
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

818. **[tda](https://github.com/irockel/tda)** - ⭐ 542
   TDA - Thread Dump Analyzer (for Java). Analyze your Thread Dumps with a GUI or use it as MCP Server.

819. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 542
   微信读书MCP

820. **[mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub)** - ⭐ 542
   A growing collection of MCP servers bringing offensive security tools to AI assistants. Nmap, Ghidra, Nuclei, SQLMap, Hashcat and more.

821. **[rails_ai_agents](https://github.com/ThibautBaissac/rails_ai_agents)** - ⭐ 539
   Specialized AI skills, agents, rules and hooks for modern Rails AI driven-development + Spec-Driven-Development kit + MCP

822. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 539
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

823. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 538

824. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 537
   LLM + MCP + RAG = Magic

825. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 537
   MCP server for querying Apple Health data with natural language and SQL

826. **[ScienceClaw](https://github.com/AgentTeam-TaichuAI/ScienceClaw)** - ⭐ 537
...
827. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 535

828. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 535
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

829. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 534
   🚀 Universal SDK for building next-gen MCP servers

830. **[work-iq-mcp](https://github.com/microsoft/work-iq-mcp)** - ⭐ 534
   MCP Server and CLI for accessing Work IQ

831. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 534

832. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 534
   MCP server for document format conversion using pandoc.

833. **[ethora](https://github.com/dappros/ethora)** - ⭐ 530
...
834. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 529
   An MCP server to query any Postgres database in natural language.

835. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 528
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

836. **[MinerU-Document-Explorer](https://github.com/opendatalab/MinerU-Document-Explorer)** - ⭐ 527
...
837. **[vestige](https://github.com/samvallad33/vestige)** - ⭐ 526
...
838. **[OpenSail](https://github.com/TesslateAI/OpenSail)** - ⭐ 524
   OpenSail is the open-source alternative to Codex App, Claude Desktop, Cursor, and Cowork for agentic software work.

839. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 522
   im busy building ai agents so why not let an ai talk to my girlfriend? (i am single) 

840. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 522
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

841. **[everything-claude-code-zh](https://github.com/xu-xiang/everything-claude-code-zh)** - ⭐ 522
...
842. **[human-skill-tree](https://github.com/24kchengYe/human-skill-tree)** - ⭐ 521
...
843. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 521
   MaverickMCP - Personal Stock Analysis MCP Server

844. **[agent-toolkit-for-aws](https://github.com/aws/agent-toolkit-for-aws)** - ⭐ 519
   Official, AWS-supported MCP servers, skills, and plugins to help AI agents build on AWS

845. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 518
   A Model-Context Protocol Server for YouTube

846. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 517

847. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 517
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

848. **[LLM-Agents-Ecosystem-Handbook](https://github.com/oxbshw/LLM-Agents-Ecosystem-Handbook)** - ⭐ 516
   One-stop handbook for building, deploying, and understanding LLM agents with 60+ skeletons, tutorials, ecosystem guides, and evaluation tools.

849. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
850. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 515
...
851. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 514
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

852. **[desktop](https://github.com/openyak/desktop)** - ⭐ 513
   Yak is all you need

853. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 513
   Make your meetings accessible to AI Agents

854. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 511
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

855. **[awesome-copilot-agents](https://github.com/Code-and-Sorts/awesome-copilot-agents)** - ⭐ 511
...
856. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 510

857. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 510
   An MCP extension for Ghidra

858. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 509
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

859. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 508
   Yes Mcp server in bash

860. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 508
   MCP Monitoring with eBPF

861. **[resend-mcp](https://github.com/resend/resend-mcp)** - ⭐ 508
   The official MCP server to send emails and interact with Resend

862. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

863. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 507
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

864. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 504
   BioMCP: Biomedical Model Context Protocol

865. **[open-harness](https://github.com/MaxGfeller/open-harness)** - ⭐ 504
   A code-first, composable SDK to build powerful AI agents

866. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 499
...
867. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 497
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

868. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
869. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

870. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 490
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

871. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 489
   A VSCode extension that lets you find and install Agent Skills and MCP Apps to use with GitHub Copilot, Claude Code, and Codex CLI.

872. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 486
   MCP Server to interact with Google Gsuite prodcuts

873. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 486
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

874. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 486
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

875. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 484
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

876. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 481
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

877. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 481
   Official Docker MCP registry 

878. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 480
   小红书MCP服务 x-s x-t js逆向

879. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 480
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

880. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 479
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

881. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 479
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

882. **[opentabs](https://github.com/opentabs-dev/opentabs)** - ⭐ 479
   Browser automation clicks buttons. OpenTabs calls APIs.

883. **[vmlx](https://github.com/jjang-ai/vmlx)** - ⭐ 479
   vMLX - Home of JANG_Q - Cont Batch, Prefix, Paged, KV Cache Quant, VL - Powers MLX Studio. Image gen/edit, OpenAI/Anth

884. **[director](https://github.com/fdmtl/director)** - ⭐ 478
   MCP Playbooks for AI agents

885. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 478
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

886. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 477
   Local MCP server for DuckDB and MotherDuck

887. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 477
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

888. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 477
   A docker MCP Server (modelcontextprotocol)

889. **[director](https://github.com/director-run/director)** - ⭐ 476
   MCP Playbooks for AI agents

890. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 476
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

891. **[travel-hacking-toolkit](https://github.com/borski/travel-hacking-toolkit)** - ⭐ 475
...
892. **[docfork](https://github.com/docfork/docfork)** - ⭐ 474
   Docfork - Context for AI Coding Agents.

893. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 474

894. **[google-ads-mcp](https://github.com/googleads/google-ads-mcp)** - ⭐ 474

895. **[cordum](https://github.com/cordum-io/cordum)** - ⭐ 473
...
896. **[swarmclaw](https://github.com/swarmclawai/swarmclaw)** - ⭐ 473
...
897. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 472
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

898. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 472
   An SDK building Laravel MCP servers

899. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 471
   Aser is a lightweight, self-assembling AI Agent frame.

900. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 466
   Things.app MCP Server

901. **[blockrun-mcp](https://github.com/BlockRunAI/blockrun-mcp)** - ⭐ 465
   Live data for AI agents — search, research, markets, crypto, X/Twitter. Pay-per-call via x402 micropayments.

902. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 465
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

903. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 463
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

904. **[arkon](https://github.com/nduckmink/arkon)** - ⭐ 461
...
905. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 460
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

906. **[claude-code-skills](https://github.com/levnikolaevich/claude-code-skills)** - ⭐ 460
...
907. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 459
...
908. **[roam-code](https://github.com/Cranot/roam-code)** - ⭐ 459
...
909. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 457
   An implementation of Model Context Protocol (MCP) server for Argo CD.

910. **[scarf](https://github.com/awizemann/scarf)** - ⭐ 456
...
911. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 455
   MCP server that execute applescript giving you full control of your Mac

912. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 452
...
913. **[awesome-ai-tools-for-ui](https://github.com/maxbogo/awesome-ai-tools-for-ui)** - ⭐ 452
   Curated list of awesome AI tools to build beautiful UI/UX.

914. **[welsonjs](https://github.com/gnh1201/welsonjs)** - ⭐ 451
   WelsonJS - Build a Windows app on the Windows built-in JavaScript engine

915. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 451
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

916. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 450
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

917. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 449
   The AI-powered toolkit that grows your YouTube channel on autopilot.

918. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 448
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

919. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 447
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

920. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

921. **[nexus](https://github.com/nexus-ai-labs/nexus)** - ⭐ 446
   Govern & Secure your AI

922. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 446
   Search Airbnb using your AI Agent

923. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 446
   MCP server to access Garmin data

924. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 445
...
925. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 444
...
926. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 444
   Send emails directly from Cursor with this email sending MCP server

927. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 443
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

928. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 443
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

929. **[claw-orchestrator](https://github.com/Enderfga/claw-orchestrator)** - ⭐ 442
...
930. **[mcp](https://github.com/cloudflare/mcp)** - ⭐ 440
   MCP server for the Cloudflare API

931. **[ZeroToken](https://github.com/AMOS144/ZeroToken)** - ⭐ 439
...
932. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 438
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

933. **[auto-browser](https://github.com/LvcidPsyche/auto-browser)** - ⭐ 438
   Give your AI agent a real browser — with a human in the loop. Open-source MCP-native browser agent.

934. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 437
   lunar.dev: Agent native MCP Gateway for governance and security

935. **[swarmvault](https://github.com/swarmclawai/swarmvault)** - ⭐ 435
...
936. **[mateclaw](https://github.com/matevip/mateclaw)** - ⭐ 435
...
937. **[Security-Detections-MCP](https://github.com/MHaggis/Security-Detections-MCP)** - ⭐ 434
   MCP to help Defenders Detection Engineer Harder and Smarter

938. **[freee-mcp](https://github.com/freee/freee-mcp)** - ⭐ 434
   Model Context Protocol (MCP) server for freee API integration

939. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 433
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

940. **[memorix](https://github.com/AVIDS2/memorix)** - ⭐ 433
...
941. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 432
...
942. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 431
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

943. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 431
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

944. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 431
   A CLI inspector for the Model Context Protocol

945. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 431
   Spec-Driven Development MCP Server, not just Vibe Coding

946. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 429
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

947. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 429
...
948. **[n8n-claw](https://github.com/freddy-schuetz/n8n-claw)** - ⭐ 429
...
949. **[yupi-hot-monitor](https://github.com/liyupi/yupi-hot-monitor)** - ⭐ 429
...
950. **[openclaw-claude-code](https://github.com/Enderfga/openclaw-claude-code)** - ⭐ 428
...
951. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 426
   Govern & Secure your AI

952. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 425
   Baidu Map MCP Server

953. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 423

954. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 423
   Create agentic AI workflows in ROBLOX Studio

955. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 422
...
956. **[skylos](https://github.com/duriantaco/skylos)** - ⭐ 422
...
957. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 422
...
958. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 421
   基于 SSH 的 MCP 服务 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

959. **[hope-agent](https://github.com/shiwenwen/hope-agent)** - ⭐ 421
...
960. **[sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh)** - ⭐ 420
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

961. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 419
   Memento MCP: A Knowledge Graph Memory System for LLMs

962. **[mq](https://github.com/harehare/mq)** - ⭐ 419
   A jq-like Markdown query language for command-line processing

963. **[station](https://github.com/cloudshipai/station)** - ⭐ 419
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

964. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 418
   Unlock 650+ MCP servers tools in your favorite agentic framework.

965. **[stitch](https://github.com/gemini-cli-extensions/stitch)** - ⭐ 417
   The Stitch extension for Gemini CLI enables you to interact with the Stitch MCP server using natural language commands. 

966. **[katmer-code](https://github.com/hkcanan/katmer-code)** - ⭐ 417
   Claude Code inside Obsidian — academic research skills, inline diff editing, MCP support

967. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 416
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

968. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 416
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

969. **[Agent](https://github.com/macOS26/Agent)** - ⭐ 416
...
970. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 415
...
971. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 414
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

972. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 414
   MCP server for JADX-AI Plugin

973. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 414
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

974. **[RenderDocMCP](https://github.com/halby24/RenderDocMCP)** - ⭐ 413

975. **[speakeasy](https://github.com/speakeasy-api/speakeasy)** - ⭐ 410
...
976. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 408
   OpenSkills: Run Claude Skills Locally using any LLM

977. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 408
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

978. **[lsbot](https://github.com/ruilisi/lsbot)** - ⭐ 407
   Lean & Secure Bot

979. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 407
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

980. **[distributed-load-testing-on-aws](https://github.com/aws-solutions/distributed-load-testing-on-aws)** - ⭐ 405
...
981. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 404
   The safest way to make REST calls in C# with an MCP Generator

982. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 402
...
983. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 402
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

984. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 401

985. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 401
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

986. **[memora](https://github.com/agentic-box/memora)** - ⭐ 400
   Give your AI agents persistent memory.

987. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 400
...
988. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 398
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

989. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 398
   An MCP implementation for Selenium WebDriver

990. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 398
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

991. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 398
   MCP Server for interacting with Salesforce instances

992. **[WyckoffTradingAgent](https://github.com/YoungCan-Wang/WyckoffTradingAgent)** - ⭐ 397
...
993. **[tentix](https://github.com/labring/tentix)** - ⭐ 396
...
994. **[ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)** - ⭐ 396
   Headless IDA Pro MCP Server

995. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 395
   Control your Android devices with AI using Model Context Protocol

996. **[geo-optimizer-skill](https://github.com/Auriti-Labs/geo-optimizer-skill)** - ⭐ 395
...
997. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 394
...
998. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 394
   An MCP server for loading skills (shim for non-claude clients).

999. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 393
   An experiment in software planning using MCP

1000. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 392
   MCP Server for code graph analysis and visualization by CodeGPT

1001. **[Context-Engine](https://github.com/Context-Engine-AI/Context-Engine)** - ⭐ 392
   Context-Engine MCP - Agentic Context Compression Suite

1002. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 391
   MCP server for Todoist integration enabling natural language task management with Claude

1003. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 391
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

1004. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 390
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

1005. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 390
   Local Groq Desktop chat app with MCP support

1006. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 389
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

1007. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 389
   F2C MCP Server

1008. **[devopness](https://github.com/devopness/devopness)** - ⭐ 389
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

1009. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 388
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

1010. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 388
   Xiaozhi MCP sample program

1011. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 386
   A centralized reverse-proxy platform for MCP servers — manage, group, and export as Skills from a single endpoint.

1012. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 386
   MCP server retrieving transcripts of YouTube videos

1013. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 386
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

1014. **[skillport](https://github.com/gotalab/skillport)** - ⭐ 385
   Bring Agent Skills to Any AI Agent and Coding Agent — via CLI or MCP. Manage once, serve anywhere.

1015. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 385
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

1016. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 384
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

1017. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 384
   A list of open-source AI projects you can use to generate income easily.

1018. **[clawreins](https://github.com/pegasi-ai/clawreins)** - ⭐ 383
   Runtime security for OpenClaw agents. Scan, fix, monitor.

1019. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 383
   Model Context Protocol server for GraphQL

1020. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 383
   MCP Server implementation for Ableton Live OSC control

1021. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 383
   MCP server for searching and retrieving Claude Agent Skills using vector search

1022. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 382
   A macOS AppleScript MCP server

1023. **[PlanExe](https://github.com/PlanExeOrg/PlanExe)** - ⭐ 380
   Create a plan from a description in minutes

1024. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 380
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

1025. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 380
   MCP server connecting to Kubernetes

1026. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 380
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

1027. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 379
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

1028. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 379
...
1029. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 378
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

1030. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 376
...
1031. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 375
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

1032. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 375
   Model Context Protocol (MCP) Server for Graphlit Platform

1033. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 374
   MCP server that provides LLMs with tools for interacting with EVM networks

1034. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 374
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

1035. **[mcp](https://github.com/IBM/mcp)** - ⭐ 374
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

1036. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 374
   MCP Server implementation for Xcode integration

1037. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 374
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

1038. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 373
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

1039. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 373
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

1040. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 372
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

1041. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 372
   Docfork MCP - Up-to-date Docs for AI Agents.

1042. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 372
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

1043. **[daymon](https://github.com/daymonio/daymon)** - ⭐ 372
   Daymon puts your favorite AI to work 24/7. It schedules, remembers, and orchestrates your own virtual team. Free.

1044. **[PerformanceMonitor](https://github.com/erikdarlingdata/PerformanceMonitor)** - ⭐ 372
...
1045. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 371
   MCP server for Bazi (八字) information

1046. **[lingti-bot](https://github.com/ruilisi/lingti-bot)** - ⭐ 370
   🐕⚡「极简至上 效率为王 秒级接入 一链即用」的 AI Bot

1047. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 368
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

1048. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 368
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

1049. **[studio](https://github.com/decocms/studio)** - ⭐ 368
   Open-source control plane for your AI agents. Connect tools, hire agents, track every token and dollar

1050. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 367
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

1051. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 367
   MCP server for Claude to access Outlook data via Microsoft Graph API

1052. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 367
   Semantic code searcher and codebase utility

1053. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 366
   Elixir Model Context Protocol (MCP) SDK

1054. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 366
   deep, reliable and confidential coding-context

1055. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 366
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

1056. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 365
   Model Context Protocol SDK for PHP

1057. **[VTCode](https://github.com/vinhnx/VTCode)** - ⭐ 365
   VT Code - Semantic coding agent in the terminal

1058. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 365
   An MCP server for Azure DevOps

1059. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 364
   Lean Theorem Prover MCP

1060. **[Gearsystem](https://github.com/drhelius/Gearsystem)** - ⭐ 364
   Sega Master System / Game Gear / SG-1000 emulator, debugger and embedded MCP server for macOS, Windows, Linux, BSD and RetroArch.

1061. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 364
...
1062. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 363
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

1063. **[token-optimizer-mcp](https://github.com/ooples/token-optimizer-mcp)** - ⭐ 363
...
1064. **[coolify-mcp](https://github.com/StuMason/coolify-mcp)** - ⭐ 363
   MCP server for Coolify — 38 optimized tools for managing self-hosted PaaS through AI assistants

1065. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 359
   First AI‑enabled open-source Human Capital Management system that you can start using today.

1066. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 359
   MCP server to expose VS Code editing features to an LLM for AI coding

1067. **[pinion-os](https://github.com/chu2bard/pinion-os)** - ⭐ 357
   Client SDK, Claude plugin and skill framework for the Pinion protocol. x402 micropayments on Base.

1068. **[vtcode](https://github.com/vinhnx/vtcode)** - ⭐ 355
   VT Code - Semantic coding agent in the terminal

1069. **[hookdeck-cli](https://github.com/hookdeck/hookdeck-cli)** - ⭐ 355
...
1070. **[entroly](https://github.com/juyterman1000/entroly)** - ⭐ 354
...
1071. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 353
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

1072. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 351
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

1073. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 350

1074. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 350
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

1075. **[boltmcp](https://github.com/boltmcp/boltmcp)** - ⭐ 349

1076. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 349
...
1077. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 349
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

1078. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 349
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

1079. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 348
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

1080. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 347
   AI-Powered Revit Modeling

1081. **[mcp](https://github.com/oracle/mcp)** - ⭐ 347
...
1082. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 347
...
1083. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 347
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1084. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 346
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

1085. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 346
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1086. **[zypher-agent](https://github.com/corespeed-io/zypher-agent)** - ⭐ 345
   A minimal yet powerful framework for creating AI agents with full control over tools, providers, and execution flow.

1087. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 345
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

1088. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 344
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

1089. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 343
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

1090. **[designing-real-world-ai-agents-workshop](https://github.com/iusztinpaul/designing-real-world-ai-agents-workshop)** - ⭐ 343
...
1091. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 342
...
1092. **[Aegis](https://github.com/Justin0504/Aegis)** - ⭐ 341
...
1101. **[mesh](https://github.com/decocms/mesh)** - ⭐ 337
   One secure endpoint for every MCP server. Deploy anywhere.

1102. **[moling](https://github.com/gojue/moling)** - ⭐ 336
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

1103. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 336
   Example of an MCP server with custom tools that can be called directly from cursor

1104. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 336
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

1105. **[wexin-read-mcp](https://github.com/Bwkyd/wexin-read-mcp)** - ⭐ 335
   能够让大模型阅读微信公众号文章，使用浏览器模拟绕过反爬虫。

1106. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 333

1107. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 332
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

1108. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 332
...
1109. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 332
   Model Context Protocol server for DeepSeek's advanced language models

1110. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 331
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

1111. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

1112. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 331
...
1113. **[meta-ads-analyzer](https://github.com/mathiaschu/meta-ads-analyzer)** - ⭐ 331
   Meta Ads Analyzer skill + MCP server for Claude Code. Breakdown Effect, Learning Phase, and expert-level campaign diagnosis.

1114. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 331
   CAD MCP Server

1115. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 330

1116. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 330
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

1117. **[STS2MCP](https://github.com/Gennadiyev/STS2MCP)** - ⭐ 330
   Full agentic runs for Slay the Spire 2. A mod that exposes in-game state, and the MCP server for the mod.

1118. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 330
...
1119. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 329
   Lightweight MCP server for Spotify

1120. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 329
   An MCP server for Massive.com Financial Market Data

1121. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 328
   A Model Context Protocol server for building an investor agent

1122. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 327
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

1123. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 326
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

1124. **[unifi-mcp](https://github.com/sirkirby/unifi-mcp)** - ⭐ 326
   MCP servers for the UniFi suite of applications, Network, Protect, Access, and Drive

1125. **[safe-mcp](https://github.com/safe-agentic-framework/safe-mcp)** - ⭐ 325
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

1126. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 325
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

1127. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 324
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

1128. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 323
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

1129. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 323
   Source code of minecraft 1.12

1130. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 322

1131. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
1132. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 322

1133. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 322
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

1134. **[emcee](https://github.com/mattt/emcee)** - ⭐ 321
   MCP generator for OpenAPIs 🫳🎤💥

1135. **[cymbal-air-toolbox-demo](https://github.com/GoogleCloudPlatform/cymbal-air-toolbox-demo)** - ⭐ 321
...
1136. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 321
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

1137. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 320
   Software architecture tooling for the AI age

1138. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 320

1139. **[generator](https://github.com/context-hub/generator)** - ⭐ 320
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

1140. **[pydantic-resolve](https://github.com/allmonday/pydantic-resolve)** - ⭐ 319
   A universal data composition tool that generates JSON RPC, GraphQL, and even MCP.

1141. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 319
   MCP server for Windows OS automation

1142. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 318
   This is a Minecraft Base Client

1143. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 318
...
1144. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 318
   Repo of skills for autogen studio using model context protocol (mcp)

1145. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 318
   MCP stdio server for frida

1146. **[deep-research-mcp](https://github.com/teelaitila/deep-research-mcp)** - ⭐ 317

1147. **[DebugMCP](https://github.com/microsoft/DebugMCP)** - ⭐ 316
   Gift your VS Code agent a real debugger: breakpoints, stepping, inspection.

1148. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 316
...
1149. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 315
...
1150. **[gemini-kit](https://github.com/nth5693/gemini-kit)** - ⭐ 314
   🚀 19 AI Agents + 44 Commands for Gemini CLI - Code 10x faster with auto planning, testing, review & security

1151. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 314
...
1152. **[sigmap](https://github.com/manojmallick/sigmap)** - ⭐ 314
   97% token reduction for AI coding sessions — zero deps, 21 languages, MCP server

1153. **[octo-terminal-releases](https://github.com/johunsang/octo-terminal-releases)** - ⭐ 313
...
1154. **[arcticdb_mcp](https://github.com/YMuskrat/arcticdb_mcp)** - ⭐ 313
   MCP server for ArcticDB

1155. **[kindly-web-search-mcp-server](https://github.com/Shelpuk-AI-Technology-Consulting/kindly-web-search-mcp-server)** - ⭐ 313
...
1156. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 313
   MCP server for TouchDesigner

1157. **[ai-polymarket-agent](https://github.com/kaktusesquire6rmu/ai-polymarket-agent)** - ⭐ 312
...
1158. **[codemogger](https://github.com/glommer/codemogger)** - ⭐ 312
   Codemogger is a code indexing library and MCP server for AI coding agents

1159. **[agents](https://github.com/astronomer/agents)** - ⭐ 312
   AI agent tooling for data engineering workflows.

1160. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 311
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

1161. **[agentic-ai-apis](https://github.com/cporter202/agentic-ai-apis)** - ⭐ 311
...
1162. **[claude-code-tool-manager](https://github.com/tylergraydev/claude-code-tool-manager)** - ⭐ 311
   GUI app to manage MCP servers for Claude Code

1163. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 311
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1164. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 310
   MCP Server for Odoo

1165. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 310
...
1166. **[cross-code-organizer](https://github.com/mcpware/cross-code-organizer)** - ⭐ 310
...
1167. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 309

1168. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 309
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

1169. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 308
   mcp store manager, add & syncs MCP server configurations across clients like Claude code, Cursor💡mcphub

1170. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 308
   An MCP server providing tools for image processing operations

1171. **[polymarket-paper-trader](https://github.com/agent-next/polymarket-paper-trader)** - ⭐ 308
...
1172. **[clawdcursor](https://github.com/AmrDab/clawdcursor)** - ⭐ 307
...
1173. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 307
   api router for MCP Servers

1174. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 307
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1175. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 306
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

1176. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 306
   Turn any openapi file into an mcp server, with just the tools you need.

1177. **[Octopoda-OS](https://github.com/RyjoxTechnologies/Octopoda-OS)** - ⭐ 306
...
1178. **[bernstein](https://github.com/sipyourdrink-ltd/bernstein)** - ⭐ 306
...
1179. **[sdk](https://github.com/smithery-ai/sdk)** - ⭐ 305
   Smithery helps AI agents access external services via a unified gateway.

1180. **[AIDA](https://github.com/Vasco0x4/AIDA)** - ⭐ 305
   AI-Driven Security Assessment - Connect AI to 400+ pentesting tools via MCP

1181. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 305
   Appium MCP on Steroids!

1182. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 304
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

1183. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 304
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1184. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 303
   A working pattern for SSE-based MCP clients and servers

1185. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 303
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

1186. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 303
   MCP Server for Tree-sitter

1187. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 303
...
1188. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 303
   Obsidian MCP (Model Context Protocol) Server

1189. **[Lucid](https://github.com/get-Lucid/Lucid)** - ⭐ 302
   An intelligence layer grounding autonomous agents in verified, real-time knowledge at scale.

1190. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 302
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

1191. **[Dex](https://github.com/davekilleen/Dex)** - ⭐ 301
   Your AI Chief of Staff — a personal operating system starter kit that adapts to your role. No coding required.

1192. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 300
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

1193. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 300
   MCP implementation of Claude Code capabilities and more

1194. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 300
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

1195. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 300
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

1196. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 299
   Discover Exceptional MCP Servers

1197. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 299
   Agentic RAG for any scenario. Customize sources, depth, and width

1198. **[Ori-Mnemos](https://github.com/aayoawoyemi/Ori-Mnemos)** - ⭐ 299
   Local-first persistent agentic memory powered by Recursive Memory Harness (RMH). Open source must win.

1199. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 298
   SpringAI，LLM，MCP，Embedding

1200. **[certctl](https://github.com/shankar0123/certctl)** - ⭐ 298
...
1201. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 297
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

1202. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 296
   Minimal MCP Server for Aider

1203. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 295
   The specification for the Universal Tool Calling Protocol

1204. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 295
...
1205. **[consult7](https://github.com/szeider/consult7)** - ⭐ 295
   MCP server to consult a language model with large context size

1206. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 295
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

1207. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 295
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

1208. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 295
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1209. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 294
   Home Assistant MCP Server

1210. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 293
...
1211. **[elementor-mcp](https://github.com/msrbuilds/elementor-mcp)** - ⭐ 293
...
1212. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 292
   Apache Doris MCP Server

1213. **[h1-brain](https://github.com/PatrikFehrenbach/h1-brain)** - ⭐ 292
   MCP server that connects AI assistants to HackerOne for bug bounty hunting

1214. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 291

1215. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 291

1216. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 291
...
1217. **[godot-mcp](https://github.com/tomyud1/godot-mcp)** - ⭐ 291
   MCP Server and Godot Plugin for AI-assisted game development

1218. **[daan](https://github.com/pluveto/daan)** - ⭐ 290
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

1219. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 290
   Standardized environment infrastructure for Agentic AI development.

1220. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 290
...
1221. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 290
   MCP server for browser automation using Playwright

1222. **[agent-trade-kit](https://github.com/okx/agent-trade-kit)** - ⭐ 290
   OKX trading MCP server — connect AI agents to spot, swap, futures, options & grid bots via the Model Context Protocol.  

1223. **[novamira](https://github.com/use-novamira/novamira)** - ⭐ 288
   MCP server that gives AI agents full access to WordPress through PHP execution and filesystem operations

1224. **[mcp-manager](https://github.com/amxv/mcp-manager)** - ⭐ 288
   simple web ui to manage mcp (model context protocol) servers in the claude app

1225. **[nova-proximity](https://github.com/Nova-Hunting/nova-proximity)** - ⭐ 287
   Nova-Proximity is a MCP and Agent Skills security scanner powered with NOVA

1226. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 287
...
1227. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 286
   MCP server for OpenAI o3 web search

1228. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 286
   Volcengine MCP Servers

1229. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 286
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

1230. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 285
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

1231. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 285
   Code to process many kinds of content by an author into an MCP server

1232. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 284
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

1233. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 284
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

1234. **[alfanous](https://github.com/Alfanous-team/alfanous)** - ⭐ 284
   Alfanous is an Arabic search engine API provides the simple and advanced search in Quran , more features and many interfaces...

1235. **[awesome-fintech](https://github.com/moov-io/awesome-fintech)** - ⭐ 284
   A curated collection of open source fintech libraries and resources.

1236. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 284
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1237. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 283
   Model Context Protocol server implementation for Reddit

1238. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 283
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

1239. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 282
   Bringing Human Capabilities to AI Agents

1240. **[unity-cli-loop](https://github.com/hatayama/unity-cli-loop)** - ⭐ 282
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1241. **[claude-code-organizer](https://github.com/mcpware/claude-code-organizer)** - ⭐ 282
...
1242. **[marionette_mcp](https://github.com/leancodepl/marionette_mcp)** - ⭐ 282
...
1243. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 282
   Model Context Protocol for x64dbg & x32dbg

1244. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

1245. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 281
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

1246. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 280
   simple web ui to manage mcp (model context protocol) servers in the claude app

1247. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 280
   Apollo MCP Server

1248. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 279
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

1249. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 279
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

1250. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 279
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1251. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 278
   MCP integration platforms making AI-Agents developers focusing on their own tasks

1252. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 278
   A Model Context Protocol Server for MongoDB

1253. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 278
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

1254. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 278
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

1255. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 277
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

1256. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 277
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

1257. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 277
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

1258. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 277
...
1259. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 276
   Context-Engine MCP - Agentic Context Compression Suite

1260. **[godot-mcp-pro](https://github.com/youichi-uda/godot-mcp-pro)** - ⭐ 276
...
1261. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 276
   Model Context Protocol (MCP) Server for dify workflows

1262. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 276
   Lightweight agent orchestration dev tool that lives in your repo

1263. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 275
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

1264. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 275
   A MCP server for our beloved terminal multiplexer tmux.

1265. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 274
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

1266. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 274
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

1267. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 274
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

1268. **[domain-check](https://github.com/saidutt46/domain-check)** - ⭐ 274
...
1269. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 273
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1270. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 273
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

1271. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 273
   Lightweight C++ MCP (Model Context Protocol) SDK

1272. **[beever-atlas](https://github.com/Beever-AI/beever-atlas)** - ⭐ 273
   Your First LLM-Wiki Conversation Knowledge Base

1273. **[api-agent](https://github.com/agoda-com/api-agent)** - ⭐ 272
   Universal MCP server for GraphQL/REST APIs

1274. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 272
   Penpot's official MCP Server

1275. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 272
...
1276. **[proximity](https://github.com/Nova-Hunting/proximity)** - ⭐ 271
   Proximity is a MCP security scanner powered with NOVA

1277. **[BitFun](https://github.com/GCWing/BitFun)** - ⭐ 270
...
1278. **[vibing-steampunk](https://github.com/oisee/vibing-steampunk)** - ⭐ 270
   vs-punk: ADT to MCP bridge - Vibe code in ABAP / AMDP

1279. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 270
   Bring your project into LLM context - tool and MCP server

1280. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 270
   A collection of MCP servers

1281. **[flyto-core](https://github.com/flytohub/flyto-core)** - ⭐ 270
   The open-source execution engine for AI agents. 412 modules, MCP-native, triggers, queue, versioning, metering.

1282. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 270
   AWS MCP Proxy Server

1283. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

1284. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 268
   An introduction to the world of AI Agents

1285. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 266
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1286. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 265
   小智AI客户端，目前主要用于MCP的对接

1287. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 264
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

1288. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 264
...
1289. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 264
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

1290. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 264
   Tableau's official MCP Server. Helping Agents see and understand data.

1291. **[ctx](https://github.com/stevesolun/ctx)** - ⭐ 263
...
1292. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 263
   A SEC EDGAR MCP (Model Context Protocol) Server

1293. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 262
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

1294. **[medusa](https://github.com/Pantheon-Security/medusa)** - ⭐ 261
...
1295. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 261
...
1296. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 259
...
1297. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 259
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

1298. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 259
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1299. **[purple](https://github.com/erickochen/purple)** - ⭐ 259
...
1300. **[corpusos](https://github.com/Corpus-OS/corpusos)** - ⭐ 258
...
1301. **[agentrove](https://github.com/Mng-dev-ai/agentrove)** - ⭐ 258
...
1302. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 258
...
1303. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 257
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1304. **[swiss-ai-call-agent](https://github.com/Chrissotino/swiss-ai-call-agent)** - ⭐ 256
...
1305. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 256
   Zerodha Kite MCP server

1306. **[pentest-agents](https://github.com/H-mmer/pentest-agents)** - ⭐ 256
   Bug bounty agent framework for Claude Code, Codex, Gemini, Cursor, Windsurf, Copilot, and OpenClaw — 48 agents, 26 commands, 19 CLI tools, 2 MCP servers, autonomous hunt loops, exploit chain builder.

1307. **[api200](https://github.com/API-200/api200)** - ⭐ 255
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

1308. **[agent-craft](https://github.com/Annyfee/agent-craft)** - ⭐ 255
   AI Agent 教学仓库 | 系统化 LangChain、RAG、LangGraph、MCP 全栈实战代码 | 万字博客详解 | 开源可运行示例 | 从零构建智能体

1309. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 255
...
1310. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 254
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

1311. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 254
   Fast-track AI innovation with a centralized, trusted, curated registry

1312. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 254
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

1313. **[data-go-mcp-servers](https://github.com/Koomook/data-go-mcp-servers)** - ⭐ 254
   Korea public data portal (data.go.kr) API MCP servers

1314. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 254
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1315. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 253
   A code reasoning MCP server, a fork of sequential-thinking

1316. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

1317. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 253
...
1318. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 252
...
1319. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 252
   hydra-ai

1320. **[AgentRecall-MCP](https://github.com/Goldentrii/AgentRecall-MCP)** - ⭐ 252
...
1321. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 252
   Local-first RAG server for developers. Semantic + keyword search for code and technical docs. Works with MCP or CLI. Fully private, zero setup.

1322. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 251
...
1323. **[vurb.ts](https://github.com/vinkius-labs/vurb.ts)** - ⭐ 250
...
1324. **[AgentRecall](https://github.com/Goldentrii/AgentRecall)** - ⭐ 250
   AI Session Memory with Think-Execute-Reflect Quality Loops — give your agent a brain that survives every session. Built on the Intelligent Distance principle.

1325. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 250
   MCP Server for ServiceNow

1326. **[agentseal](https://github.com/getagentseal/agentseal)** - ⭐ 250
   Security toolkit for AI agents. Scan your machine for dangerous skills and MCP configs, monitor for supply chain attacks, test prompt injection resistance, and audit live MCP servers for tool poisoning.

1327. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 249
   MCP server implementation for Google's Gemini API

1328. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 249
   Opensource Memory for Agents

1329. **[call.md](https://github.com/video-db/call.md)** - ⭐ 249
...
1330. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 249
   Turn any MCP server into a Python module

1331. **[CoWork-OS](https://github.com/CoWork-OS/CoWork-OS)** - ⭐ 249
...
1332. **[mcp-dev-latam](https://github.com/codespar/mcp-dev-latam)** - ⭐ 249
   MCP servers for Brazilian services — payments, fiscal, banking, communication. Generated by CodeSpar.

1333. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 249
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1334. **[Claude-Code-AI-Design](https://github.com/Julpygo/Claude-Code-AI-Design)** - ⭐ 249
...
1335. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 249
...
1336. **[solomd](https://github.com/zhitongblog/solomd)** - ⭐ 249
   A markdown editor — and the bridge to your LLM. Local-first, MIT, ~15 MB. Bundled MCP server lets Claude Code / Codex / Cursor drive your vault directly. 14 AI providers BYOK.

1337. **[MoltBrain](https://github.com/nhevers/MoltBrain)** - ⭐ 248
   Long-term memory layer for OpenClaw & MoltBook agents that learns and recalls your project context automatically.

1338. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 248
   MCP server(s) for Aipolabs ACI.dev

1339. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 248
   MCP Interface for Video Jungle

1340. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 248
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

1341. **[JoySafeter](https://github.com/jd-opensource/JoySafeter)** - ⭐ 248
...
1342. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 248
   💻 Give AI models complete control of your computer (probably a bad idea)

1343. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 248
   Sketchup Model Context Protocol

1344. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 247
   An experimental MCP Server for foundry built for Solidity devs

1345. **[claude-recall](https://github.com/nhevers/claude-recall)** - ⭐ 247
   Long-term memory layer for MoltBot & Claude Code that learns and recalls your project context automatically

1346. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 247
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

1347. **[dat](https://github.com/hexinfo/dat)** - ⭐ 247
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

1348. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 247
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1349. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 246
   The evaluation benchmark on MCP servers

1350. **[lokka](https://github.com/merill/lokka)** - ⭐ 246
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

1351. **[copilot-plugins](https://github.com/github/copilot-plugins)** - ⭐ 246
   The official GitHub Copilot plugins collection — MCP servers, skills, hooks, and other extensibility tools for GitHub Copilot.

1352. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 245
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

1353. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 244
...
1354. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 244
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

1355. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 244
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

1356. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 244
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

1357. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 244
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1358. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 243
   🔥 Model Context Protocol (MCP) server for Firebase.

1359. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 243
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

1360. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 243
   MCP Server for Telegram

1361. **[embodied-claude](https://github.com/lifemate-ai/embodied-claude)** - ⭐ 243
   Claudeに身体性を与えるMCP群

1362. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 242
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

1363. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 242
...
1364. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 242
   Simplified Gemini for Claude Code. 

1365. **[claude-in-mobile](https://github.com/AlexGladkov/claude-in-mobile)** - ⭐ 242
...
1366. **[sap-ai-mcp-servers](https://github.com/marianfoo/sap-ai-mcp-servers)** - ⭐ 242
   A complete list of SAP MCP Servers and SAP AI Skills

1367. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 241
   Code Runner MCP Server

1368. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 240
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

1369. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 240
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

1370. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 240
   Easy guide to installing Claude Code MCPs globally on your machine.

1371. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 239
   Playwright MCP fork that works with Cloudflare Browser Rendering

1372. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

1373. **[Google-Research-MCP](https://github.com/mixelpixx/Google-Research-MCP)** - ⭐ 239
...
1374. **[flutter-skill](https://github.com/ai-dashboad/flutter-skill)** - ⭐ 239
...
1375. **[claudit-sec](https://github.com/HarmonicSecurity/claudit-sec)** - ⭐ 239
...
1376. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 238

1377. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 238
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

1378. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 238
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1379. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 238
   MCP server for Anki via AnkiConnect

1380. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 237
   MCP Server built for use with Claude Code, Claude Desktop, VS Code, Cline  - enable google search and ability to follow links and research websites

1381. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 237
...
1382. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 236
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

1383. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 236
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

1384. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 236
...
1385. **[mcp-engine-public](https://github.com/maxanatsko/mcp-engine-public)** - ⭐ 236
...
1386. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 236
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

1387. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 236
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

1388. **[mcp-todoist](https://github.com/greirson/mcp-todoist)** - ⭐ 236
   MCP server that connects Claude to Todoist for natural language task and project   management with bulk operations

1389. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 235
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1390. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 235
   Autonomous SWE agent working in the cloud!

1391. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 235
...
1392. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 235
   Connect your AI to your APIs on Postman

1393. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 234
   A Model Context Protocol (MCP) server that enables natural language queries to databases

1394. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 234
   Hugging Face MCP Server

1395. **[Charles-mcp](https://github.com/heizaheiza/Charles-mcp)** - ⭐ 234
   Charles Proxy MCP server for AI agents with live capture, structured traffic analysis, and agent-friendly tool contracts

1396. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 233
...
1397. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 233
   Homeassistant MCP server for 小智AI

1398. **[LycheeMem](https://github.com/LycheeMem/LycheeMem)** - ⭐ 233
   Lightweight Long-Term Memory for LLM Agents.

1399. **[jebmcp](https://github.com/flankerhqd/jebmcp)** - ⭐ 233

1400. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 233
   IMAP and SMTP via MCP Server

1401. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 232
...
1402. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 232
   Creates a simple MCP tool server with "streaming" HTTP.

1403. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 232
   A Model Context Protocol (MCP) server for interacting with Twitter.

1404. **[godot-ai](https://github.com/hi-godot/godot-ai)** - ⭐ 232
   Production-grade MCP server and AI tools for the Godot engine. A Snap to install. Totally free and fun.

1405. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 231
   Model Context Protocol Servers for Milvus

1406. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 230
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

1407. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 230
   🧰 All-in-one domain name intelligence as a service

1408. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 230
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

1409. **[STS2-Agent](https://github.com/CharTyr/STS2-Agent)** - ⭐ 230
   杀戮尖塔2的MOD，将杀戮尖塔2的游戏状态与操作暴露为本地 HTTP API 包装成 MCP Server，供支持 MCP 的AI客户端直接调用

1410. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 229
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

1411. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 229
   mindmap, mcp server, artifact

1412. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 229
   Penpot MCP server

1413. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 229
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1414. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 228
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

1415. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 228
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

1416. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 228
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1417. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 228
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1418. **[pasal](https://github.com/ilhamfp/pasal)** - ⭐ 228
...
1419. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1420. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 227
...
1421. **[awesome-osint-mcp-servers](https://github.com/soxoj/awesome-osint-mcp-servers)** - ⭐ 226
   A curated list of OSINT MCP servers. Pull requests are welcomed!

1422. **[HarnessKit](https://github.com/RealZST/HarnessKit)** - ⭐ 226
...
1423. **[agent-skills-hub](https://github.com/zhuyansen/agent-skills-hub)** - ⭐ 226
...
1424. **[agent-skills](https://github.com/jdrhyne/agent-skills)** - ⭐ 225
   A collection of AI agent skills for Clawdbot, Claude Code, Codex

1425. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 225
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1426. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 225

1427. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 225
   Neo4j official MCP Server

1428. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 225
   MCP stdio server for radare2

1429. **[scrumboy](https://github.com/markrai/scrumboy)** - ⭐ 224
   Self-hosted kanban & project management with shareable boards, voice commands, sticky-notes and MCP support

1430. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 224
   Model Context Protocol server to run commands (tool: `runProcess`)

1431. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 224
   Your own Claude Code UI, sandbox, in-browser VS Code, terminal, multi-provider support (Anthropic, OpenAI, GitHub Copilot, OpenRouter), custom skills, and MCP servers.

1432. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 224
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

1433. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 224
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1434. **[skyll](https://github.com/assafelovic/skyll)** - ⭐ 223
   A tool for autonomous agents like OpenClaw to discover and learn skills autonomously

1435. **[AutoResearch-SibylSystem](https://github.com/Sibyl-Research-Team/AutoResearch-SibylSystem)** - ⭐ 223
   Fully Autonomous AI Research System with Self-Evolution, built natively on Claude Code

1436. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 222

1437. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 222
...
1438. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 222

1439. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 222
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

1440. **[ATaC](https://github.com/ATaC-team/ATaC)** - ⭐ 222
   Record and Replay AI Agent Trajectories.

1441. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 222
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1442. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 221

1443. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 221
...
1444. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 221
   Tools to allow LLM clients to interact with Linux systems remotely

1445. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
1446. **[mcp-dev-brasil](https://github.com/codespar/mcp-dev-brasil)** - ⭐ 219
   MCP servers for Brazilian services — payments, fiscal, banking, communication. Generated by CodeSpar.

1447. **[registry-broker-skills](https://github.com/hashgraph-online/registry-broker-skills)** - ⭐ 219
   AI agent skills for the Universal Registry - search, chat, and register 72,000+ agents across 14+ protocols. Works with Claude, Codex, Cursor, OpenClaw, and any AI assistant.

1448. **[Windows-MCP.Net](https://github.com/shuyu-labs/Windows-MCP.Net)** - ⭐ 219
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

1449. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 219
   Razorpay's Official MCP Server

1450. **[OpenCode-Everything-You-Need-to-Know](https://github.com/wesammustafa/OpenCode-Everything-You-Need-to-Know)** - ⭐ 219
...
1451. **[readwise-skills](https://github.com/readwiseio/readwise-skills)** - ⭐ 219
...
1452. **[craft-agents-oss](https://github.com/warpdot-dev/craft-agents-oss)** - ⭐ 218
...
1453. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 218
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

1454. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 218
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1455. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 218
   🔎 A MCP server for Unsplash image search.

1456. **[facebook-ads-library-mcp](https://github.com/proxy-intell/facebook-ads-library-mcp)** - ⭐ 218
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1457. **[ai-code-interface.el](https://github.com/tninja/ai-code-interface.el)** - ⭐ 218
   Unified Emacs interface supporting OpenAI Codex, GitHub Copilot CLI, Claude Code, Gemini CLI, Opencode, and more

1458. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 217
   A Model Context Protocol (MCP) server providing access to Google Search Console

1459. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 216

1460. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 216
...
1461. **[harnss](https://github.com/OpenSource03/harnss)** - ⭐ 216
...
1462. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 216
...
1463. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 216
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1464. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 216
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1465. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 215
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

1466. **[airbroke](https://github.com/icoretech/airbroke)** - ⭐ 215
   🔥 Lightweight, Airbrake/Sentry-compatible, PostgreSQL-based Open Source Error Catcher

1467. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 214
   Agent MCP for ffmpeg

1468. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 214
   Run and monitor MCP servers locally

1469. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 214
...
1470. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 214
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1471. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 213
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1472. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

1473. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 213
...
1474. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 213
   Nextcloud MCP Server

1475. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 212
...
1476. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 212
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1477. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 212
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

1478. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 211
   Pure Rust implementation of MCP server for headless terminal 

1479. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 211
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

1480. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 210
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

1481. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 210
   An MCP server to use Sora video generation APIs

1482. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

1483. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 210
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

1484. **[Claude-code-ChatInWindows](https://github.com/LKbaba/Claude-code-ChatInWindows)** - ⭐ 210
...
1485. **[open-webui-plugins](https://github.com/Classic298/open-webui-plugins)** - ⭐ 210
   A curated collection of Open WebUI plugins - tools, skills, filters, pipes, and actions that extend your AI chat experience.

1486. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 210
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1487. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 210
   A ReAct-Based Highly Robust Autonomous Agent (Harness) Framework.

1488. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 210
   Supercharge AI Agents, Safely

1489. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 209

1490. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

1491. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 209
...
1492. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 209
   这是一个专为开发企业级MCP server而设计的通用开发框架

1493. **[Claude-Code-Frontend-Design-Toolkit](https://github.com/wilwaldon/Claude-Code-Frontend-Design-Toolkit)** - ⭐ 209
...
1494. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 208
   interactive programming of melodies, producing MIDI 

1495. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 208
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1496. **[cryptocurrency.cv](https://github.com/nirholas/cryptocurrency.cv)** - ⭐ 208
...
1497. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 207
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1498. **[mcp-launchpad](https://github.com/kenneth-liao/mcp-launchpad)** - ⭐ 207
...
1499. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 207
...
1500. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 207
   Self-hosted AI RAG + MCP Platform

1501. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 207
...
1502. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 207
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1503. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

1504. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 206
   MCP server for Dynatrace Observability

1505. **[AutoRedTeam-Orchestrator](https://github.com/Coff0xc/AutoRedTeam-Orchestrator)** - ⭐ 206
...
1506. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 206
...
1507. **[Corbell](https://github.com/Corbell-AI/Corbell)** - ⭐ 206
   AI-powered spec generation and review using multi-repo code graph intelligence for backend teams that ship to production.

1508. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 206
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

1509. **[agent-trade-kit](https://github.com/6551-Team/agent-trade-kit)** - ⭐ 205
...
1510. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 205
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

1511. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

1512. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

1513. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 205
   Model Context Protocol tool support for LangChain

1514. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 205
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1515. **[storybloq](https://github.com/Storybloq/storybloq)** - ⭐ 205
...
1516. **[mcp-fusion](https://github.com/vinkius-labs/mcp-fusion)** - ⭐ 204
   MCP Fusion - The framework for AI-native MCP servers. 

1517. **[sap-skills](https://github.com/secondsky/sap-skills)** - ⭐ 204
...
1518. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 204
   MCP Server for Wazuh SIEM

1519. **[pentest-ai](https://github.com/0xSteph/pentest-ai)** - ⭐ 204
...
1520. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 203
   A MCP Server for the RAG Web Browser Actor

1521. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 203
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1522. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 202
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1523. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 202
   A Tiny Terminal Chat App for AI Models with MCP Client Support

1524. **[CrowdSentinels-AI-MCP](https://github.com/thomasxm/CrowdSentinels-AI-MCP)** - ⭐ 202
   AI-powered threat hunting and incident response MCP server for Elasticsearch/OpenSearch

1525. **[ai-skills](https://github.com/sanjay3290/ai-skills)** - ⭐ 202
   Collection of agent skills for AI coding assistants

1526. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 202
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1527. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 202
...
1528. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 201
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1529. **[shodh-memory](https://github.com/varun29ankuS/shodh-memory)** - ⭐ 201
...
1530. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 201
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1531. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 201
   R MCP Server

1532. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 201
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1533. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 201
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

1534. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 201
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1535. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 201
   Learn how to use MCP Servers with GitHub Copilot

1536. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

1537. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 200
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1538. **[codefire-app](https://github.com/websitebutlers/codefire-app)** - ⭐ 200
...
1539. **[binary-ninja-headless-mcp](https://github.com/mrphrazer/binary-ninja-headless-mcp)** - ⭐ 200
   Headless Binary Ninja MCP server — giving AI agents deep reverse-engineering capabilities via 180 tools.

1540. **[live-coding-music-mcp](https://github.com/williamzujkowski/live-coding-music-mcp)** - ⭐ 200
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1541. **[monarch-mcp-server](https://github.com/robcerda/monarch-mcp-server)** - ⭐ 200
   MCP Server for use with Monarch Money

1542. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 199
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1543. **[ClaudeR](https://github.com/IMNMV/ClaudeR)** - ⭐ 199
...
1544. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 199
   Manage / Proxy / Secure your MCP Servers

1545. **[aleph](https://github.com/Hmbown/aleph)** - ⭐ 199
   Skill + MCP server to turn your agent into an RLM. Load context, iterate with search/code/think tools, converge on answers.

1546. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 199
   Discord MCP Server for Claude Integration

1547. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 199
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1548. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 198
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1549. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 198
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1550. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 198
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1551. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 198
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1552. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 198
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1553. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 198
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1554. **[ida-multi-mcp](https://github.com/MeroZemory/ida-multi-mcp)** - ⭐ 198
   Multi-instance IDA Pro MCP server — analyze multiple binaries simultaneously through a single MCP endpoint.

1555. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 197
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1556. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 197
...
1557. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1558. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 196
   MCP server implementation for the UniFi network application

1559. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 196
...
1560. **[mangaba_ai](https://github.com/Mangaba-ai/mangaba_ai)** - ⭐ 196
...
1561. **[memex](https://github.com/iamtouchskyer/memex)** - ⭐ 196
...
1562. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 196
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1563. **[SharpToolsMCP](https://github.com/kooshi/SharpToolsMCP)** - ⭐ 196
   A suite of MCP tools for AIs to analyze and modify C# solutions with high signal, Roslyn powered context.

1564. **[security-investigator](https://github.com/SCStelz/security-investigator)** - ⭐ 196
...
1565. **[openchrome](https://github.com/shaun0927/openchrome)** - ⭐ 196
   Open-source browser automation MCP server. Control your real Chrome from any AI agent.

1566. **[notebooklm-skill](https://github.com/claude-world/notebooklm-skill)** - ⭐ 196
...
1567. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1568. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 195
...
1569. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 195
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1570. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 195
   MCP Server for Searching Turkish Legislation

1571. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 195

1572. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 195
   DataForSEO API modelcontextprotocol server 

1573. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 195
   MCP Server that enables Claude code to interact with Gemini

1574. **[bluebox](https://github.com/VectorlyApp/bluebox)** - ⭐ 194
   Index the world's undocumented APIs

1575. **[mcp-agent-graph](https://github.com/keta1930/mcp-agent-graph)** - ⭐ 194
   MCP Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1576. **[agent-graph](https://github.com/keta1930/agent-graph)** - ⭐ 194
   Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1577. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 194
   Absurdly easy Model Context Protocol Servers in Typescript

1578. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 194
...
1579. **[omem](https://github.com/ourmem/omem)** - ⭐ 193
...
1580. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 192
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1581. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 192
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1582. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 192
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1583. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 192
   Chat application with multi-agents system supports multi-models and MCP

1584. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 192
   An MCP server to search for flights.

1585. **[agentseal](https://github.com/AgentSeal/agentseal)** - ⭐ 191
   Security toolkit for AI agents. Scan your machine for dangerous skills and MCP configs, monitor for supply chain attacks, test prompt injection resistance, and audit live MCP servers for tool poisoning.

1586. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 191

1587. **[dario](https://github.com/askalf/dario)** - ⭐ 191
...
1588. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 191
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1589. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
1590. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 190
   Supabase MCP server created in Python.

1591. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 190
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1592. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 190
   This extension enables developers to implement the MCP server features easily.

1593. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 190
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1594. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 189
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1595. **[gigabrain](https://github.com/legendaryvibecoder/gigabrain)** - ⭐ 189
   Local-first memory layer for OpenClaw, Codex App, and Codex CLI: capture, recall, dedupe, and native sync.

1596. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 189
   Official Railway MCP Server for interacting with your Railway account

1597. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 189
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1598. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 188
   Model Context Protocol Servers in Quarkus

1599. **[bear-notes-mcp](https://github.com/vasylenko/bear-notes-mcp)** - ⭐ 188
   MCP Server for Bear note taking app available as Claude Desktop extension or standalone server for any other AI tool

1600. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 188
   Typescript SDK to build MCP servers in an agnostic way

1601. **[renderdoc-mcp](https://github.com/JiaboLi-GitHub/renderdoc-mcp)** - ⭐ 188
   An MCP server for RenderDoc: Empowering AI assistants to analyze GPU frame captures and debug graphics pipelines.

1602. **[figma-mcp-bridge](https://github.com/gethopp/figma-mcp-bridge)** - ⭐ 188
   Figma Plugin & MCP server to bypass API limits

1603. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1604. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1605. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1606. **[memov](https://github.com/memovai/memov)** - ⭐ 187
...
1607. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 187
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1608. **[LeanKG](https://github.com/FreePeak/LeanKG)** - ⭐ 187
   LeanKG: Stop Burning Tokens. Start Coding Lean.

1609. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1610. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 186
   MCP for calling Siri Shorcuts from LLMs

1611. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 186
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1612. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 185
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1613. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 185
   Official Magic UI MCP server.

1614. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 185
   A TypeScript framework for building MCP servers elegantly

1615. **[docs](https://github.com/strands-agents/docs)** - ⭐ 185
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1616. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 185
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1617. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 185
   MCP Server for the Bilibili API, supporting various operations.

1618. **[lumen](https://github.com/ory/lumen)** - ⭐ 185
...
1619. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1620. **[siconos](https://github.com/siconos/siconos)** - ⭐ 184
   Simulation framework for nonsmooth dynamical systems

1621. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 184
   Examples of using Pipedream's MCP server in your app or AI agent.

1622. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 184
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1623. **[PerformanceStudio](https://github.com/erikdarlingdata/PerformanceStudio)** - ⭐ 184
...
1624. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 184
   A simple CLI to install MCP servers into any client - auth included!

1625. **[android-skills-mcp](https://github.com/skydoves/android-skills-mcp)** - ⭐ 184
   An MCP server and CLI packager for official Android skills.

1626. **[trading_skills](https://github.com/staskh/trading_skills)** - ⭐ 184
   Claude powered advisor system for option traders

1627. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 183
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1628. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 183
   Server-enforced workflow discipline for AI agents. An MCP server providing persistent work items, dependency graphs, quality gates, and actor attribution. Schemas define what agents must produce — the server blocks the call if they don't. Works with any MCP-compatible client.

1629. **[comfy-pilot](https://github.com/ConstantineB6/comfy-pilot)** - ⭐ 183
   MCP server + embedded terminal that lets Claude Code see and edit your ComfyUI workflows

1630. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 183
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1631. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 182
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1632. **[aelf-skills](https://github.com/AElfProject/aelf-skills)** - ⭐ 182
   Unified aelf skills hub for discovery, routing, bootstrap, and health checks across OpenClaw, Codex, Cursor, and Claude Code.

1633. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1634. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1635. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 182
...
1636. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 182
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1637. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 182

1638. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 182
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1639. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 182
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1640. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 182
   A redmine MCP server covering close to 100% of redmines API

1641. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 181
...
1642. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 181
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1643. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 181
   Official MCP server for Tripo

1644. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 181
...
1645. **[mcp-toolbox-sdk-python](https://github.com/googleapis/mcp-toolbox-sdk-python)** - ⭐ 181
   Python SDK for interacting with the MCP Toolbox for Databases. 

1646. **[WeChat-MCP](https://github.com/BiboyQG/WeChat-MCP)** - ⭐ 181
   WeChat-MCP: let Openclaw/Claude/ChatGPT and other AI assistants read and reply to WeChat for you

1647. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 180
...
1648. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 180
   An MCP server for Anki

1649. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 180
...
1650. **[cachebro](https://github.com/glommer/cachebro)** - ⭐ 180
   File cache with diff tracking for AI coding agents. Drop-in MCP server that cuts token usage by 26%.

1651. **[apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server)** - ⭐ 180
   MCP server for querying Apple Health data with natural language using DuckDB under the hood.

1652. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 180
   📜 An MCP server for conversation history search and retrieval in Claude Code

1653. **[xiaoi](https://github.com/xvhuan/xiaoi)** - ⭐ 179
   小爱音箱语音通知工具：提供 CLI/TUI/MCP/Webhook 一键播报与控制音量，支持 PM2 常驻部署，支持docker部署。

1654. **[icm](https://github.com/rtk-ai/icm)** - ⭐ 179
   Permanent memory for AI agents. Single binary, zero dependencies, MCP native.

1655. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 179
...
1656. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 178
...
1657. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1658. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1659. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 178
...
1660. **[bernstein](https://github.com/chernistry/bernstein)** - ⭐ 178
   Deterministic orchestrator for 30+ CLI AI coding agents. Git worktree isolation, HMAC audit trail, MCP server mode.

1661. **[dataseo-mcp](https://github.com/egebese/dataseo-mcp)** - ⭐ 178
...
1662. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 178

1663. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 177
   A MCP server to search for accurate academic articles.

1664. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 177
   MCP Server for Google Slides

1665. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 176
   MCP Server for Postgres

1666. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 176
   MCP Salesforce connector

1667. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 176
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1668. **[Companion](https://github.com/mattt/Companion)** - ⭐ 175
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1669. **[aghub](https://github.com/AkaraChen/aghub)** - ⭐ 175
   One hub for every AI coding agent. Unified configuration management for 22+ assistants.

1670. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 175
   MCP server to work with Telegram through MTProto

1671. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 175
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1672. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 175
   Turn any website or doc into an MCP server

1673. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 175
    QMT-MCP 模块化量化交易助手

1674. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 174
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1675. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 174
...
1676. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 174
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1677. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 174
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1678. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 174
   A free SEO research tool using Model Context Protocol (MCP) powered by Ahrefs data. Get backlink analysis, keyword research, traffic estimation, and more — directly in your AI-powered IDE.

1679. **[command](https://github.com/scopecraft/command)** - ⭐ 174
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1680. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 173

1681. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 173
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1682. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 173
   Model Context Protocol For R

1683. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 173
...
1684. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 173
...
1685. **[chiasmus](https://github.com/yogthos/chiasmus)** - ⭐ 173
   Chiasmus is an MCP server that gives language models access to formal verification

1686. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 172
   A mongo db server for the model context protocol (MCP)

1687. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 172
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1688. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 172
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1689. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 172
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1690. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 172
...
1691. **[clix](https://github.com/spideystreet/clix)** - ⭐ 171
   X from terminal. No API keys needed. Just plug your AI Agent.

1692. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 171
   One MCP Server, All Your Apps, Privacy First

1693. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 171
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1694. **[PolyMCP](https://github.com/poly-mcp/PolyMCP)** - ⭐ 171
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1695. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 171
...
1696. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 171
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1697. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 171
   StarRocks MCP (Model Context Protocol) Server

1698. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 171
   MCPSDK.dev(ToolSDK.ai)'s Awesome MCP Servers and Packages Registry and Database with Structured JSON configurations. Supports OAuth2.1, DCR...

1699. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 170
   Codex Mcp Server 

1700. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 170
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1701. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1702. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 170
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1703. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 170
   Turn a web server into an MCP server in one click without making any code changes.

1704. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 169
   A Tiny Web Chat App for AI Models with MCP Client Support

1705. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 169
   Local-first MCP App framework for ChatGPT Apps, Claude, and more.

1706. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 169
   Command line interface for MCP clients with secure execution and customizable security policies

1707. **[AI-company](https://github.com/CronusL-1141/AI-company)** - ⭐ 169
...
1708. **[Gopeak-godot-mcp](https://github.com/HaD0Yun/Gopeak-godot-mcp)** - ⭐ 169
...
1709. **[sibyl-research-system](https://github.com/Sibyl-Research-Team/sibyl-research-system)** - ⭐ 168
   Fully Autonomous AI Research System with Self-Evolution, built natively on Claude Code

1710. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 168
   c4 GenAI Suite

1711. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 168
   MCP server for Mikrotik

1712. **[VibeUE](https://github.com/kevinpbuckley/VibeUE)** - ⭐ 168
   Unreal Engine Vibe Coding tool

1713. **[refref](https://github.com/amicalhq/refref)** - ⭐ 167
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1714. **[agnix](https://github.com/agent-sh/agnix)** - ⭐ 167
...
1715. **[ironcurtain](https://github.com/provos/ironcurtain)** - ⭐ 167
   A secure* runtime for autonomous AI agents. Policy from plain-English constitutions. (*https://ironcurtain.dev)

1716. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 167
   MariaDB MCP (Model Context Protocol) server implementation

1717. **[knowledge-base-server](https://github.com/willynikes2/knowledge-base-server)** - ⭐ 167
...
1718. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 167
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1719. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 167
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1720. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 167
   Persistent Intelligence Infrastructure for AI Agents

1721. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 167
   MCP Server and CLI for Apache Spark History Server. Debug Spark applications from AI agents, scripts, or the terminal.

1722. **[domscribe](https://github.com/patchorbit/domscribe)** - ⭐ 167
...
1723. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 166
   A desktop application that adds powerful tools to Claude and AI platforms

1724. **[CyberStrike](https://github.com/CyberStrikeus/CyberStrike)** - ⭐ 166
...
1725. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 166
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1726. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 166
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1727. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 166

1728. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 165
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1729. **[mengram](https://github.com/alibaizhanov/mengram)** - ⭐ 165
...
1730. **[QuickDesk](https://github.com/barry-ran/QuickDesk)** - ⭐ 165
...
1731. **[jdocmunch-mcp](https://github.com/jgravelle/jdocmunch-mcp)** - ⭐ 165
   The leading, most token-efficient MCP server for documentation exploration and retrieval via structured section indexing

1732. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 165
   MCP server that provides access to Chinese stock market data using akshare-one

1733. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 165
   Instagram Direct messages MCP

1734. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 164
   MCP server for searching and querying PubMed medical papers/research database

1735. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 164
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1736. **[recall](https://github.com/joseairosa/recall)** - ⭐ 164
   Persistent cross-session memory for Claude & AI agents. Self-host on Redis/Valkey, or use the managed SaaS at recallmcp.com.

1737. **[Axon.MCP.Server](https://github.com/ali-kamali/Axon.MCP.Server)** - ⭐ 164
...
1738. **[memorizer](https://github.com/petabridge/memorizer)** - ⭐ 164
   Vector-search powered agent memory MCP server

1739. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 164
...
1740. **[ServiceGraph](https://github.com/nostrband/ServiceGraph)** - ⭐ 164
   AI Agent skills for a structured catalog of 100k+ US professional-services firms

1741. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 164
   Model Context Protocol (MCP) server for constraint optimization and solving"

1742. **[affine-mcp-server](https://github.com/DAWNCR0W/affine-mcp-server)** - ⭐ 164
...
1743. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 164

1744. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 164
   小红书MCP服务器 | 秒级工具调用执行，笔记用户搜索、通知消息监控等；打造2026最简单、最快速、最精准、最好用的小红书MCPServer！

1745. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 164
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1746. **[mcp-victoriametrics](https://github.com/VictoriaMetrics/mcp-victoriametrics)** - ⭐ 164
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1747. **[data-verify-mcp](https://github.com/CCCpan/data-verify-mcp)** - ⭐ 163
   中国数据核验 MCP Server | 身份核验/企业查询/车辆信息/OCR识别/风险评估 | 10个Tool覆盖5大类 | 微信: chenganp | 邮箱: 345048305@qq.com

1748. **[mcp-codex-dev](https://github.com/FYZAFH/mcp-codex-dev)** - ⭐ 163
   MCP Server for Codex CLI integration - stateful code writing and review workflows

1749. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 163
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1750. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 162
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1751. **[turbo-flow](https://github.com/marcuspat/turbo-flow)** - ⭐ 162
...
1752. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 162
...
1753. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 162
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1754. **[mcp-crash-course](https://github.com/emarco177/mcp-crash-course)** - ⭐ 162
...
1755. **[unity-mcp-server](https://github.com/AnkleBreaker-Studio/unity-mcp-server)** - ⭐ 162
   Unity MCP Server — 268 tools for AI-assisted game development. Connect Claude, Cursor, or any MCP client to Unity Editor & Unity Hub. Scene management, GameObjects, components, builds, profiling, Shader Graph, Amplify, terrain, physics, NavMesh, animation, MPPM multiplayer & more. Free & open source by AnkleBreaker Studio.

1756. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 161
   MCP (Model Context Protocol) server for Weaviate

1757. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 161
   MCP Server for AI Summarization

1758. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 161
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1759. **[meta-mcp](https://github.com/brijr/meta-mcp)** - ⭐ 161
   MCP Server for connecting to the Meta Marketing API

1760. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 161
   Isaac Simulation MCP Extension and Server

1761. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 160
   Scrapeless Mcp Server

1762. **[Text2Sql.Net](https://github.com/shuyu-labs/Text2Sql.Net)** - ⭐ 160
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1763. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 160
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1764. **[awesome-ai-for-economists](https://github.com/hanlulong/awesome-ai-for-economists)** - ⭐ 160
...
1765. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 160
   Simple Slackbot MCP Client

1766. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 160
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1767. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 160

1768. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 160
   A Model Context Protocol server for Hopper Disassembler

1769. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 159
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1770. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 159
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1771. **[claude-code-open](https://github.com/kill136/claude-code-open)** - ⭐ 158
   Open source AI coding platform with Web IDE, multi-agent system, 37+ tools, MCP protocol. MIT licensed.

1772. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 158
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1773. **[mcp-bridge](https://github.com/firekula/mcp-bridge)** - ⭐ 158
   这是一个为 Cocos Creator 设计的 MCP (Model Context Protocol) 桥接插件，用于连接外部 AI 工具与 Cocos Creator 编辑器，实现对场景、节点等资源的自动化操作。

1774. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 157
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1775. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 157
   A Model Context Protocol server for MySQL database operations

1776. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 157
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1777. **[bocha-search-mcp](https://github.com/BochaAI/bocha-search-mcp)** - ⭐ 157
   Bocha Search MCP Server.

1778. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 156
   An MCP server for fetching URLs / Youtube video transcript.

1779. **[refref](https://github.com/refrefhq/refref)** - ⭐ 156
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1780. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 156

1781. **[FirstData](https://github.com/MLT-OSS/FirstData)** - ⭐ 156
   The World's Most Comprehensive, Authoritative, and Structured Open Source Data Source Knowledge Base

1782. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 156
   Make MCP Server

1783. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 156
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1784. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 155
   ChatGPT Copilot Extension for Visual Studio Code

1785. **[payram-mcp](https://github.com/PayRam/payram-mcp)** - ⭐ 155
   Connect to hosted payram helper at: https://mcp.payram.com

1786. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 155
   Deep Research for crypto - free & fully local

1787. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 155
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1788. **[hanzi-browse](https://github.com/hanzili/hanzi-browse)** - ⭐ 155
   let any ai agent use the local browser

1789. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 155
   Salesforce MCP Server

1790. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 154
   A simple MCP server to search for documentation (tutorial)

1791. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 154
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1792. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 154
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1793. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 153
   :octocat: GitHub Emoji for C#, dotnet and beyond

1794. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 153
   Manage Your Kubernetes Cluster with k8s mcp-server

1795. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 153
   An MCP Server for Ollama

1796. **[resolve-mcp](https://github.com/barckley75/resolve-mcp)** - ⭐ 153
   Connect DaVinci Resolve Studio to Claude AI through the Model Context Protocol (MCP)

1797. **[dedalus-mcp-python](https://github.com/dedalus-labs/dedalus-mcp-python)** - ⭐ 152
   A simple and performant Model Context Protocol framework for Python.

1798. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 152
   A gateway demo for MCP SSE Server

1799. **[agentanycast](https://github.com/AgentAnycast/agentanycast)** - ⭐ 152
   Connect AI agents across any network — zero config, encrypted, skill-based routing

1800. **[claude-code-karma](https://github.com/JayantDevkar/claude-code-karma)** - ⭐ 152
   Dashboard for monitoring claude code sessions. 

1801. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 152
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1802. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 152
   Dynamically expose tools from proxied servers based on an Agent Persona

1803. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 152
   MCP server for discord bot

1804. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 151
   MCP server for Unreal Engine 5

1805. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 151
   Toolkit for Coding Agents to work reliably with repo of any size.

1806. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 151
   MCP Server for using any LLM as a Tool

1807. **[claude-desktop-extension-bear-notes](https://github.com/vasylenko/claude-desktop-extension-bear-notes)** - ⭐ 151
   Claude Desktop extension with bundled MCP Server for Bear note taking app

1808. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 151
   Catch MCP server issues before your agents do.

1809. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 151
   Serper MCP Server supporting search and webpage scraping

1810. **[eion](https://github.com/eiondb/eion)** - ⭐ 151
   Shared Memory Storage for Multi-Agent Systems

1811. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 151
   Model Context Protocol (MCP) with TikTok integration

1812. **[relay](https://github.com/prism-php/relay)** - ⭐ 151
   An MCP client tool for Prism

1813. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 151
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1814. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 151
   Model Context Protocol Server for Swift

1815. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 150
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1816. **[aai-gateway](https://github.com/gybob/aai-gateway)** - ⭐ 150
   Install MCP servers and skills once, share across all your AI agents — with 90% less context overhead.

1817. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 150
   MCP server to download entire websites

1818. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 150
   Let LLMs control embedded devices via the Model Context Protocol.

1819. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 150
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1820. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 150
   Connect any Open Data to any LLM with Model Context Protocol.

1821. **[ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus)** - ⭐ 150
   Use MCP and OpenAPI to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.

1822. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 150
...
1823. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 150
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1824. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 150
   Model Context Protocol (MCP) server for the Zotero API, in Python

1825. **[Express-REST-API-and-MCP-Server-Framework](https://github.com/iolufemi/Express-REST-API-and-MCP-Server-Framework)** - ⭐ 149
...
1826. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 149
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1827. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 149
   Enable AI Agents to Control Unity

1828. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 149
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1829. **[regenerator2000](https://github.com/ricardoquesada/regenerator2000)** - ⭐ 149
...
1830. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 149
   MCP server for interaction with Bitwarden.

1831. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 149
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1832. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 149
   A Model Context Protocol server for calculating.

1833. **[eclipse-chatgpt-plugin](https://github.com/gradusnikov/eclipse-chatgpt-plugin)** - ⭐ 149
   Eclipse IDE as an MCP Server for AI Agents

1834. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 149
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1835. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 149
...
1836. **[firefox-devtools-mcp](https://github.com/mozilla/firefox-devtools-mcp)** - ⭐ 149
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

1837. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 148
   Desktop APP for Discover and Install MCP Servers

1838. **[plan-cascade](https://github.com/Taoidle/plan-cascade)** - ⭐ 148
...
1839. **[kom](https://github.com/weibaohui/kom)** - ⭐ 148
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1840. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 148
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1841. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 148
   Raindrop MCP Server

1842. **[comet-mcp](https://github.com/hanzili/comet-mcp)** - ⭐ 148
   MCP Server connecting to Perplexity Comet browser

1843. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 148
   A PubMed MCP server.

1844. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 148
   Model Context Protocol server implementation for Figma API

1845. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 148
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1846. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 148
...
1847. **[meta_skill](https://github.com/Dicklesworthstone/meta_skill)** - ⭐ 147
...
1848. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 147
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1849. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 147
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1850. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 146
   An MCP server that provides access to Postman.

1851. **[openwebui-extensions](https://github.com/Fu-Jie/openwebui-extensions)** - ⭐ 146
...
1852. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 146
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1853. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 146
...
1854. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 146
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1855. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 145
   Goku is an HTTP load testing application written in Rust 

1856. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 145
   MSSQL Server MCP implementation written in C#

1857. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 145
...
1858. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 145
...
1859. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 145
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1860. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 144
   A MCP Server for creating Powerpoint Presentations

1861. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 144
...
1862. **[godot-mcp](https://github.com/tugcantopaloglu/godot-mcp)** - ⭐ 144
   MCP server for full Godot 4.x engine control — 149 tools for AI-driven game development

1863. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 144
...
1864. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 143
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1865. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 143
   MCP server implementation for Google's Gemini API

1866. **[mcp-servers](https://github.com/charIesding/mcp-servers)** - ⭐ 143
   mcp server implementations

1867. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 143
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1868. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 143
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1869. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 143
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1870. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 142
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1871. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 142
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1872. **[openagent](https://github.com/Th0rgal/openagent)** - ⭐ 142
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1873. **[mcpd](https://github.com/mozilla-ai/mcpd)** - ⭐ 142
...
1874. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 142
...
1875. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 142
...
1876. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 141
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1877. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 141
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1878. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 141
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1879. **[antigravity-link-extension](https://github.com/cafeTechne/antigravity-link-extension)** - ⭐ 141
...
1880. **[Hegelion](https://github.com/Hmbown/Hegelion)** - ⭐ 140
   Dialectical reasoning architecture for LLMs (Thesis → Antithesis → Synthesis)

1881. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 140

1882. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 140
   MCP server for Israel Government Data

1883. **[linkedin-mcp-server](https://github.com/eliasbiondo/linkedin-mcp-server)** - ⭐ 140
...
1884. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 139
   Graphiti MCP Server

1885. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 139
...
1886. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 139
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1887. **[ksail](https://github.com/devantler-tech/ksail)** - ⭐ 139
   Tool for creating, maintaining and operating Kubernetes clusters with ease.

1888. **[forgemax](https://github.com/postrv/forgemax)** - ⭐ 139
   Code Mode inspired local sandboxed MCP Gateway - collapses N servers x M tools into 2 tools (~1,000 tokens)

1889. **[reddit-mcp-server](https://github.com/eliasbiondo/reddit-mcp-server)** - ⭐ 139
...
1890. **[yuque-mcp-server](https://github.com/yuque/yuque-mcp-server)** - ⭐ 139
   Yuque MCP Server - Model Context Protocol server for Yuque API

1891. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 138
   Simple MCP Server Implementation

1892. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 138
   MCP server for seamless document format conversion and processing

1893. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 138
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1894. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 138
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1895. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 138
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1896. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 138
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1897. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 138
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1898. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 138
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1899. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 137
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1900. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 137
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1901. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 137
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1902. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 137
   mcp server for gitingest

1903. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 137
   Model Context Protocol for Actual Budget API

1904. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 136
...
1905. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 136
      Convert any MCP server into a Claude Skill with 90% context savings

1906. **[design-systems-mcp](https://github.com/southleft/design-systems-mcp)** - ⭐ 136
   I'm your specialized design systems assistant. Ask me about components, tokens, patterns, and best practices.

1907. **[mcp-server-excel](https://github.com/sbroenne/mcp-server-excel)** - ⭐ 136
   Excel MCP Server & CLI - 23 tools, 214 operations for AI-powered Excel automation via COM API

1908. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 135
   Simple API & React framework, fully type safe, OpenAPI, RSC, MCP, type safe client, streaming with SSE

1909. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 135
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1910. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 135
   MCP server for interacting with the Aseprite API

1911. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 135
...
1912. **[ChatPPT-MCP](https://github.com/YOOTeam/ChatPPT-MCP)** - ⭐ 135
...
1913. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 135
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1914. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 135
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1915. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1916. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 134
...
1917. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 134
   A powerful MCP server for intelligently reading Java source code (For Jar and local project).

1918. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 134
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1919. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 133
   An MCP server implementing the think tool for Claude

1920. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1921. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 133
...
1922. **[charlotte](https://github.com/TickTockBent/charlotte)** - ⭐ 133
   Token-efficient browser MCP server — structured web pages for AI agents, not raw accessibility dumps

1923. **[claudeus-wp-mcp](https://github.com/deus-h/claudeus-wp-mcp)** - ⭐ 133
   Claudeus WordPress MCP Server

1924. **[magg](https://github.com/sitbon/magg)** - ⭐ 133
   Magg: The MCP Aggregator

1925. **[Kagi-Session2API-MCP](https://github.com/KSroido/Kagi-Session2API-MCP)** - ⭐ 133
...
1926. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 133
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1927. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 133
   A Google Tasks Model Context Protocol Server for Claude

1928. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 132
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1929. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 132
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1930. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 132
   Docker Hub MCP Server

1931. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 132
   Rust MCP server for comprehensive code intelligence - 90 tools, 32 languages, security scanning, call graphs, and more

1932. **[orchestkit](https://github.com/yonatangross/orchestkit)** - ⭐ 132
...
1933. **[mcp-ts-core](https://github.com/cyanheads/mcp-ts-core)** - ⭐ 132
...
1934. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 132
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1935. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 131

1936. **[ClawMem](https://github.com/yoloshii/ClawMem)** - ⭐ 131
   On-device memory layer for AI agents. Claude Code, Hermes and OpenClaw. Hooks + MCP server + hybrid RAG search.

1937. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 131
   blazigly fast gRPC/MCP client & server implementation in zig

1938. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 131
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1939. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 131
...
1940. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 130
   BrowserStack's Official MCP Server

1941. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 130
   High-performance CCXT MCP server for cryptocurrency exchange integration

1942. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 130
   It's time to push beyond MCP Servers... Right?

1943. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 130
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1944. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 130
   Model Context Protocol (MCP) server for the Webflow Data API.

1945. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 130
   Buttplug.io Model Context Protocol (MCP) Server

1946. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 129
   A modular MCP server that provides commonly used developer tools for AI coding agents

1947. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 129
   A collection of crypto MCP servers.

1948. **[exstruct](https://github.com/harumiWeb/exstruct)** - ⭐ 129
...
1949. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 129
   TOON encoding for Laravel. Encode data for AI/LLMs with ~50% fewer tokens than JSON.

1950. **[indonesia-gov-apis](https://github.com/suryast/indonesia-gov-apis)** - ⭐ 129
...
1951. **[prism-mcp](https://github.com/dcostenco/prism-mcp)** - ⭐ 129
...
1952. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 129
   A Model Context Protocol Server to manipulate *.xcodeproj

1953. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 129
   A Model Context Protocol (MCP) for Jupyter Notebook

1954. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 129
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1955. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 129
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1956. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 129
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1957. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 128
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1958. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 128
   Intelligent spec workflow management MCP server

1959. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 128
   a private MCP server for accessing Linear

1960. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 128
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1961. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1962. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 128
...
1963. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 128
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1964. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 127
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1965. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1966. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 127

1967. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 127
   Portainer MCP server

1968. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 127
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1969. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 127
   MCP server for understanding AWS spend

1970. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 127
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1971. **[esankhyiki-mcp](https://github.com/nso-india/esankhyiki-mcp)** - ⭐ 127
...
1972. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 126
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1973. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 126
   Dart AI Model Context Protocol (MCP) server

1974. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1975. **[sysplant](https://github.com/x42en/sysplant)** - ⭐ 126
   Your Windows syscall hooking factory - feat Canterlot's Gate - All accessible over MCP

1976. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 126
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1977. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1978. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 125
...
1979. **[cloudflare-mcp](https://github.com/mattzcarey/cloudflare-mcp)** - ⭐ 125
   unofficial mcp server for cloudflare api

1980. **[web-scout-mcp](https://github.com/pinkpixel-dev/web-scout-mcp)** - ⭐ 125
   A powerful MCP server extension providing web search and content extraction capabilities. Integrates DuckDuckGo search functionality and URL content extraction into your MCP environment, enabling AI assistants to search the web and extract webpage content programmatically.

1981. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 125
   A Model Context Protocol server that provides access to BigQuery

1982. **[rails-ai-context](https://github.com/crisnahine/rails-ai-context)** - ⭐ 125
...
1983. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 125
...
1984. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1985. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 124
   🐉 The fast, PHP way to build MCP servers

1986. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 124
...
1987. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 124
...
1988. **[OverleafMCP](https://github.com/mjyoo2/OverleafMCP)** - ⭐ 124
...
1989. **[gm-exec](https://github.com/AnEntrypoint/gm-exec)** - ⭐ 123
   wanna develop an app ❓

1990. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 123
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1991. **[mcp-glootie](https://github.com/AnEntrypoint/mcp-glootie)** - ⭐ 123
   wanna develop an app ❓

1992. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 123
...
1993. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 123
   MCP server for Google Tag Manager

1994. **[ASI](https://github.com/vNeeL-code/ASI)** - ⭐ 123
   Android ✧ Gemma Integration into Android System Intelligence

1995. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 123
...
1996. **[Matryoshka](https://github.com/yogthos/Matryoshka)** - ⭐ 123
   MCP server for token-efficient large document analysis via the use of REPL state

1997. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 123
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1998. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 123
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1999. **[mcp-gm](https://github.com/AnEntrypoint/mcp-gm)** - ⭐ 122
   wanna develop an app ❓

2000. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 122
...
2001. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 122
...
2002. **[env-doctor](https://github.com/mitulgarg/env-doctor)** - ⭐ 122
   Debug your GPU, CUDA, and AI stacks across local, Docker, and CI/CD (CLI and MCP server)

2003. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 122
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

2004. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 122
   An MCP server that provides LLMs with the latest stable package versions when coding

2005. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 122
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

2006. **[mcp](https://github.com/taskade/mcp)** - ⭐ 122
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

2007. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 122
   MCP server for *arr media management suite

2008. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 122
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

2009. **[mcp-hubspot](https://github.com/baryhuang/mcp-hubspot)** - ⭐ 122
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

2010. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 122
...
2011. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

2012. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 121
   MCP server implementation for n8n workflow automation

2013. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 121

2014. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 121
...
2015. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 120
   An MCP server for FFmpeg

2016. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 120
   Google Sheets MCP Server 📊🤖

2017. **[mcp](https://github.com/frappe/mcp)** - ⭐ 120
   Frappe MCP allows Frappe apps to function as MCP servers

2018. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 120
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

2019. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 120
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

2020. **[Pare](https://github.com/Dave-London/Pare)** - ⭐ 120
   Dev tools, optimized for agents. Structured, token-efficient MCP servers for git, test runners, npm, Docker, and more.

2021. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 120
   A proxy to use HTTP/SSE MCPs from STDIO clients

2022. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 120
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

2023. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 119

2024. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 119
   TypeScript template for building Model Context Protocol (MCP) servers. Ships with declarative tools/resources, pluggable auth, multi-backend storage, OpenTelemetry observability, and first-class support for both local and edge (Cloudflare Workers) runtimes.

2025. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 119
...
2026. **[awesome-openclaw](https://github.com/vincentkoc/awesome-openclaw)** - ⭐ 119
...
2027. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 119
...
2028. **[nitrostack](https://github.com/nitrocloudofficial/nitrostack)** - ⭐ 119
   The full-stack TypeScript framework to build, test, and deploy production-ready MCP servers and AI-native apps.

2029. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 118
   Vector-search powered agent memory MCP server

2030. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 118
   MCP Server for PolyMarket API

2031. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 118
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

2032. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 118
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

2033. **[MiniClaw](https://github.com/8421bit/MiniClaw)** - ⭐ 118
...
2034. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 118
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

2035. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 117
...
2036. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 117
   An MCP server for InterviewReady

2037. **[kodit](https://github.com/helixml/kodit)** - ⭐ 117
   👩‍💻 MCP server to index external repositories

2038. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 117
   It's an MCP server... for Outline (the documentation platform!)

2039. **[diagram-mcp-server](https://github.com/andrewmoshu/diagram-mcp-server)** - ⭐ 117
   An MCP server that seamlessly creates infrastructure diagrams for AWS, Azure, GCP, Kubernetes and more

2040. **[pocketbase-mcp](https://github.com/mrwyndham/pocketbase-mcp)** - ⭐ 116
   MCP server for building PocketBase apps really quickly - Need a front end quick consider FastPocket

2041. **[EDT-MCP](https://github.com/DitriXNew/EDT-MCP)** - ⭐ 116
   MCP for 1C:EDT

2042. **[mcp-dock](https://github.com/OldJii/mcp-dock)** - ⭐ 116
...
2043. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 115
   Fast and super efficient Minecraft Server written in C++

2044. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 115
   Azure API Management as AI Gateway to Remote MCP servers.

2045. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 115
   MCP Server for working with large Oracle databases

2046. **[remote-mcp-functions-python](https://github.com/Azure-Samples/remote-mcp-functions-python)** - ⭐ 115
   Getting Started with Remote MCP Servers using Azure Functions (Python)

2047. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 115
...
2048. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 115
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

2049. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 115
   From Java Dev to AI Engineer: Spring AI Fast Track

2050. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 115
   Native Delphi Server implementation of the Model Context Protocol (MCP)

2051. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 114
   Swagger to MCP server

2052. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 114
   Foxy contexts is a library for building context servers supporting Model Context Protocol

2053. **[modex](https://github.com/theronic/modex)** - ⭐ 114
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

2054. **[mcp-armor](https://github.com/aira-security/mcp-armor)** - ⭐ 114
...
2055. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 114
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

2056. **[cli](https://github.com/mcpgod/cli)** - ⭐ 114
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

2057. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 114
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

2058. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 113
   MCP server for Oura API integration

2059. **[AgenticGoKit](https://github.com/AgenticGoKit/AgenticGoKit)** - ⭐ 113
...
2060. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 113
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

2061. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 113
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

2062. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 113
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

2063. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 112
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

2064. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 112
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

2065. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 112
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

2066. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 112

2067. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 112
...
2068. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 112
   Rails Engine with MCP compliant Spec.

2069. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 112
   Headless IDA Pro binary analysis via Model Context Protocol

2070. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
2071. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 111
   MCP server for connecting agentic systems to search systems via searXNG

2072. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 111
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

2073. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 111
...
2074. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

2075. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 111

2076. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 111
   Open Source MCP Servers for Scientific Research

2077. **[idun-agent-platform](https://github.com/Idun-Group/idun-agent-platform)** - ⭐ 111
...
2078. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 111
   MCP for semantic code search & navigation that reduces token waste

2079. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 111
...
2080. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 111
   Safe local execution layer for AI agent tools. Build, validate, and publish MCP tools with a no-pass-no-run workflow — cross-platform desktop app powered by Spring AI.

2081. **[obsidian-web-mcp](https://github.com/jimprosser/obsidian-web-mcp)** - ⭐ 111
...
2082. **[glade-mcp-unity](https://github.com/Glade-tool/glade-mcp-unity)** - ⭐ 111
...
2083. **[MySearch-Proxy](https://github.com/skernelx/MySearch-Proxy)** - ⭐ 110
   Unified search MCP, proxy console, and skill for Tavily, Firecrawl, and Social / X.

2084. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 110
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

2085. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 110
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

2086. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 110
   MCP server for Dash, the macOS documentation browser

2087. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 110
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

2088. **[code-pathfinder](https://github.com/shivasurya/code-pathfinder)** - ⭐ 110
...
2089. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 110
...
2090. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 110
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

2091. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 110
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

2092. **[mcp-reticle](https://github.com/soth-ai/mcp-reticle)** - ⭐ 110
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

2093. **[ETOS-LLM-Studio](https://github.com/Eric-Terminal/ETOS-LLM-Studio)** - ⭐ 110
...
2094. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 110
   MCP Client Implementation using Python, LangGraph and Gemini

2095. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 109

2096. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 109
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

2097. **[kibitz](https://github.com/nick1udwig/kibitz)** - ⭐ 109
   The coding agent for professionals

2098. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 109
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

2099. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 109
...
2100. **[rust-docs-mcp](https://github.com/snowmead/rust-docs-mcp)** - ⭐ 109
   MCP server for agents to explore rust docs, analyze source code, and build with confidence

2101. **[adloop](https://github.com/kLOsk/adloop)** - ⭐ 109
...
2102. **[one-search-mcp](https://github.com/yokingma/one-search-mcp)** - ⭐ 109
   🚀 OneSearch MCP Server: Web Search & Scraper & Extract,  Support agent-browser, SearXNG, Tavily, DuckDuckGo, Bing, etc.

2103. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 109
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

2104. **[Alicization-Town](https://github.com/ceresOPA/Alicization-Town)** - ⭐ 109
...
2105. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 108
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

2106. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

2107. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

2108. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

2109. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 108
   An MCP client for Node.js.

2110. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 108
   Payload CMS MCP Server

2111. **[forge-orchestrator](https://github.com/nxtg-ai/forge-orchestrator)** - ⭐ 108
   Forge Orchestrator: Multi-AI task orchestration. File locking, knowledge capture, drift detection. Rust.

2112. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 108
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

2113. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 108
...
2114. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 108
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

2115. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 108
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

2116. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 107
...
2117. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 107
   A Slack MCP server

2118. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 107
   An MCP Server for your Self Hosted Supabase

2119. **[arxiv-latex-mcp](https://github.com/takashiishida/arxiv-latex-mcp)** - ⭐ 107
   MCP server that uses arxiv-to-prompt to fetch and process arXiv LaTeX sources for precise interpretation of mathematical expressions in scientific papers.

2120. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 107
   fast, secure c# runner

2121. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 107
...
2122. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 107
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

2123. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 107
...
2124. **[winremote-mcp](https://github.com/dddabtc/winremote-mcp)** - ⭐ 107
   Windows Remote MCP Server — 40+ tools for desktop automation, process management, file operations via FastMCP

2125. **[xclaude-plugin](https://github.com/conorluddy/xclaude-plugin)** - ⭐ 106
...
2126. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 106
   MCP server for natural language interaction with Power BI datasets

2127. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 106
...
2128. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 106
   Model Context Protocol for YNAB (you need a budget)

2129. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 105
   An md file as a chat interface and editable history in one.

2130. **[claude-emporium](https://github.com/Vvkmnn/claude-emporium)** - ⭐ 105
   🏛 [UNDER CONSTRUCTION] A (roman) claude plugin marketplace 

2131. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 105
...
2132. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 105
...
2137. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 105
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

2138. **[deep-code-reasoning-mcp](https://github.com/evalops/deep-code-reasoning-mcp)** - ⭐ 105
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

2139. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 105
   first gemini based desktop client for MCP

2140. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 105
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

2141. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 105
...
2142. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 105
...
2143. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 104
   MCP Server for EMRs with FHIR

2144. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 104
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

2145. **[linggen](https://github.com/linggen/linggen)** - ⭐ 104
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

2146. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 104
   Official Vectorize MCP Server

2147. **[agent-bridge](https://github.com/raysonmeng/agent-bridge)** - ⭐ 104
   A local bridge for bidirectional collaboration between Claude Code and Codex. 连接 Claude Code 与 Codex 的本地实时协作桥接工具。

2148. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 104
   A Model Context Protocol server that provides knowledge graph management capabilities. 

2149. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 104
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

2150. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 103
   simple web ui to manage mcp (model context protocol) servers in the claude app

2151. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
2152. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

2153. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
2154. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 103
...
2155. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 103
   MCP Server for Chronulus AI Forecasting and Prediction Agents

2156. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 103
...
2157. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 103
   AlibabaCloud CloudOps MCP Server

2158. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 103
   Wanaku MCP Router

2159. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 103
    Official Go implementation of the UTCP 

2160. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 103
...
2161. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 103
   This is a Ruby implementation of MCP (Model Context Protocol) client

2162. **[omega-memory](https://github.com/omega-memory/omega-memory)** - ⭐ 103
   Persistent memory for AI coding agents

2163. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 103
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

2164. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 103
...
2165. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 103
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

2166. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 102
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

2167. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 102
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

2168. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 102
   go doc mcp server

2169. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 102
   Quickly screenshots webpages and converts to an LLM friendly size

2170. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 102
   Node.js Client Implementation for Model Context Protocol (MCP)

2171. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 102
...
2172. **[mcp-image](https://github.com/shinpr/mcp-image)** - ⭐ 102
...
2173. **[agenticmail](https://github.com/agenticmail/agenticmail)** - ⭐ 102
   Email & SMS infrastructure for AI agents — send and receive real email and text messages programmatically

2174. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

2175. **[cesium-mcp](https://github.com/gaopengbin/cesium-mcp)** - ⭐ 102
...
2176. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 101
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

2177. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 101
   Collection of examples of how to use Model Context Protocol with AWS.

2178. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

2179. **[nowledge-mem](https://github.com/nowledge-co/nowledge-mem)** - ⭐ 101
   Memory and context manager just works.

2180. **[stock-mcp](https://github.com/huweihua123/stock-mcp)** - ⭐ 101
   专业的金融市场数据 MCP 服务器 - 支持A股/美股/加密货币，原生 MCP 协议，AI Agent 友好

2181. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 101
...
2182. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 101
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

2183. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
2184. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

2185. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
2186. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
2187. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

2188. **[mpm-vibe-coding](https://github.com/halflifezyf2680/mpm-vibe-coding)** - ⭐ 100
...
2189. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 100
   LangGraph AI Repository

2190. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 100
   MCP server for persistent context management in AI coding assistants

2191. **[unreal-mcp](https://github.com/runreal/unreal-mcp)** - ⭐ 100
   MCP server for Unreal Engine that uses Unreal Python Remote Execution

2192. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

2193. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

2194. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

2195. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

2196. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 99
   lapras.com 公式MCP Server

2197. **[heimdall-mcp-server](https://github.com/lcbcFoo/heimdall-mcp-server)** - ⭐ 99
   Your AI Coding Assistant's Long-Term Memory

2198. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 99
...
2199. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 99
   A Model Context Protocol (MCP) server for square

2200. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 99
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

2201. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 99
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

2202. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 99
   A Model Context Protocol (MCP) server for querying the CVE-Search API

2203. **[Embody](https://github.com/dylanroscover/Embody)** - ⭐ 99
   MCP server for TouchDesigner — build, wire, and debug networks with AI. Plus git-diffable externalization.

2204. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 98
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

2205. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 98
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

2206. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

2207. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 98
   MCP Server for AI automation of the PlayCanvas Editor

2208. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 98
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

2209. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

2210. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 98
   Context7 MCP Server for Zed

2211. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 98
...
2212. **[mcp_on_ruby](https://github.com/nagstler/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

2213. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 98
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

2214. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 97
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

2215. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 97
...
2216. **[z-image-studio](https://github.com/iconben/z-image-studio)** - ⭐ 97
...
2217. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 97
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

2218. **[ogham-mcp](https://github.com/ogham-mcp/ogham-mcp)** - ⭐ 97
   Shared memory MCP server — persistent, searchable, cross-client Claude, Opencode

2219. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 96
   claude mcp sse demo with server and client(cli、web)

2220. **[deterministic-agent-control-protocol](https://github.com/elliot35/deterministic-agent-control-protocol)** - ⭐ 96
...
2221. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 96
...
2222. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 96
...
2223. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 96
...
2224. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 96
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

2225. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 96
   Portable , scalable , secure AI Agents

2226. **[NetworkOps_Platform](https://github.com/E-Conners-Lab/NetworkOps_Platform)** - ⭐ 96
...
2227. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 96
...
2228. **[homeassistant-mcp](https://github.com/robbrad/homeassistant-mcp)** - ⭐ 96
   Home Assistant MCP Server - Control your smart home with AI assistants via the Model Context Protocol

2229. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 95
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

2230. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 95
   MCP Server for Linux Scheduler Management and Auto optimization

2231. **[agent-toolkit](https://github.com/sanity-io/agent-toolkit)** - ⭐ 95
   Collection of resources to help AI agents build better with Sanity.

2232. **[mcp-server-apple-events](https://github.com/FradSer/mcp-server-apple-events)** - ⭐ 95
   MCP server providing native macOS integration with Apple Reminders and Calendar via EventKit

2233. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 95
   A Model Context Protocol (MCP) server for working with TradingView PineScript

2234. **[native-devtools-mcp](https://github.com/sh3ll3x3c/native-devtools-mcp)** - ⭐ 95
...
2235. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 95
...
2236. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 95
...
2237. **[bouvet](https://github.com/vrn21/bouvet)** - ⭐ 94
   Sandbox for Agents 

2238. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 94
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

2239. **[generative-ui-playground](https://github.com/CopilotKit/generative-ui-playground)** - ⭐ 94
   Interact with all three types of generative UI, all in one interface

2240. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 94
   Model Context Protocol server for Replicate's API

2241. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 94
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

2242. **[us-gov-open-data-mcp](https://github.com/lzinga/us-gov-open-data-mcp)** - ⭐ 94
...
2243. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 94
   Official Oxylabs MCP integration

2244. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 94
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

2245. **[awesome-mcp-servers-devops](https://github.com/WagnerAgent/awesome-mcp-servers-devops)** - ⭐ 94
...
2246. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 94
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

2247. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

2248. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

2249. **[gospy](https://github.com/monsterxx03/gospy)** - ⭐ 93
   Non-Invasive goroutine inspector

2250. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 93
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

2251. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 93
   Octopus Deploy Official MCP Server

2252. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 93
   MCPcat is an analytics platform for MCP server owners 🐱.

2253. **[awsome_kali_MCPServers](https://github.com/ccq1/awsome_kali_MCPServers)** - ⭐ 93
   awsome kali MCPServers is a set of MCP servers tailored for Kali Linux

2254. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 93
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

2255. **[askimo](https://github.com/haiphucnguyen/askimo)** - ⭐ 93
...
2256. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 93
...
2257. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 92
   Authentication and Authorization Proxy for MCP Servers

2258. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 92
   Open Models MCP for Blender Using Ollama

2259. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 92
...
2260. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 92
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

2261. **[zabbix-mcp-server](https://github.com/initMAX/zabbix-mcp-server)** - ⭐ 92
...
2262. **[identity](https://github.com/agntcy/identity)** - ⭐ 92
...
2263. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 91
...
2264. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 91
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

2265. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 91
   A Model Context Protocol server that provides knowledge graph management capabilities.

2266. **[photon](https://github.com/portel-dev/photon)** - ⭐ 91
   Define intent once. Photon turns a single TypeScript file into CLI tools, MCP servers, and web interfaces.

2267. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 91
   A model-context-protocol server for molecules.

2268. **[kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro)** - ⭐ 91
...
2269. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 91
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

2270. **[Fusion-360-MCP-Server](https://github.com/AuraFriday/Fusion-360-MCP-Server)** - ⭐ 91
   Control Fusion 360 with any AI through Model Context Protocol (MCP)

2271. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 90
   A Model Context Protocol server for Zendesk

2272. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 90
...
2273. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 89
...
2274. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 89
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

2275. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 89
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

2276. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 89
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

2277. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 89
   The official MCP server for SurrealDB

2278. **[tradingview-chart-mcp](https://github.com/ertugrul59/tradingview-chart-mcp)** - ⭐ 89
...
2279. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 89
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

2280. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 89
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

2281. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 89
...
2282. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 88
   A minimalist Typescript ChatGPT App based on the Skybridge framework

2283. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 88
   高德地图MCP Server，支持stdio, sse和streamable-http

2284. **[mcpgen](https://github.com/lyeslabs/mcpgen)** - ⭐ 88
   Generate Go MCP server boilerplate from OpenAPI 3 specifications

2285. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 88
   CLI & API for MCP management

2286. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 88
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

2287. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 88
   A WooCommerce (MCP) Model Context Protocol server

2288. **[AutoGenesis](https://github.com/microsoft/AutoGenesis)** - ⭐ 88
...
2289. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 87
...
2290. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 87
...
2291. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 87
   mcp server for slidev to make web ppt quickly and elegantly

2292. **[mcp-dbutils](https://github.com/donghao1393/mcp-dbutils)** - ⭐ 87
...
2293. **[sdl-mcp](https://github.com/GlitterKill/sdl-mcp)** - ⭐ 87
...
2294. **[mcpmu](https://github.com/Bigsy/mcpmu)** - ⭐ 87
   TUI-based MCP server multiplexer, configure all your MCP's in a single MCP with profiles

2295. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 87
   MCP server for Slither static analysis of Solidity smart contracts

2296. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 87
...
2297. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 87
...
2298. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 87
...
2299. **[mirroir-mcp](https://github.com/jfarcand/mirroir-mcp)** - ⭐ 87
...
2300. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 86
   Ragie Model Context Protocol Server

2301. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

2302. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

2303. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

2304. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 86
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

2305. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 86
   Agent Tool Protocol

2306. **[mcp-server](https://github.com/cap-js/mcp-server)** - ⭐ 86
   MCP server for AI-assisted development of CAP applications

2307. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 86
...
2308. **[mcp-server](https://github.com/bitDive/mcp-server)** - ⭐ 86
...
2309. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 86
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

2310. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 86
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2311. **[aivectormemory](https://github.com/Edlineas/aivectormemory)** - ⭐ 86
...
2312. **[reddit-mcp-server](https://github.com/jordanburke/reddit-mcp-server)** - ⭐ 86
   ⚙️ A Model Context Protocol (MCP) that provides tools for fetching and creating Reddit content

2313. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 85
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

2314. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 85
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

2315. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

2316. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 85
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

2317. **[fabric-mcp](https://github.com/ksylvan/fabric-mcp)** - ⭐ 85
   Fabric MCP Server: Seamlessly integrate Fabric AI capabilities into MCP-enabled tools like IDEs and chat interfaces.

2318. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 85
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

2319. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 85
...
2320. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 85
...
2321. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 85
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

2322. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 85
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

2323. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 85
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

2324. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 85
   Model Context Protocol server for CODESYS automation platform

2325. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
2326. **[spiceflow-framework](https://github.com/remorses/spiceflow-framework)** - ⭐ 84
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

2327. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 84
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

2328. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 84
   a mcp server to manage github project's functionality 

2329. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 84
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

2330. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 84
   Model Context Protocol (MCP) Server for the Keboola Platform

2331. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 84
   Open-source FRED MCP Server (Federal Reserve Economic Data)

2332. **[mcp-1c](https://github.com/feenlace/mcp-1c)** - ⭐ 84
...
2333. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 84
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

2334. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 84
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

2335. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 84
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

2336. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 84
...
2337. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 84
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

2338. **[ComIDP-MCP-Server](https://github.com/ComPDFKit/ComIDP-MCP-Server)** - ⭐ 84
   A lightweight MCP (Model Context Protocol) server designed for seamless integrating ComIDP with Claude Desktop.

2339. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 84
   An extension of MCP for SillyTavern.

2340. **[line-desktop-mcp](https://github.com/dtwang/line-desktop-mcp)** - ⭐ 84
...
2341. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 83
...
2342. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 83
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

2343. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 83
   Streams are the future of AI powered by unlimited free tokens.

2344. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

2345. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 83
...
2346. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 83
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

2347. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 83
...
2348. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 83
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

2349. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 83
   The EMBL-EBI Ontology Lookup Service (OLS)

2350. **[zed-mcp-server-github](https://github.com/LoamStudios/zed-mcp-server-github)** - ⭐ 83
   A GitHub MCP Server extension for Zed

2351. **[mcp-forge](https://github.com/achetronic/mcp-forge)** - ⭐ 83
   A complete MCP server template that include vitamins (oauth authentication included)

2352. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 83
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

2353. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 83
...
2354. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 83
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

2355. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 83
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

2356. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 83
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

2357. **[houtini-lm](https://github.com/houtini-ai/houtini-lm)** - ⭐ 83
...
2358. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 83
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2359. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 82
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

2360. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 82
...
2361. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 82
   Model Context Protocol (MCP) CLI server template for Rust

2362. **[claude-mermaid](https://github.com/veelenga/claude-mermaid)** - ⭐ 82
   MCP Server to previewing mermaid diagrams with live reload

2363. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 82
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

2364. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 82
...
2365. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 82
   A Model Context Protocol (MCP) server for Microsoft Clarity

2366. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 82
   A full featured, enterprise grade rust MCP SDK

2367. **[qgis-mcp](https://github.com/nkarasiak/qgis-mcp)** - ⭐ 82
   Connect QGIS to Claude AI through the Model Context Protocol (MCP)

2368. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 82
...
2369. **[formanator](https://github.com/timrogers/formanator)** - ⭐ 81
   Submit and manage Forma (https://joinforma.com) claims from the command line and Model Context Protocol (MCP) clients

2370. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

2371. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

2372. **[mcp-openapi](https://github.com/ReAPI-com/mcp-openapi)** - ⭐ 81
   OpenAPI specification MCP server.

2373. **[code-to-tree](https://github.com/micl2e2/code-to-tree)** - ⭐ 81
   A runtime-free MCP server that converts source code into AST🌲, regardless of language.

2374. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 81
   A model context protocol server that connects to Anki through AnkiConnect

2375. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 81
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

2376. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 81
   Model Context Protocol server for OpenStreetMap data

2377. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 81
...
2378. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 81
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

2379. **[perplexity-webui-scraper](https://github.com/henrique-coder/perplexity-webui-scraper)** - ⭐ 81
   An advanced, high-performance Python client, MCP server, and REST API for reverse-engineering Perplexity AI's WebUI.

2380. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 80
...
2381. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

2382. **[mcp-server-any-openapi](https://github.com/baryhuang/mcp-server-any-openapi)** - ⭐ 80
...
2383. **[ophis](https://github.com/njayp/ophis)** - ⭐ 80
   Transform any Cobra CLI into an MCP server

2384. **[mcpc](https://github.com/mcpc-tech/mcpc)** - ⭐ 80
   Build agentic-MCP servers by composing existing MCP tools.

2385. **[tauri-plugin-mcp](https://github.com/P3GLEG/tauri-plugin-mcp)** - ⭐ 80
...
2386. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 80
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

2387. **[transit-agent](https://github.com/ruby-verma/transit-agent)** - ⭐ 80
...
2388. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 80
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

2389. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 80
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2390. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 79
...
2391. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 79
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

2392. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

2393. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

2394. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
2395. **[glif-mcp-server](https://github.com/glifxyz/glif-mcp-server)** - ⭐ 79
   Easily run glif.app AI workflows inside your LLM: image generators, memes, selfies, and more. Glif supports all major multimedia AI models inside one app

2396. **[terminal_server](https://github.com/theailanguage/terminal_server)** - ⭐ 79
   MCP server that can execute terminal commands

2397. **[django-ai-boost](https://github.com/vintasoftware/django-ai-boost)** - ⭐ 79
   A MCP server for Django applications, inspired by Laravel Boost.

2398. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 79
   Model Context Protocol implementation for retrieving codebases using RepoMix

2399. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 79
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

2400. **[modular-context-obsidian-plugin](https://github.com/klemensgc/modular-context-obsidian-plugin)** - ⭐ 79
   Modular Context | Karpathy LLM Knowledge Base + Gmail & G-Cal — multi-account MCP server for Claude Code, encrypted local-first

2401. **[Ludus-FastMCP](https://github.com/tjnull/Ludus-FastMCP)** - ⭐ 79
...
2402. **[RivalSearchMCP](https://github.com/damionrashford/RivalSearchMCP)** - ⭐ 79
...
2403. **[gno](https://github.com/gmickel/gno)** - ⭐ 79
...
2404. **[hulunote](https://github.com/hulunote/hulunote)** - ⭐ 79
   AI + Note Hippocampus — Your second brain, powered by AI

2405. **[MiniMax-Coding-Plan-MCP](https://github.com/MiniMax-AI/MiniMax-Coding-Plan-MCP)** - ⭐ 79
...
2406. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 79
...
2407. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 79
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

2408. **[bing-search-mcp](https://github.com/leehanchung/bing-search-mcp)** - ⭐ 78
   MCP Server for Bing Search API

2409. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 78
...
2410. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 78
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

2411. **[wasmcp](https://github.com/wasmcp/wasmcp)** - ⭐ 78
   Build MCP servers with WebAssembly components

2412. **[windbg-mcp](https://github.com/gengstah/windbg-mcp)** - ⭐ 78
...
2413. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 77
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

2414. **[rtfmbro-mcp](https://github.com/marckrenn/rtfmbro-mcp)** - ⭐ 77
   rtfmbro provides always-up-to-date, version-specific package documentation as context for coding agents. An alternative to context7

2415. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
2416. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

2417. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

2418. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 77
   Model Context Protocol (MCP) Client for Apify's Actors

2419. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 77
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

2420. **[mcp-llm](https://github.com/sammcj/mcp-llm)** - ⭐ 77
    An MCP server that provides LLMs access to other LLMs

2421. **[ExternalAttacker-MCP](https://github.com/MorDavid/ExternalAttacker-MCP)** - ⭐ 77
   A modular external attack surface mapping tool integrating tools for automated reconnaissance and bug bounty workflows.

2422. **[agent-security-scanner-mcp](https://github.com/sinewaveai/agent-security-scanner-mcp)** - ⭐ 77
   Security scanner MCP server for AI coding agents. Prompt injection firewall, package hallucination detection (4.3M+ packages), 1000+ vulnerability rules with AST & taint analysis, auto-fix.

2423. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 77
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

2424. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 77
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

2425. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 77
   A Model Context Protocol Server to perform Kafka client operations

2426. **[unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server)** - ⭐ 77
   The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.

2427. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 77
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

2428. **[mcp-gemini-google-search](https://github.com/yukukotani/mcp-gemini-google-search)** - ⭐ 76
   MCP server for Google Search integration using Gemini's built-in search capabilities

2429. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

2430. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 76
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

2431. **[perplexity-mcp-zerver](https://github.com/wysh3/perplexity-mcp-zerver)** - ⭐ 76
   MCP web search using perplexity without any API KEYS 

2432. **[lazy-mcp](https://github.com/voicetreelab/lazy-mcp)** - ⭐ 76
     MCP proxy server with lazy loading support - reduces context usage through on-demand tool activation

2433. **[apitap](https://github.com/n1byn1kt/apitap)** - ⭐ 76
   The MCP server that turns any website into an API — no docs, no SDK, no browser. npm: @apitap/core

2434. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 76
...
2435. **[Sephera](https://github.com/Reim-developer/Sephera)** - ⭐ 76
   Fast local-first Rust CLI for codebase metrics, AST-compressed LLM context bundles, and built-in MCP server.

2436. **[altk-evolve](https://github.com/AgentToolkit/altk-evolve)** - ⭐ 76
   Self improving agents through iterations

2437. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 76
...
2438. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 76
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

2439. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 76
   Index of all Model Context Protocol (MCP) clients and their capabilities

2440. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 75
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

2441. **[Meting-Agent](https://github.com/ELDment/Meting-Agent)** - ⭐ 75
   🪐 面向 AI 的多音乐平台的 API 代理 • 网易云 • QQ音乐 • 酷狗 • 酷我 🎻 Multi-platform music API agent for AI • NetEase • QQ Music • KuGou • Kuwo

2442. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

2443. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 75
   MCP to explore websites with llms.txt files

2444. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 75
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

2445. **[openfoam-mcp-server](https://github.com/webworn/openfoam-mcp-server)** - ⭐ 75
   LLM-powered OpenFOAM MCP server for intelligent CFD education with Socratic questioning and expert error resolution

2446. **[roundtable](https://github.com/askbudi/roundtable)** - ⭐ 75
...
2447. **[interactive-brokers-mcp](https://github.com/code-rabi/interactive-brokers-mcp)** - ⭐ 75
   Interactive Brokers MCP Server

2448. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 75
   The Privacy Firewall for LLMs

2449. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 75
...
2450. **[zeromcp](https://github.com/mrexodia/zeromcp)** - ⭐ 75
   Zero-dependency MCP server implementation.

2451. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 75
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2452. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 75
...
2453. **[buddy](https://github.com/fiorastudio/buddy)** - ⭐ 75
...
2454. **[conductor-tasks](https://github.com/hridaya423/conductor-tasks)** - ⭐ 74
   A task management system designed for AI development

2455. **[gdai-mcp-plugin-godot](https://github.com/3ddelano/gdai-mcp-plugin-godot)** - ⭐ 74
...
2456. **[UnrealMotionGraphicsMCP](https://github.com/winyunq/UnrealMotionGraphicsMCP)** - ⭐ 74
...
2457. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 74
   Unified execution environment for Python code, shell commands, and programmatic MCP tool calls.

2458. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 74
   AniList MCP server for accessing anime and manga data

2459. **[ClueoMCP](https://github.com/ClueoFoundation/ClueoMCP)** - ⭐ 74
...
2460. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 74
   Altium Model Context Protocol server and Altium API script

2461. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 74
   Python 实现 MCP client / service

2462. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 74
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

2463. **[wp-mcp-ultimate](https://github.com/AgriciDaniel/wp-mcp-ultimate)** - ⭐ 74
...
2464. **[youtube-connector-mcp](https://github.com/ShellyDeng08/youtube-connector-mcp)** - ⭐ 73
...
2465. **[bitcoin-mcp](https://github.com/AbdelStark/bitcoin-mcp)** - ⭐ 73
   Bitcoin & Lightning Network MCP Server.

2466. **[sanity-mcp-server](https://github.com/sanity-io/sanity-mcp-server)** - ⭐ 73
   Deprecated: Use the remote MCP server at https://mcp.sanity.io instead.

2467. **[Custom-MCP-Server](https://github.com/Sharan-Kumar-R/Custom-MCP-Server)** - ⭐ 73
   MCP server for scraping LinkedIn, Facebook, Instagram profiles and Google search.

2468. **[firefox-devtools-mcp](https://github.com/globau/firefox-devtools-mcp)** - ⭐ 73
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2469. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 73
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

2470. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 73
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

2471. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 73
...
2472. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 72
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

2473. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 72
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

2474. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 72
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

2475. **[github-brain](https://github.com/wham/github-brain)** - ⭐ 72
   An experimental GitHub MCP server with local database.

2476. **[mcp-openmemory](https://github.com/baryhuang/mcp-openmemory)** - ⭐ 72
   Simple standalone MCP server giving Claude the ability to remember your conversations and learn from them over time.

2477. **[joplin-mcp](https://github.com/alondmnt/joplin-mcp)** - ⭐ 72
   MCP server for the Joplin note taking app

2478. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 72
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2479. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 72
   An unofficial and community-built MCP server for integrating with https://railway.app

2480. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 72
   Model Context Protocol (MCP) server for Gmail

2481. **[sugar](https://github.com/roboticforce/sugar)** - ⭐ 72
   Persistent memory for AI coding agents. Cross-session context, global knowledge, and autonomous task execution.

2482. **[ainativelang](https://github.com/sbhooley/ainativelang)** - ⭐ 72
...
2483. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 72
   可视化的配置和管理，给xiaozhi接入mcp

2484. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 72
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

2485. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 72
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

2486. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 72
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

2487. **[mcp-toolbox-sdk-js](https://github.com/googleapis/mcp-toolbox-sdk-js)** - ⭐ 72
   Javascript SDK for interacting with the MCP Toolbox for Databases.

2488. **[drawio-mcp-server](https://github.com/simonkurtz-MSFT/drawio-mcp-server)** - ⭐ 71
...
2489. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 71
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

2490. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 71
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

2491. **[adb-tui](https://github.com/alanisme/adb-tui)** - ⭐ 71
   🤖 Full-featured Android Debug Bridge TUI and MCP server. Control any device by keystroke or AI.

2492. **[ytt-mcp](https://github.com/cottongeeks/ytt-mcp)** - ⭐ 71
   MCP server to fetch YouTube transcripts

2493. **[MCP-wolfram-alpha](https://github.com/SecretiveShell/MCP-wolfram-alpha)** - ⭐ 71
   Connect your chat repl to wolfram alpha computational intelligence

2494. **[template-mcp-server](https://github.com/mcpdotdirect/template-mcp-server)** - ⭐ 71
   Template to quickly set up your own MCP server 

2495. **[sub-agents-mcp](https://github.com/shinpr/sub-agents-mcp)** - ⭐ 71
   Define task-specific AI sub-agents in Markdown for any MCP-compatible tool.

2496. **[medical-mcp](https://github.com/JamesANZ/medical-mcp)** - ⭐ 71
...
2497. **[trading-mcp](https://github.com/netanelavr/trading-mcp)** - ⭐ 71
   The MCP server that will help you trade smarter (or at least try)

2498. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 71
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

2499. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 71
   MCP client for local ollama models

2500. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 71
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

2501. **[gtm-mcp-server](https://github.com/paolobietolini/gtm-mcp-server)** - ⭐ 71
   An MCP server for Google Tag Manager. Connect it to your LLM, authenticate once, and start managing GTM through natural language.

2502. **[mcp-victorialogs](https://github.com/VictoriaMetrics/mcp-victorialogs)** - ⭐ 71
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2503. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 71
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

2504. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 71
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2505. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 71
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

2506. **[powerpoint-mcp](https://github.com/Ayushmaniar/powerpoint-mcp)** - ⭐ 71
   Open Source Model Context Protocol server for PowerPoint automation on Windows via pywin32

2507. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 71
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

2508. **[lc2mcp](https://github.com/xiaotonng/lc2mcp)** - ⭐ 70
   Convert LangChain tools to FastMCP tools

2509. **[mcp-discord](https://github.com/barryyip0625/mcp-discord)** - ⭐ 70
   Implement Discord MCP server enabling AI assistants to interact with the Discord platform.

2510. **[ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp)** - ⭐ 70
...
2511. **[ros2_mcp](https://github.com/wise-vision/ros2_mcp)** - ⭐ 70
   Advanced MCP Server ROS 2 bridging AI agents straight into robotics

2512. **[CodeMCP](https://github.com/SimplyLiz/CodeMCP)** - ⭐ 70
   Code intelligence for AI assistants - MCP server, CLI, and HTTP API with symbol navigation, impact analysis, and architecture mapping

2513. **[mcd-mcp-server](https://github.com/M-China/mcd-mcp-server)** - ⭐ 70
   McDonald's China MCP Server Integration Guide

2514. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 70
...
2515. **[MCP-server-Deepseek_R1](https://github.com/kamelirzouni/MCP-server-Deepseek_R1)** - ⭐ 70
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

2516. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 70
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

2517. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 70
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

2518. **[aguara](https://github.com/garagon/aguara)** - ⭐ 70
...
2519. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 70
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2520. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 69
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

2521. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 69
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

2522. **[robot_MCP](https://github.com/IliaLarchenko/robot_MCP)** - ⭐ 69
   A simple MCP server for the SO-ARM100 control

2523. **[crash-mcp](https://github.com/nikkoxgonzales/crash-mcp)** - ⭐ 69
   MCP server for structured and efficient reasoning with step validation, branching, and revisions.

2524. **[unity-mcp-plugin](https://github.com/AnkleBreaker-Studio/unity-mcp-plugin)** - ⭐ 69
...
2525. **[claude-code-source-all-in-one](https://github.com/wuwangzhang1216/claude-code-source-all-in-one)** - ⭐ 69
...
2526. **[Skills-ContextManager](https://github.com/One-Man-Company/Skills-ContextManager)** - ⭐ 69
...
2527. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 69
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

2528. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 69
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2529. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 69
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

2530. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 69
...
2531. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 68
...
2532. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 68
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

2533. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 68

2534. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 68
...
2535. **[mcp-server-node](https://github.com/lucianoayres/mcp-server-node)** - ⭐ 68
...
2536. **[deep-research-mcp-server](https://github.com/ssdeanx/deep-research-mcp-server)** - ⭐ 68
   MCP Deep Research Server using Gemini creating a Research AI Agent

2537. **[pydantic-rpc](https://github.com/i2y/pydantic-rpc)** - ⭐ 68
...
2538. **[vesta-mac-dist](https://github.com/scouzi1966/vesta-mac-dist)** - ⭐ 68
...
2539. **[hyperterse](https://github.com/hyperterse/hyperterse)** - ⭐ 68
   The MCP framework. Connect your data to your agents.

2540. **[nothumanallowed](https://github.com/adoslabsproject-gif/nothumanallowed)** - ⭐ 68
...
2541. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 68
...
2542. **[gdal-mcp](https://github.com/JordanGunn/gdal-mcp)** - ⭐ 68
...
2543. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 68
   🗓️ A CalDAV Model Context Protocol (MCP) server to expose calendar operations as tools for AI assistants.

2544. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 68
...
2545. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 68
   ABAP MCP - Model Context Protocol - Server SDK

2546. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 68
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2547. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 68
...
2548. **[reaper-mcp](https://github.com/bonfire-audio/reaper-mcp)** - ⭐ 68
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2549. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

2550. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

2551. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

2552. **[shinzo-ts](https://github.com/shinzo-labs/shinzo-ts)** - ⭐ 67
...
2553. **[nav2_mcp_server](https://github.com/ajtudela/nav2_mcp_server)** - ⭐ 67
   MCP server that provides tools and resources to control and monitor robots using Nav2.

2554. **[mcp-bear](https://github.com/jkawamoto/mcp-bear)** - ⭐ 67
   A MCP server for interacting with Bear note-taking software.

2555. **[nautex](https://github.com/hmldns/nautex)** - ⭐ 67
   MCP server for guiding Coding Agents via end-to-end requirements to implementation plan pipeline

2556. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 67
   Attio Model Context Protocol (MCP) server implementation

2557. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 67
...
2558. **[monolith](https://github.com/tumourlove/monolith)** - ⭐ 67
...
2559. **[compass](https://github.com/raystack/compass)** - ⭐ 67
...
2560. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 67
...
2561. **[adeu](https://github.com/dealfluence/adeu)** - ⭐ 67
...
2562. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 67
...
2563. **[mcp4k](https://github.com/ondrsh/mcp4k)** - ⭐ 67
   Compiler-driven MCP framework for Kotlin Multiplatform

2564. **[cesium-ai-integrations](https://github.com/CesiumGS/cesium-ai-integrations)** - ⭐ 67
...
2565. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 67
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2566. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 67
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2567. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 67
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

2568. **[join.cloud](https://github.com/kushneryk/join.cloud)** - ⭐ 66
...
2569. **[flapi](https://github.com/DataZooDE/flapi)** - ⭐ 66
...
2570. **[VibeShift](https://github.com/GroundNG/VibeShift)** - ⭐ 66
   [MCP Server] The Security Agent for AI assisted coding

2571. **[amazon-mcp](https://github.com/Fewsats/amazon-mcp)** - ⭐ 66
   Amazon MCP server to search & buy products using the L402

2572. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 66
   Model Context Protocol(MCP) 中文教程讲解

2573. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 66
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

2574. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 66
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

2575. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 66
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

2576. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 66
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

2577. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 66
...
2578. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 66
...
2586. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 65
   LSD Model Context Protocol

2587. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 65
   MCP server for the ClinicalTrials.gov v2 API. Search trials, retrieve study details and results, and match patients to eligible trials.

2588. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 65
...
2591. **[CornMCP](https://github.com/yuki-20/CornMCP)** - ⭐ 65
...
2592. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 65
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

2593. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 65
...
2594. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 65
...
2595. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 64
   A Model Context Protocol implementation for FHIR

2596. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

2597. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

2598. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 64
   A CLI tool for easy installation of MCP servers and managing their configuration

2599. **[mcp-server](https://github.com/UI5/mcp-server)** - ⭐ 64
   The UI5 MCP server improves the developer experience when working with agentic AI and the UI5 framework.

2600. **[estonia-ai-kit](https://github.com/stefanoamorelli/estonia-ai-kit)** - ⭐ 64
...
2601. **[pitlane-mcp](https://github.com/eresende/pitlane-mcp)** - ⭐ 64
   Token-efficient navigation substrate for AI coding agents. Index code once and retrieve only the symbols you need.

2602. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 64
   Miro integration for Model Context Protocol

2603. **[time-mcp](https://github.com/yokingma/time-mcp)** - ⭐ 64
   ⏰ Time MCP Server: Giving LLMs Time Awareness Capabilities

2604. **[SageFs](https://github.com/WillEhrendreich/SageFs)** - ⭐ 64
...
2605. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 64
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2606. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 64
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2607. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 63
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2608. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 63
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

2609. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 63
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2610. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 63
...
2611. **[cortex-scout](https://github.com/cortex-works/cortex-scout)** - ⭐ 63
...
2615. **[home-memory](https://github.com/impactjo/home-memory)** - ⭐ 63
   MCP server that lets your AI assistant remember everything about your home.

2616. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 63
...
2617. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 63
   Model Context Protocol server for ActivityWatch time tracking data

2618. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 63
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

2619. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 62
   A Model Context Protocol (MCP) server for Rember.

2620. **[mcp-server-ccxt](https://github.com/Nayshins/mcp-server-ccxt)** - ⭐ 62
   Cryptocurrency Market Data MCP Server

2621. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

2622. **[data-gov-il-mcp](https://github.com/DavidOsherdiagnostica/data-gov-il-mcp)** - ⭐ 62
   Advanced MCP server for seamless access to Israeli Government Open Data

2623. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 62
   Model Context Protocol server and client for R

2624. **[mcp-server-security-standard](https://github.com/mcp-security-standard/mcp-server-security-standard)** - ⭐ 62
...
2625. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 62
...
2626. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 62
...
2627. **[agent-architecture-review-sample](https://github.com/Azure-Samples/agent-architecture-review-sample)** - ⭐ 62
...
2628. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 62
   A Model Context Protocol server for Go developers

2629. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

2630. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 61
...
2631. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 61
   Universal MCP Server Configuration Manager

2632. **[identity-service](https://github.com/agntcy/identity-service)** - ⭐ 61
...
2633. **[nocodb-mcp-server](https://github.com/edwinbernadus/nocodb-mcp-server)** - ⭐ 61
   nocodb mcp server

2634. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 61
   A Clojure SDK to create MCP servers (and eventually clients)

2635. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 61
   A curated list of awesome Model Context Protocol (MCP) servers.

2636. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 61
...
2637. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 61
...
2638. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 61
...
2639. **[mcp-bridgekit](https://github.com/mkbhardwas12/mcp-bridgekit)** - ⭐ 61
...
2640. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 61
   A Model Context Protocol server for Ashra

2641. **[pentestMCP](https://github.com/RamKansal/pentestMCP)** - ⭐ 61
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2642. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 61
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

2643. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 61
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

2644. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 61
...
2645. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 60
   A powerful Model Context Protocol server for LinkedIn API integration

2646. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 60
   Unblock, scrape, and search tools for MCP clients

2647. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 60
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

2648. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 60
   MCP (Model Context Protocol) server for the Contentful Management API

2649. **[devto-mcp](https://github.com/Arindam200/devto-mcp)** - ⭐ 60
   MCP Server of DevTo

2650. **[autosteer](https://github.com/notch-ai/autosteer)** - ⭐ 60
   Desktop app for multi-workspace Claude Code management

2651. **[mcp-server-echart](https://github.com/cnkanwei/mcp-server-echart)** - ⭐ 60
   基于 mcp-go 框架构建的 mcp 服务，它提供了一个能动态生成 ECharts 图表页面的工具。

2652. **[blockbench-mcp-plugin](https://github.com/jasonjgardner/blockbench-mcp-plugin)** - ⭐ 60
   Adds MCP server to Blockbench

2653. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 60
...
2654. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 60
   MCP (Model Context Protocol) server plugin for CAP NodeJS

2655. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 60
...
2656. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 60
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

2657. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 59
   MCP Server for IBKR Client

2658. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 59
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

2659. **[mcp-difyworkflow-server](https://github.com/gotoolkits/mcp-difyworkflow-server)** - ⭐ 59
   mcp-difyworkflow-server is an mcp server Tools application that implements the query and invocation of Dify workflows, supporting the on-demand operation of multiple custom Dify workflows.

2660. **[cline-mcp-memory-bank](https://github.com/dazeb/cline-mcp-memory-bank)** - ⭐ 59
   A memory system for Cline that tracks progress between conversations.

2661. **[shadcn-ui-mcp-server](https://github.com/ymadd/shadcn-ui-mcp-server)** - ⭐ 59
   MCP server for shadcn/ui component references

2662. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 59
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

2663. **[mcp_server_gdb](https://github.com/pansila/mcp_server_gdb)** - ⭐ 59
   MCP Server to expose the GDB debugging capabilities

2664. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 59
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

2665. **[ask-user-questions-mcp](https://github.com/paulp-o/ask-user-questions-mcp)** - ⭐ 59
...
2666. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 59
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

2667. **[mcp-stata](https://github.com/tmonk/mcp-stata)** - ⭐ 59
...
2668. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 59
...
2669. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 58
   MCP router and Web Based MCP client

2670. **[mcpserver](https://github.com/2234839/mcpserver)** - ⭐ 58
   为claude code+glm 添加上眼睛

2671. **[job-searchoor](https://github.com/0xDAEF0F/job-searchoor)** - ⭐ 58
   A simple MCP server that delivers you jobs based on your needs

2672. **[scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp)** - ⭐ 58
   ScapeGraph MCP Server

2673. **[vscode-mcp](https://github.com/tjx666/vscode-mcp)** - ⭐ 58
...
2674. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 58
...
2675. **[better-bear](https://github.com/KuvopLLC/better-bear)** - ⭐ 58

2676. **[ntfy-me-mcp](https://github.com/gitmotion/ntfy-me-mcp)** - ⭐ 58
...
2677. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 58
...
2678. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 58
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

2679. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 58
...
2680. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 58
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

2681. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

2682. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 57
   Model Context Protocol server for Daipendency

2683. **[Archive-Agent](https://github.com/shredEngineer/Archive-Agent)** - ⭐ 57
   Find your files with natural language and ask questions.

2684. **[adbfriend](https://github.com/mikepenz/adbfriend)** - ⭐ 57
   Android ADB CLI tool including integrated MCP Server with common adb actions used during development

2685. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 57
   MKP is a Model Context Protocol (MCP) server for Kubernetes

2686. **[MCP_Atom_of_Thoughts](https://github.com/kbsooo/MCP_Atom_of_Thoughts)** - ⭐ 57
...
2687. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 57
   A Nasdaq Data Link MCP (Model Context Protocol) Server

2688. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 57
   OCaml implementation of the Model Context Protocol (MCP)

2689. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 57
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

2690. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

2691. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 57
...
2692. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 57
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

2693. **[openzim-mcp](https://github.com/cameronrye/openzim-mcp)** - ⭐ 57
...
2694. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 57
   Go SDK for interacting with the MCP Toolbox for Databases.

2695. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 57
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

2696. **[aitour26-WRK542-prototype-agents-with-Foundry-toolkit-and-model-context-protocol](https://github.com/microsoft/aitour26-WRK542-prototype-agents-with-Foundry-toolkit-and-model-context-protocol)** - ⭐ 57

2697. **[python](https://github.com/mcp-auth/python)** - ⭐ 57
   🔐 Plug-and-play auth for Python MCP servers.

2698. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 57
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

2699. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 57
   Open source MCP hosting - deploy MCP servers to HTTP endpoints for n8n, Dify, Voiceflow, and any MCP client.

2700. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2701. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 57
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

2702. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 57
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

2703. **[ontosphere](https://github.com/ThHanke/ontosphere)** - ⭐ 57
...
2704. **[ApkMCP-Auto](https://github.com/kggzs/ApkMCP-Auto)** - ⭐ 57
   本项目是一个 Android 逆向工程工具集合，通过 MCP (Model Context Protocol) 协议将 AI 助手（如 Claude）与专业的 Android 反编译工具连接起来，实现智能化的 APK 分析与修改。

2705. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 57
...
2706. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
2707. **[naver-search-mcp](https://github.com/isnow890/naver-search-mcp)** - ⭐ 56
...
2708. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 56
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

2709. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 56
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

2710. **[solana-mcp-server](https://github.com/openSVM/solana-mcp-server)** - ⭐ 56
   solana mcp sever to enable solana rpc methods

2711. **[web2mcp](https://github.com/neelsomani/web2mcp)** - ⭐ 56
   Generate an MCP for any web app

2712. **[mcp-server-flomo](https://github.com/chatmcp/mcp-server-flomo)** - ⭐ 56
   Write notes to Flomo

2713. **[MegaMemory](https://github.com/0xK3vin/MegaMemory)** - ⭐ 56
   Persistent project knowledge graph for coding agents. MCP server with semantic search, in-process embeddings, and web explorer.

2714. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 56
...
2715. **[mcpshim](https://github.com/mcpshim/mcpshim)** - ⭐ 56
   Turn remote MCP servers into local command workflows.

2716. **[client](https://github.com/php-mcp/client)** - ⭐ 56
   Core PHP implementation for the Model Context Protocol (MCP) Client

2717. **[astro-mcp](https://github.com/morinokami/astro-mcp)** - ⭐ 56
   MCP server to support Astro project development

2718. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 56
...
2719. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 56
...
2720. **[unity-mcp-pro-plugin](https://github.com/youichi-uda/unity-mcp-pro-plugin)** - ⭐ 56
...
2721. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 55
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

2722. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 55
   Build multi-model chatbots and agents from intent.

2723. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 55
...
2724. **[mcp-secrets-plugin](https://github.com/amirshk/mcp-secrets-plugin)** - ⭐ 55
...
2725. **[trellis_blender](https://github.com/FishWoWater/trellis_blender)** - ⭐ 55
   Blender plugin for TRELLIS and TRELLIS.2 (3D AIGC Model, Text-to-3D, Image-to-3D)

2726. **[powhttp-mcp](https://github.com/usestring/powhttp-mcp)** - ⭐ 55
   MCP server enabling agents to debug HTTP requests better (using powhttp)

2727. **[cosmotop](https://github.com/bjia56/cosmotop)** - ⭐ 55
   Multiplatform system monitoring tool using Cosmopolitan Libc

2728. **[AfdianToMarkdown](https://github.com/PhiFever/AfdianToMarkdown)** - ⭐ 55
   爱发电爬虫(afdian.com)

2729. **[go-crx3](https://github.com/mmadfox/go-crx3)** - ⭐ 55
...
2730. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 55
   MCP Memory Server with DuckDB backend

2731. **[unraid-mcp](https://github.com/jmagar/unraid-mcp)** - ⭐ 55
...
2732. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 55
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

2733. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 55
...
2734. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 55
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2735. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 55
   Implementation of Model Context Protocol server for Mailgun APIs

2736. **[npm-packages](https://github.com/WebMCP-org/npm-packages)** - ⭐ 55
   NPM packages for MCP-B: Transport layers, React hooks, and browser tools for the Model Context Protocol

2737. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 55
   Amadeus MCP(Model Context Protocol) Server

2738. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 55
   IMAP Model Context Protocol server for interactive email processing

2739. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 55
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

2740. **[UnrealMCPBridge](https://github.com/appleweed/UnrealMCPBridge)** - ⭐ 54
   An Unreal Engine plugin that implements an MCP server allowing MCP clients to access the UE Editor Python API.

2741. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

2742. **[minibridge](https://github.com/acuvity/minibridge)** - ⭐ 54
   Make your MCP servers secure and production ready

2743. **[temporal-mcp](https://github.com/Mocksi/temporal-mcp)** - ⭐ 54
   Empowering AI with Workflow Orchestration

2744. **[sympy-mcp](https://github.com/sdiehl/sympy-mcp)** - ⭐ 54
   A MCP server for symbolic manipulation of mathematical expressions

2745. **[swift-mcp-gui](https://github.com/NakaokaRei/swift-mcp-gui)** - ⭐ 54
   MCP server that can execute commands such as keyboard input and mouse movement on macOS

2746. **[talkito](https://github.com/robdmac/talkito)** - ⭐ 54
...
2747. **[Navidrome-MCP](https://github.com/Blakeem/Navidrome-MCP)** - ⭐ 54
...
2748. **[claude-code-emacs](https://github.com/yuya373/claude-code-emacs)** - ⭐ 54
...
2749. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 54
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

2750. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 54
   A Model Context Protocol server that validates and renders Mermaid diagrams.

2751. **[brainstorm-mcp](https://github.com/spranab/brainstorm-mcp)** - ⭐ 54
   MCP server for multi-round AI brainstorming debates between multiple models (GPT, DeepSeek, Groq, Ollama, etc.)

2752. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 54
   MCP client for Discourse sites

2753. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 54
...
2754. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 54
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2755. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 53
   Model Context Protocol Servers for Azure AI Search

2756. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
2757. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

2758. **[user-feedback-mcp](https://github.com/mrexodia/user-feedback-mcp)** - ⭐ 53
   Simple MCP Server to enable a human-in-the-loop workflow in tools like Cline and Cursor.

2759. **[Multi-Agent-System-A2A-ADK-MCP](https://github.com/RubensZimbres/Multi-Agent-System-A2A-ADK-MCP)** - ⭐ 53
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2760. **[skrills](https://github.com/athola/skrills)** - ⭐ 53
...
2773. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 53
   Inkdrop Model Context Protocol Server

2774. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 53
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2775. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 53
   MCP (Model Context Protocol) server for the Contentful Management API

2776. **[roblox-executor-mcp](https://github.com/notpoiu/roblox-executor-mcp)** - ⭐ 53
   A MCP Server which allows for direct access to the roblox game client

2777. **[PowerShell.MCP](https://github.com/yotsuda/PowerShell.MCP)** - ⭐ 53
...
2778. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 52
   Unofficial Golang SDK for Anthropic Model Context Protocol

2779. **[A2A_ADK_MCP](https://github.com/RubensZimbres/A2A_ADK_MCP)** - ⭐ 52
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2780. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 52
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2781. **[baba_is_eval](https://github.com/lennart-finke/baba_is_eval)** - ⭐ 52
   Claude  et al. play the brilliant puzzle title "Baba is You"

2782. **[us-census-bureau-data-api-mcp](https://github.com/uscensusbureau/us-census-bureau-data-api-mcp)** - ⭐ 52
   The U.S. Census Bureau Data API MCP connects AI Assistants with official Census Bureau statistics.

2783. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 52
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

2784. **[gemini-cloud-assist-mcp](https://github.com/GoogleCloudPlatform/gemini-cloud-assist-mcp)** - ⭐ 52
   An MCP Server for Gemini Cloud Assist; provides tools to assist with your tasks on GCP

2785. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 52
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

2786. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 52
   Official Rust implementation of the UTCP

2787. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 52
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2788. **[unity-api-mcp](https://github.com/Codeturion/unity-api-mcp)** - ⭐ 52
...
2789. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 52
...
2790. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 52
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

2791. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 52
...
2792. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 52
...
2793. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
2794. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 52
...
2795. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 52
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2796. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 52
   A Model-Context-Protocol (MCP) Server for Active Directory

2797. **[ferris-search](https://github.com/lispking/ferris-search)** - ⭐ 52
   A blazing-fast MCP (Model Context Protocol) server for multi-engine web search, written in Rust.

2798. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 52
...
2799. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 52
...
2800. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 51
...
2801. **[gdal-mcp](https://github.com/Wayfinder-Foundry/gdal-mcp)** - ⭐ 51
   Model Context Protocol server that packages GDAL-style geospatial workflows through Python-native libraries (Rasterio, GeoPandas, PyProj, etc.) to give AI agents catalog discovery, metadata intelligence, and raster/vector processing with built-in reasoning guidance and reference resources.

2802. **[whois-mcp](https://github.com/bharathvaj-ganesan/whois-mcp)** - ⭐ 51
   MCP Server for whois lookups.

2803. **[mcp-atlassian-server](https://github.com/phuc-nt/mcp-atlassian-server)** - ⭐ 51
   MCP server connecting AI assistants with Jira & Confluence for smart project management.

2804. **[ShadowCrawl](https://github.com/DevsHero/ShadowCrawl)** - ⭐ 51
...
2805. **[hmr](https://github.com/promplate/hmr)** - ⭐ 51
   Real hot-module reload for Python—side effects handled reactively. https://py3.online/hmr

2806. **[matlab-mcp-server](https://github.com/subspace-lab/matlab-mcp-server)** - ⭐ 51
   Matlab MCP Server in python

2807. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 51
...
2813. **[template-mcp-server](https://github.com/redhat-data-and-ai/template-mcp-server)** - ⭐ 51
   Production-ready Python template for building MCP servers with FastMCP, FastAPI, OAuth, and OpenShift deployment.

2814. **[openclaw-superpowers](https://github.com/ArchieIndian/openclaw-superpowers)** - ⭐ 51
   44 plug-and-play skills for OpenClaw — self-modifying AI agent with cron scheduling, security guardrails, persistent memory, knowledge graphs, and MCP health monitoring. Your agent teaches itself new behaviors during conversation.

2815. **[notebooklm-mcp](https://github.com/roomi-fields/notebooklm-mcp)** - ⭐ 51
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

2816. **[omnifocus-mcp-enhanced](https://github.com/jqlts1/omnifocus-mcp-enhanced)** - ⭐ 51
...
2817. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 51
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2818. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

2819. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

2820. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2821. **[devswarm](https://github.com/justrach/devswarm)** - ⭐ 51
...
2828. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 50
...
2829. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 50
   An implementation of the Model Context Protocol in Ruby.

2830. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 50
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

2831. **[gimp-mcp](https://github.com/maorcc/gimp-mcp)** - ⭐ 50
   GIMP MCP server

2832. **[mcp-tts](https://github.com/blacktop/mcp-tts)** - ⭐ 50
   MCP Server for Text to Speech

2833. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 50
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

2834. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 50
...
2835. **[civyk-winwright](https://github.com/civyk-official/civyk-winwright)** - ⭐ 50
...
2836. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 50
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

2837. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 50
...
2838. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 50
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2839. **[slack-mcp-plugin](https://github.com/slackapi/slack-mcp-plugin)** - ⭐ 50
   Repo containing the configuration information for the Slack MCP to be added to other clients

2840. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 50
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2841. **[synapse-ai](https://github.com/synapseorch-ai/synapse-ai)** - ⭐ 50
...
2842. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 49
   Anthropic’s Model Context Protocol implementation for Oat++

2843. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 49
   vMCP - Virtual Model Context Protocol

2844. **[n8n-workflow-builder-mcp](https://github.com/ifmelate/n8n-workflow-builder-mcp)** - ⭐ 49
   MCP server that allow LLM in agent mode builds n8n workflows for you

2845. **[linux-do-mcp](https://github.com/Pleasurecruise/linux-do-mcp)** - ⭐ 49
   A MCP Server For LINUX DO community

2846. **[agent-os](https://github.com/imran-siddique/agent-os)** - ⭐ 49
   A Safety-First Kernel for Autonomous AI Agents - POSIX-inspired primitives with 0% policy violation guarantee

2847. **[cinema4d-mcp](https://github.com/ttiimmaacc/cinema4d-mcp)** - ⭐ 49
   Cinema 4D plugin integrating Claude AI for prompt-driven 3D modeling, scene creation, and manipulation.

2848. **[image-gen-mcp](https://github.com/lansespirit/image-gen-mcp)** - ⭐ 49
   An MCP server that integrates with gpt-image-1 & Gemini imagen4 model for text-to-image generation services

2849. **[mcp](https://github.com/goplus/mcp)** - ⭐ 49
...
2850. **[mcp_server_notify](https://github.com/Cactusinhand/mcp_server_notify)** - ⭐ 49
   Send system notification when Agent task is done.

2851. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 49

2852. **[MCPwner](https://github.com/Pigyon/MCPwner)** - ⭐ 49
   Model Context Protocol server for autonomous vulnerability discovery

2853. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 49
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

2854. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 49
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

2855. **[gtm-mcp](https://github.com/impecablemee/gtm-mcp)** - ⭐ 49
...
2856. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 49
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

2857. **[lisply-mcp](https://github.com/gornskew/lisply-mcp)** - ⭐ 49
   Model Context Protocol (MCP) server to manage and talk to compliant "Lisply" lisp-speaking backend services

2858. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 49
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

2859. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 49
...
2860. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 49
...
2861. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 49
...
2862. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 49
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

2863. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 49
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

2864. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 49
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

2865. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 49
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2866. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 48
   Un-official Serper Google search server for Cline and other MCP clients

2867. **[shadowgit-mcp](https://github.com/aflsolutions/shadowgit-mcp)** - ⭐ 48
...
2868. **[mcp-codebase-index](https://github.com/MikeRecognex/mcp-codebase-index)** - ⭐ 48
...
2869. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 48
...
2870. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
2871. **[mcp-server-chart-minio](https://github.com/zaizaizhao/mcp-server-chart-minio)** - ⭐ 48
   mcp-server-chart私有化部署方案

2872. **[lakevision](https://github.com/lakevision-project/lakevision)** - ⭐ 48
   Lakevision is a tool which provides insights into your Apache Iceberg based Data Lakehouse.

2873. **[buildkite-mcp-server](https://github.com/buildkite/buildkite-mcp-server)** - ⭐ 48
   Official MCP Server for Buildkite.

2874. **[mcp-metabase-server](https://github.com/easecloudio/mcp-metabase-server)** - ⭐ 48
   A comprehensive MCP server for Metabase with 70+ tools.

2875. **[globalping-mcp-server](https://github.com/jsdelivr/globalping-mcp-server)** - ⭐ 48
   Remote MCP server that gives LLMs access to run network commands

2876. **[advanced-homeassistant-mcp](https://github.com/jango-blockchained/advanced-homeassistant-mcp)** - ⭐ 48
   An advanced MCP server for Home Assistant. 🔋 Batteries included.

2877. **[codex-specialized-subagents](https://github.com/leonardsellem/codex-specialized-subagents)** - ⭐ 48
   MCP server that lets Codex delegate to isolated codex exec sub-agents, selecting repo+global skills automatically

2878. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides AI assistants with secure, read-only access to your ShadowGit repositories. This enables powerful debugging and code analysis capabilities by giving AI access to your project's fine-grained git history.

2879. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 48
   Model Context Protocol to fetch youtube transcript

2880. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 48
   mcp server to run scripts on adobe illustrator

2881. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

2882. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 48
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2883. **[claude-plugins](https://github.com/2389-research/claude-plugins)** - ⭐ 48
...
2884. **[Kaimon.jl](https://github.com/kahliburke/Kaimon.jl)** - ⭐ 48
...
2885. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 48
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2886. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 48
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2887. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2888. **[js](https://github.com/mcp-auth/js)** - ⭐ 48
   🔐 Plug-and-play auth for Node.js MCP servers.

2889. **[mcp-gitlab-server](https://github.com/yoda-digital/mcp-gitlab-server)** - ⭐ 48
   Enhanced MCP server for GitLab: group projects listing and activity tracking

2890. **[foundry-vtt-mcp](https://github.com/adambdooley/foundry-vtt-mcp)** - ⭐ 48
...
2891. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 48
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2892. **[sharedcontext](https://github.com/Eversmile12/sharedcontext)** - ⭐ 48
...
2893. **[cheat-engine-server-python](https://github.com/bethington/cheat-engine-server-python)** - ⭐ 48
...
2894. **[synapse-ai](https://github.com/naveenraj-17/synapse-ai)** - ⭐ 48
   Build AI agents that actually do things. Synapse is an open-source platform for creating, connecting, and orchestrating AI agents powered by any LLM — local, cloud or CLIs.

2895. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 47
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

2896. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

2897. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
2898. **[spec-coding-mcp](https://github.com/feiyun0112/spec-coding-mcp)** - ⭐ 47
...
2899. **[gnome-mcp-server](https://github.com/bilelmoussaoui/gnome-mcp-server)** - ⭐ 47
   Grant the AI octopus access to a portion of your desktop

2900. **[dremio-mcp](https://github.com/dremio/dremio-mcp)** - ⭐ 47
   Dremio MCP server

2901. **[Reversecore_MCP](https://github.com/sjkim1127/Reversecore_MCP)** - ⭐ 47
...
2902. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 47
   OpenAPI Schema Model Context Protocol Server

2903. **[MDB-MCP](https://github.com/smadi0x86/MDB-MCP)** - ⭐ 47
   Multi Debugger MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2904. **[mcp-zen](https://github.com/199-mcp/mcp-zen)** - ⭐ 47
   Enhanced Zen MCP Server with 'zen' default tool and improvements

2905. **[ai-software-architect](https://github.com/codenamev/ai-software-architect)** - ⭐ 47
...
2906. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 47
   Sample MCP Server and MCP client with Aspire

2907. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 47
   A production-ready Model Context Protocol (MCP) server for semantic memory management

2908. **[oh-my-codex](https://github.com/scalarian/oh-my-codex)** - ⭐ 47
...
2909. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 47
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2910. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 47
...
2911. **[mcp-workspace](https://github.com/MarcusJellinghaus/mcp-workspace)** - ⭐ 47
...
2912. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 47
...
2913. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 47
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2914. **[AgentTools](https://github.com/WolframResearch/AgentTools)** - ⭐ 47
   Implements a model context protocol server using Wolfram Language

2915. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 47
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2916. **[MCP-Trust-Kit](https://github.com/aak204/MCP-Trust-Kit)** - ⭐ 46
   Deterministic CI scanner and surface-risk scoring for MCP (Model Context Protocol) servers.

2917. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 46
   共学《MCP极简开发》项目代码

2918. **[steel-mcp-server](https://github.com/steel-dev/steel-mcp-server)** - ⭐ 46
   MCP Server for interacting with a Steel web browser

2919. **[tiger-slack](https://github.com/timescale/tiger-slack)** - ⭐ 46
   Real-time Slack ingest and MCP server to power your agentic Slack bots

2920. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 46
   Model Context Protocol server for Flight Tracking

2921. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 46
   MCPcat is an analytics platform for MCP server owners 🐱.

2922. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 46
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

2923. **[inAI-wiki](https://github.com/inai-sandy/inAI-wiki)** - ⭐ 46
   🌍 The open-source Wikipedia of AI — 2M+ apps, agents, LLMs & datasets. Updated daily with tools, tutorials & news.

2924. **[lighthouse-mcp-server](https://github.com/danielsogl/lighthouse-mcp-server)** - ⭐ 46
   MCP server that enables AI agents to perform comprehensive web audits using Google Lighthouse with 13+ tools for performance, accessibility, SEO, and security analysis.

2925. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 46
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2926. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 46
...
2927. **[claude-additional-models-mcp](https://github.com/Arkya-AI/claude-additional-models-mcp)** - ⭐ 46
...
2928. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2929. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 46
   An implementation of the Model Context Protocol for the World Bank open data API

2930. **[Generative-UI-MCP](https://github.com/op7418/Generative-UI-MCP)** - ⭐ 46
   MCP server that teaches AI models to generate interactive visualizations — charts, diagrams, mockups, and more.

2931. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 46
   An opinionated starter template for making Model Context Protocol (MCP) servers

2932. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 46
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2933. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2934. **[tomtom-maps-mcp](https://github.com/tomtom-international/tomtom-maps-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2935. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 46
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

2936. **[peta-core](https://github.com/dunialabs/peta-core)** - ⭐ 46
   The Control Plane for MCP — secure vault, managed runtime, audit trail, and policy-based approvals.

2937. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2938. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 46
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2939. **[mcp-musescore](https://github.com/ghchen99/mcp-musescore)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides programmatic control over MuseScore!

2940. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 46
...
2941. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 46
...
2942. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 45
...
2943. **[dataworkers-claw-community](https://github.com/DataWorkersProject/dataworkers-claw-community)** - ⭐ 45
   We’re build a swarm of agents for all data tasks. That anyone can use for free, open-source community version.  

2944. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 45
...
2945. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 45
...
2946. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 45
   ElizaOS plugin allowing agents to connect to MCP servers

2947. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

2948. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

2949. **[mcp-yfinance-server](https://github.com/Adity-star/mcp-yfinance-server)** - ⭐ 45
   Real-time stock API with Python, MCP server example, yfinance stock analysis dashboard

2950. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 45
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

2951. **[ainovelprompter](https://github.com/danielsobrado/ainovelprompter)** - ⭐ 45
   Create the prompts you need to write your Novel using AI

2952. **[kanban-mcp](https://github.com/bradrisse/kanban-mcp)** - ⭐ 45
...
2953. **[gopls-mcp](https://github.com/xieyuschen/gopls-mcp)** - ⭐ 45
   MCP server for golang projects development: Expand AI Code Agent ability boundary to have a semantic understanding and determinisic information for golang projects.

2954. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 45
...
2955. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 45
   GraphQL Schema Model Context Protocol Server

2956. **[bonnard-cli](https://github.com/bonnard-data/bonnard-cli)** - ⭐ 45
   Open-source agentic schema CLI. Optimised for claude code, gemini, codex and co-pilot. Skills included.

2957. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 45
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2958. **[aitour26-WRK542-prototype-agents-with-the-ai-toolkit-and-model-context-protocol](https://github.com/microsoft/aitour26-WRK542-prototype-agents-with-the-ai-toolkit-and-model-context-protocol)** - ⭐ 45

2959. **[mcpx](https://github.com/lydakis/mcpx)** - ⭐ 45
   Turn MCP servers into composable CLIs.

2960. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 45
   A Model Context Protocol (MCP) server for NATS messaging system integration

2961. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 45
...
2962. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 45
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

2963. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 45
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2964. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 45
...
2965. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 45
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

2966. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 45
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

2967. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 45
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2968. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 45
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

2969. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 45
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2970. **[arch-mcp](https://github.com/nihalxkumar/arch-mcp)** - ⭐ 45
   Arch Linux MCP (Model Context Protocol) Server

2971. **[Dragon-Brain](https://github.com/iikarus/Dragon-Brain)** - ⭐ 45
...
2972. **[deepseek-mcp](https://github.com/arizen-dev/deepseek-mcp)** - ⭐ 45
   A tiny MCP stdio server that exposes DeepSeek as a cheap supervised worker for Claude Code, Codex, or any MCP client.

2973. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 44
   Model Context Protocol server for Salesforce REST API integration

2974. **[moondream-mcp](https://github.com/ColeMurray/moondream-mcp)** - ⭐ 44
   Moondream MCP Server in Python

2975. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
2976. **[mcp-typescribe](https://github.com/yWorks/mcp-typescribe)** - ⭐ 44
   An MCP server implementation enabling LLMs to work with new APIs and frameworks

2977. **[code-screenshot-mcp](https://github.com/MoussaabBadla/code-screenshot-mcp)** - ⭐ 44
   MCP server for generating beautiful code screenshots directly from Claude

2978. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 44
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

2979. **[chrome-debug-mcp](https://github.com/robertheadley/chrome-debug-mcp)** - ⭐ 44
   An MCP server to allow you to debug webpages using LLMs

2980. **[yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp)** - ⭐ 44
   Yandex Tracker MCP Server with OAuth2 support

2981. **[adal-cli](https://github.com/SylphAI-Inc/adal-cli)** - ⭐ 44
...
2982. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 44
   Model Context Protocol Platform，统一管理你的MCP服务

2983. **[prism-mcp-rs](https://github.com/prismworks-ai/prism-mcp-rs)** - ⭐ 44
   Enterprise-grade Rust implementation of Anthropic's MCP protocol

2984. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

2985. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 44
...
2986. **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** - ⭐ 44
...
2987. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 44
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2988. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 44
...
2989. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 44
   A curated list of excellent Model Context Protocol (MCP) servers.

2990. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 44
   Algorand Local Model Context Protocol (Server & Client)

2991. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 44
   A Model Context Protocol server implementation for Kagi's API

2992. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 44
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2993. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 44
   Model Context Protocol (MCP) server for LinkedIn API integration

2994. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 44
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2995. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 44
...
2996. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 44
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2997. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 44
...
2998. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 44
   Command-line interface for any Model Context Protocol (MCP) server.

2999. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 44
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

3000. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 44
   Bluesky MCP (Model Context Protocol) Server

3001. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 44
...
3002. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 44
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

3003. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 44
...
3004. **[TalkToFigmaDesktop](https://github.com/grab/TalkToFigmaDesktop)** - ⭐ 44
...
3005. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 43
   Quantum-proof MCP Server and Client Interactions

3006. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

3007. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

3008. **[mcp-rquest](https://github.com/xxxbrian/mcp-rquest)** - ⭐ 43
...
3013. **[nia](https://github.com/nozomio-labs/nia)** - ⭐ 43
...
3014. **[lastsaas](https://github.com/jonradoff/lastsaas)** - ⭐ 43
...
3015. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 43
   Solana Model Context Protocol (MCP) Demo

3016. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 43
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

3017. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 43
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

3018. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 43
   Sync MCP (Model Context Protocol) configurations across AI tools

3019. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 43
...
3020. **[music-composer-webmcp](https://github.com/Leanmcp-Community/music-composer-webmcp)** - ⭐ 43
...
3021. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 43
   model context protocol for Autodesk Revit

3022. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 43
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

3023. **[NepseAPI-Unofficial](https://github.com/surajrimal07/NepseAPI-Unofficial)** - ⭐ 43
...
3024. **[arifos](https://github.com/ariffazil/arifos)** - ⭐ 43
...
3025. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 43
   Claude Unified Model Context Interaction Protocol

3026. **[amazon_ads_mcp](https://github.com/KuudoAI/amazon_ads_mcp)** - ⭐ 43
   Amazon Ads MCP - Model Context Protocol server for Amazon Advertising API

3027. **[iota-agent-mcp](https://github.com/Scottcjn/iota-agent-mcp)** - ⭐ 43
...
3028. **[Mira](https://github.com/vwww-droid/Mira)** - ⭐ 43
   🔬 Mobile runtime detection workbench for AI (iOS and Android)

3029. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 42
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

3030. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 42
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

3031. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 42
   Model Context Protocol for WeChat

3032. **[mobile-dev-mcp-server](https://github.com/jsuarezruiz/mobile-dev-mcp-server)** - ⭐ 42
   This is a MCP designed to manage and interact with mobile devices and simulators.

3033. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 42
   Model Context Protocol Clojure support including REPL integration with development tools.

3034. **[zed-mcp-server-sequential-thinking](https://github.com/LoamStudios/zed-mcp-server-sequential-thinking)** - ⭐ 42
   A sequential thinking MCP server extension for Zed

3035. **[whatsapp-mcp](https://github.com/felipeadeildo/whatsapp-mcp)** - ⭐ 42
   WhatsApp Unofficial MCP Server

3036. **[linkedapi-mcp](https://github.com/Linked-API/linkedapi-mcp)** - ⭐ 42
   MCP server that lets AI assistants control LinkedIn accounts and retrieve real-time data.

3037. **[TWSEMCPServer](https://github.com/twjackysu/TWSEMCPServer)** - ⭐ 42
   台灣證交所OpenAPI 的 MCP Server

3038. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 42
   Rimworld Coding RAG MCP server

3039. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 42
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

3040. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 42
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

3041. **[getnote-mcp](https://github.com/iswalle/getnote-mcp)** - ⭐ 42
   GetNote For MCP

3042. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 42
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

3043. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 42
   A generic, modular server for implementing the Model Context Protocol (MCP). 

3044. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 42
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

3045. **[mie](https://github.com/kraklabs/mie)** - ⭐ 42
...
3046. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 42
   Model Context Protocol server for Sitecore

3047. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 42
   Emacs Lisp implementation of the Model Context Protocol

3048. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 42
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

3049. **[reactbits-mcp-server](https://github.com/ceorkm/reactbits-mcp-server)** - ⭐ 42
   MCP server providing access to 135+ animated React components from ReactBits.dev (9.2/10 test score)

3050. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 42
...
3051. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 42
...
3052. **[fusion360-claude-ultimate](https://github.com/Misterbra/fusion360-claude-ultimate)** - ⭐ 42
...
3053. **[email-mcp](https://github.com/codefuturist/email-mcp)** - ⭐ 42
...
3054. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 41
   Model Context Protocol (MCP) implementation for iOS simulators

3055. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
   MCP server that exposes YepCode processes as callable tools for AI platforms. Securely connect AI assistants to your YepCode workflows, APIs, and automations.

3056. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

3057. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 41
   A Model Context Protocol server for Dify

3058. **[ZMCPTools](https://github.com/ZachHandley/ZMCPTools)** - ⭐ 41
   A custom TypeScript MCP Server intended to be used with Claude Code

3059. **[locallama-mcp](https://github.com/Heratiki/locallama-mcp)** - ⭐ 41
...
3060. **[seekcode](https://github.com/seekrays/seekcode)** - ⭐ 41
   A clean and efficient code snippet and clipboard management tool designed for developers

3061. **[platform-context-exporter](https://github.com/alkoleft/platform-context-exporter)** - ⭐ 41
   Инструмент для выгрузки синтаксис помощника в файлы

3062. **[mcp-obsidian](https://github.com/fazer-ai/mcp-obsidian)** - ⭐ 41
   MCP server for Obsidian (TypeScript + Bun)

3063. **[unreal-mcp](https://github.com/runeape-sats/unreal-mcp)** - ⭐ 41
   Unreal Engine MCP server for Claude Desktop (early alpha preview)

3064. **[neurondb](https://github.com/neurondb/neurondb)** - ⭐ 41
   PostgreSQL extension for vector search, embeddings, and ML, plus NeuronAgent runtime and NeuronMCP server.

3065. **[processhacker-mcp](https://github.com/illegal-instruction-co/processhacker-mcp)** - ⭐ 41
   your ai debugger, vibe hacking tool

3066. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 41

3067. **[gatekit](https://github.com/gatekit-ai/gatekit)** - ⭐ 41
   A hackable Model Context Protocol (MCP) gateway

3068. **[memcord](https://github.com/ukkit/memcord)** - ⭐ 41
   🧠 Privacy-first MCP server for AI memory management. Save, search & organize chat history with intelligent  summarization.

3069. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 41
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

3070. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 41
...
3071. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 41
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

3072. **[arifOS](https://github.com/ariffazil/arifOS)** - ⭐ 41
   ArifOS — Constitutional MCP kernel for governed AI execution. AAA architecture: Architect · Auditor · Agent. Built for the open-source agentic era.

3073. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 41
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

3074. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 41
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

3075. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 41
   Learn Model Context Protocol with Python, published by Packt

3076. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 41
   A Model Context Protocol server that provides access to Shodan API functionality

3077. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 41
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

3078. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 41
...
3079. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 41
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

3080. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 41
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

3081. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 41
...
3082. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 41
   ElysiaJS plugin for Model Context Protocol with HTTP transport

3083. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 41
...
3084. **[zapier-mcp](https://github.com/zapier/zapier-mcp)** - ⭐ 41
   Connect your AI to thousands of apps with the Model Context Protocol.

3085. **[agent-trace](https://github.com/Siddhant-K-code/agent-trace)** - ⭐ 41
...
3086. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 41
...
3087. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 41
...
3088. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 40
...
3089. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 40
   a mcp server for polymarket

3090. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

3091. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

3092. **[just-mcp](https://github.com/toolprint/just-mcp)** - ⭐ 40
   Share the same project justfile tasks with your AI Coding Agent.

3093. **[scraps](https://github.com/boykush/scraps)** - ⭐ 40
   Scraps is a portable CLI knowledge hub for managing interconnected Markdown documentation with Wiki-link notation.

3094. **[mcp-panther](https://github.com/panther-labs/mcp-panther)** - ⭐ 40
   Write detections, investigate alerts, and query logs from your favorite AI agents

3095. **[forgejo-mcp](https://github.com/raohwork/forgejo-mcp)** - ⭐ 40
   A MCP server that enables you to manage Gitea/Forgejo repositories through AI assistants

3096. **[pdf-rag-mcp-server](https://github.com/hyson666/pdf-rag-mcp-server)** - ⭐ 40
   PDF RAG server for cursor.

3097. **[bonnard-cli](https://github.com/meal-inc/bonnard-cli)** - ⭐ 40
   Agent-native analytics. MCP server, dashboards, SDK, and semantic layer CLI.

3098. **[apple-books-mcp](https://github.com/vgnshiyer/apple-books-mcp)** - ⭐ 40
   Apple Books MCP Server

3099. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 40
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

3100. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 40
   It shows how to use model-context-protocol. 

3101. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 40
...
3102. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 40
...
3103. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 40
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

3104. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 40
...
3105. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 40
   An MCP server for querying Solana transactions using natural language with Solscan API

3106. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 40
...
3107. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 40
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

3108. **[rustchain-mcp](https://github.com/Scottcjn/rustchain-mcp)** - ⭐ 40
...
3109. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 40
   http4k MCP Desktop Client

3110. **[mcp-tools](https://github.com/clerk/mcp-tools)** - ⭐ 40
   Tools for building modern & secure MCP integrations across the client and server side

3111. **[RedTeam-Agent](https://github.com/ktol1/RedTeam-Agent)** - ⭐ 40
...
3112. **[pyrestoolbox-mcp](https://github.com/gabrielserrao/pyrestoolbox-mcp)** - ⭐ 40
...
3113. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 40
...
3114. **[SpecialAgentPlugin](https://github.com/ArtisanGameworks/SpecialAgentPlugin)** - ⭐ 40
...
3115. **[xero-agent-toolkit](https://github.com/XeroAPI/xero-agent-toolkit)** - ⭐ 40
...
3116. **[MCPbundler](https://github.com/eugenepyvovarov/MCPbundler)** - ⭐ 40

3117. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 40
...
3118. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 40
...
3119. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 39
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

3120. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 39
   MCP server for anki

3121. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 39
   A simple NextJS MCP client with sensible keybindings

3122. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

3123. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

3124. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

3125. **[vscode-agent-todos](https://github.com/digitarald/vscode-agent-todos)** - ⭐ 39
   Gives VS Code agent mode planning superpowers with dynamic todo lists

3126. **[pbixray-mcp-server](https://github.com/jonaolden/pbixray-mcp-server)** - ⭐ 39
...
3127. **[search-scrape](https://github.com/DevsHero/search-scrape)** - ⭐ 39
...
3128. **[steampipe-mcp](https://github.com/turbot/steampipe-mcp)** - ⭐ 39
   Enable AI assistants to explore and query your Steampipe data!

3129. **[storybook-mcp](https://github.com/mcpland/storybook-mcp)** - ⭐ 39
   A MCP server for Storybook.

3130. **[best-of-mcp-servers](https://github.com/tolkonepiu/best-of-mcp-servers)** - ⭐ 39
   🏆  A ranked list of MCP servers. Updated weekly.

3131. **[arifosmcp](https://github.com/ariffazil/arifosmcp)** - ⭐ 39
   ArifOS — AAA MCP-governed constitutional kernel for AI agents.

3132. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

3133. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 39
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

3134. **[mcp-server](https://github.com/Aayush9029/mcp-server)** - ⭐ 39
   MCP SERVER

3135. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 39
   Model Context Protocol Minecraft Server

3136. **[roampal-core](https://github.com/roampal-ai/roampal-core)** - ⭐ 39
...
3140. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 39
...
3141. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 39
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

3142. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 39
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

3143. **[mitre-attack-mcp](https://github.com/stoyky/mitre-attack-mcp)** - ⭐ 39
   A Model-Context Protocol server for the MITRE ATT&CK knowledge base

3144. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 39
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

3145. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 39
...
3146. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 39
   Zillow MCP Server for real estate data access via the Model Context Protocol

3147. **[CE-MCP-Plugin](https://github.com/Eruditi/CE-MCP-Plugin)** - ⭐ 39
...
3148. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 38
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

3149. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 38
   A Chat Client for LLMs, written in Compose Multiplatform.

3150. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 38
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

3151. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 38
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

3152. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 38
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

3153. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 38
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

3154. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 38
   A package manager to manage all your mcp servers across platforms

3155. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 38
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

3156. **[prompt-decorators](https://github.com/synaptiai/prompt-decorators)** - ⭐ 38
...
3157. **[vancouver](https://github.com/jameslong/vancouver)** - ⭐ 38
   Simple MCP server library for Elixir.

3158. **[cdk_pywrapper](https://github.com/sebotic/cdk_pywrapper)** - ⭐ 38
   A Python wrapper for the Chemistry Development Kit (CDK)

3159. **[mocxykit](https://github.com/shunseven/mocxykit)** - ⭐ 38
...
3160. **[comfy-mcp-server](https://github.com/lalanikarim/comfy-mcp-server)** - ⭐ 38
   A server using FastMCP framework to generate images based on prompts via a remote Comfy server.

3161. **[kitwork](https://github.com/kitwork/kitwork)** - ⭐ 38
...
3162. **[nostr-mcp](https://github.com/AbdelStark/nostr-mcp)** - ⭐ 38
   A Nostr MCP server that allows to interact with Nostr, enabling posting notes, and more.

3163. **[octomind](https://github.com/Muvon/octomind)** - ⭐ 38
   Highly configurable autonomous efficient-first agentic AI framework for CLI

3164. **[context-awesome](https://github.com/bh-rat/context-awesome)** - ⭐ 38
   awesome-lists now available as MCP server for you agent.

3165. **[Web-Algebra](https://github.com/AtomGraph/Web-Algebra)** - ⭐ 38
   Suite of generic Linked Data/SPARQL as well as LinkedDataHub-specific MCP tools

3166. **[MCP-Microsoft-Office](https://github.com/Aanerud/MCP-Microsoft-Office)** - ⭐ 38
   an local MCP server you can run on your env, connecting you to Microsoft Graph, and the complete M365 eco system.

3167. **[mcp-appstore](https://github.com/appreply-co/mcp-appstore)** - ⭐ 38
...
3168. **[nestjs-starter](https://github.com/hmake98/nestjs-starter)** - ⭐ 38
...
3169. **[shadcn-svelte-mcp](https://github.com/Michael-Obele/shadcn-svelte-mcp)** - ⭐ 38
   Mastra MCP server and tooling for the shadcn-svelte component docs and developer utilities.

3170. **[FastAPI-BitNet](https://github.com/grctest/FastAPI-BitNet)** - ⭐ 38
   Running Microsoft's BitNet inference framework via FastAPI, Uvicorn and Docker.

3171. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 38
   Model Context Protocol server to let LLMs write and execute matlab scripts 

3172. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 38
...
3173. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 38
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

3174. **[trainingpeaks-mcp](https://github.com/JamsusMaximus/trainingpeaks-mcp)** - ⭐ 38
...
3175. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 38
...
3176. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 38
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

3177. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 38
...
3178. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 38
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

3179. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 38
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

3180. **[OpenInsider-MCP](https://github.com/btopn/OpenInsider-MCP)** - ⭐ 38
   MCP server that exposes openinsider.com to any MCP compatible client.

3181. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 38
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

3182. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 38
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

3183. **[protonmail-mcp](https://github.com/amotivv/protonmail-mcp)** - ⭐ 38
   This MCP server provides email sending functionality using Protonmail's SMTP service. It allows both Claude Desktop and Cline VSCode extension to send emails on your behalf using your Protonmail credentials.

3184. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 38
   Build Model Context Protocol (MCP) servers in Go

3185. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 38
   Model Context Protocol (MCP) server that interacts with a Debugger

3186. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 38
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

3187. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 38
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

3188. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 38
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

3189. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 38
...
3190. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 38
   List of Awesome MCP Servers and Clients for building Agentic Devops 

3191. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 38
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

3192. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 38
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

3193. **[screaming-frog-mcp](https://github.com/bzsasson/screaming-frog-mcp)** - ⭐ 38
...
3194. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 38
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

3195. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 37
...
3196. **[trivy-mcp](https://github.com/aquasecurity/trivy-mcp)** - ⭐ 37
   Trivy plugin for starting an MCP server

3197. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

3198. **[mcp-server-webcrawl](https://github.com/pragmar/mcp-server-webcrawl)** - ⭐ 37
   MCP server tailored to connecting web crawler data and archives

3199. **[gemini-superclaude-mcp-server](https://github.com/Dianel555/gemini-superclaude-mcp-server)** - ⭐ 37
...
3200. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

3201. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

3202. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

3203. **[GDB-MCP](https://github.com/smadi0x86/GDB-MCP)** - ⭐ 37
   An MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

3204. **[agentic-commerce-protocol-demo](https://github.com/locus-technologies/agentic-commerce-protocol-demo)** - ⭐ 37
   Reference implementation of OpenAI's Agentic Commerce Protocol (ACP)

3205. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 37
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

3206. **[google-workspace-mcp](https://github.com/dguido/google-workspace-mcp)** - ⭐ 37
   MCP server for Google Drive, Docs, Sheets, Slides, Calendar, Gmail, and Contacts

3207. **[tasker-mcp](https://github.com/dceluis/tasker-mcp)** - ⭐ 37
   An MCP server for Android's Tasker automation app.

3208. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 37
   A simple note-taking MCP server for recording and managing notes with AI models.

3209. **[godot-mcp](https://github.com/HaD0Yun/godot-mcp)** - ⭐ 37
   GoPeak — The most comprehensive MCP server for Godot Engine. 95+ tools: scene management, GDScript LSP, DAP debugger, screenshot capture, input injection, ClassDB introspection, CC0 asset library. npx gopeak

3210. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 37
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

3211. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 37
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

3212. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 37
   Demonstrate how to implement MCP Client in Flutter application with AI.

3213. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 37
   a lib to build MCP clients and MCP servers in Clojure(script)

3214. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 37
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

3215. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 37
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

3216. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 37
...
3217. **[vulnerablemcp](https://github.com/vineethsai/vulnerablemcp)** - ⭐ 37
   A comprehensive database of Model Context Protocol vulnerabilities, security research, and exploits

3218. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 37
   Model Context Protocol (MCP) Server for Mistral OCR API

3219. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 37
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

3220. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 37
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

3221. **[datawrapper-mcp](https://github.com/palewire/datawrapper-mcp)** - ⭐ 37
   A Model Context Protocol (MCP) server and app for creating Datawrapper charts using AI assistants.

3222. **[mcp-dblp](https://github.com/szeider/mcp-dblp)** - ⭐ 37
...
3223. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 37
...
3224. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 37
   Model Context Protocol (MCP) server for openBIM

3225. **[claude-image-gen](https://github.com/guinacio/claude-image-gen)** - ⭐ 37
...
3226. **[inkmcp](https://github.com/Shriinivas/inkmcp)** - ⭐ 37
   Inkscape MCP Server - Control Inkscape through AI assistants via Model Context Protocol

3227. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 37
   A Model Context Protocol for checking domain name registration status in bulk.

3228. **[SSH-MCP](https://github.com/mixelpixx/SSH-MCP)** - ⭐ 37
...
3229. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 37
...
3230. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

3231. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

3232. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
3233. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

3234. **[mcp-server-antv](https://github.com/antvis/mcp-server-antv)** - ⭐ 36
...
3235. **[mcp-crew-ai](https://github.com/adam-paterson/mcp-crew-ai)** - ⭐ 36
   MCP Crew AI Server is a lightweight Python-based server designed to run, manage and create CrewAI workflows.

3236. **[Handler](https://github.com/alDuncanson/Handler)** - ⭐ 36
   A2A Protocol client and developer toolkit.

3237. **[ai-workshop](https://github.com/dotnet-presentations/ai-workshop)** - ⭐ 36
   Building GenAI Apps in C#: AI Templates, GitHub Models, Azure OpenAI & More

3238. **[mcp-sandbox](https://github.com/JohanLi233/mcp-sandbox)** - ⭐ 36
   Python sandboxes for llms

3239. **[awesome-mcp-personas](https://github.com/toolprint/awesome-mcp-personas)** - ⭐ 36
   A curated collection of persona-based mcp server & tool groupings.

3240. **[mcp-server](https://github.com/VapiAI/mcp-server)** - ⭐ 36
   Vapi MCP Server

3241. **[workflowy](https://github.com/mholzen/workflowy)** - ⭐ 36
   Powerful CLI and MCP server for WorkFlowy: reports, search/replace, backup support, and AI integration (Claude, LLMs)

3242. **[pfsense-mcp-server](https://github.com/gensecaihq/pfsense-mcp-server)** - ⭐ 36
   pfSense MCP Server enables security administrators to manage their pfSense firewalls using natural language through AI assistants like Claude Desktop. Simply ask "Show me blocked IPs" or "Run a PCI compliance check" instead of navigating complex interfaces. Supports REST/XML-RPC/SSH connections, and includes built-in complian

3243. **[apple-mail-mcp](https://github.com/patrickfreyer/apple-mail-mcp)** - ⭐ 36
   MCP server giving AI assistants full access to Apple Mail - read, search, compose, organize & analyze emails via natural language

3244. **[copilot-security-instructions](https://github.com/Robotti-io/copilot-security-instructions)** - ⭐ 36
...
3245. **[ronykit](https://github.com/clubpay/ronykit)** - ⭐ 36
   API Framework supporting REST and RPC.

3246. **[agience-core](https://github.com/Agience/agience-core)** - ⭐ 36
   An open, extensible runtime for agentic AI. Shared artifacts, structured state, and provenance by default.

3247. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

3248. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 36
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

3249. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 36
   A super simple Starter to build your own MCP Server

3250. **[kimi-code-mcp](https://github.com/howardpen9/kimi-code-mcp)** - ⭐ 36
...
3251. **[ckan-mcp-server](https://github.com/ondata/ckan-mcp-server)** - ⭐ 36
   MCP server for querying CKAN open data portals (package search, DataStore SQL, organizations, groups, tags)

3252. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 36
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

3253. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 36
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

3254. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 36
...
3255. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 36
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

3256. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 36
   esa の Model Context Protocol サーバー実装

3257. **[browser-use-rs](https://github.com/BB-fat/browser-use-rs)** - ⭐ 36
...
3258. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 36
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

3259. **[levante](https://github.com/levante-hub/levante)** - ⭐ 36
   Levante - Personal, Secure, Free, Local AI, MCP Client

3260. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 36
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

3261. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 36
...
3266. **[mTarsier](https://github.com/mcp360/mTarsier)** - ⭐ 36
   mTarsier - The Open Source MCP & Skill Manager for Claude, Cursor, VS Code & any AI client.

3267. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 35
   OpenAI Code Assistant Model Context Protocol (MCP) Server

3268. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 35
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

3269. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

3270. **[mcp-tung-shing](https://github.com/baranwang/mcp-tung-shing)** - ⭐ 35
   中国传统黄历 MCP 服务 | Chinese Traditional Almanac MCP Service

3271. **[mcp](https://github.com/screenshotone/mcp)** - ⭐ 35
   A simple implementation of an MCP server for the ScreenshotOne API

3272. **[atlas-docs-mcp](https://github.com/CartographAI/atlas-docs-mcp)** - ⭐ 35
   Provide LLMs hosted, clean markdown documentation of libraries and frameworks

3273. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 35
   An open source implementation of the Claude built-in text editor tool

3274. **[daisyui-mcp](https://github.com/birdseyevue/daisyui-mcp)** - ⭐ 35
   🌼 A token-friendly local MCP server for DaisyUI component documentation using their public llms.txt.

3275. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 35
   Turn any MCP Client into a "multi-agent" system (via prompting)

3276. **[awesome-mcp-servers](https://github.com/ever-works/awesome-mcp-servers)** - ⭐ 35
   A curated list of the best MCP Servers, featuring top solutions, libraries, tools, and more. - https://mcpserver.works

3277. **[Blender-MCP-Server](https://github.com/poly-mcp/Blender-MCP-Server)** - ⭐ 35
...
3278. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 35
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

3279. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 35
...
3280. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 35
   About A Model Context Protocol server that executes commands in the current WezTerm session

3281. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 35
   Model Context Protocol extension for Azure Functions.

3282. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 35
...
3283. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 35
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

3284. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

3285. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 35
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

3286. **[godoc-mcp-server](https://github.com/yikakia/godoc-mcp-server)** - ⭐ 35
   A mcp server provide infomation from pkg.go.dev. For all golang programmers

3287. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 35
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

3288. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 35
   Awesome list of MCP servers for interacting with hardware and the physical world.

3289. **[onec-client-mcp-devkit](https://github.com/1c-neurofish/onec-client-mcp-devkit)** - ⭐ 35
   Реализация MCP сервера, который запускается в клиенте 1С:Предприятие

3290. **[mcp_xpp](https://github.com/ccampora/mcp_xpp)** - ⭐ 35
...
3291. **[predictive-maintenance-mcp](https://github.com/LGDiMaggio/predictive-maintenance-mcp)** - ⭐ 35
...
3296. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

3297. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

3298. **[DBJavaGenix](https://github.com/ZhaoXingPeng/DBJavaGenix)** - ⭐ 34
...
3299. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 34
...
3300. **[chessagineweb](https://github.com/jalpp/chessagineweb)** - ⭐ 34
   The most underrated FOSS chess interface that combines AI agents and chess engines into one unified platform. 

3301. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 34
...
3302. **[codelogic-mcp-server](https://github.com/CodeLogicIncEngineering/codelogic-mcp-server)** - ⭐ 34
   An MCP Server to utilize Codelogic's rich software dependency data in your AI programming assistant.

3303. **[any-script-mcp](https://github.com/izumin5210/any-script-mcp)** - ⭐ 34
   An MCP server that exposes arbitrary CLI tools and shell scripts as MCP Tools

3304. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 34
   Model Context Protocol server written in Scala

3305. **[iotdb-mcp-server](https://github.com/apache/iotdb-mcp-server)** - ⭐ 34
   Apache IoTDB MCP Server

3306. **[1mcp](https://github.com/buremba/1mcp)** - ⭐ 34
   Let your agent write code and execute code directly in the browser with WASM

3307. **[kanban-mcp](https://github.com/eyalzh/kanban-mcp)** - ⭐ 34
   MCP server providing kanban-based task management memory for complex multi-session workflows with AI agents

3308. **[diy-tools-mcp](https://github.com/hesreallyhim/diy-tools-mcp)** - ⭐ 34
   An MCP server that allows users to dynamically add custom tools/functions at runtime

3309. **[pushover-mcp](https://github.com/AshikNesin/pushover-mcp)** - ⭐ 34
   A MCP implementation for sending notifications via Pushover

3310. **[capacities-mcp](https://github.com/jem-computer/capacities-mcp)** - ⭐ 34
   Capacities×MCP

3311. **[mcp-searxng-enhanced](https://github.com/OvertliDS/mcp-searxng-enhanced)** - ⭐ 34
   Enhanced MCP server for SearXNG: category-aware web-search, web-scraping, and date/time retrieval.

3312. **[mcp-probe-kit](https://github.com/mybolide/mcp-probe-kit)** - ⭐ 34
   一个强大的 MCP (Model Context Protocol) 服务器，提20个实用工具，覆盖代码质量、开发效率、项目管理、生成skills文档全流程。

3313. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 34
...
3314. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 34
...
3315. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 34
...
3316. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 34
...
3317. **[MCPServer](https://github.com/rhennigan/MCPServer)** - ⭐ 34
   Implements a model context protocol server using Wolfram Language

3318. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 34
   A generic mcp server fuzzer

3319. **[review-flow](https://github.com/DGouron/review-flow)** - ⭐ 34
...
3327. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

3328. **[laravel-mcp-companion](https://github.com/brianirish/laravel-mcp-companion)** - ⭐ 34
...
3329. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 34
...
3330. **[lucide-icons-mcp](https://github.com/SeeYangZhi/lucide-icons-mcp)** - ⭐ 34
...
3331. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 34
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

3332. **[turbomcpstudio](https://github.com/Epistates/turbomcpstudio)** - ⭐ 34
   A native desktop application for developing, testing, and debugging Model Context Protocol servers.

3333. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 34
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

3334. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 33
   MCP Server connects with claude code local command.

3335. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 33
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

3336. **[DMCPServer](https://github.com/Daniel09Fernandes/DMCPServer)** - ⭐ 33
   Dinos MCP Server, make your code, on MCP Action and execute by AI

3337. **[mcp-veo2](https://github.com/mario-andreschak/mcp-veo2)** - ⭐ 33
   MCP for Video- or Image-Generation with Google VEO2

3338. **[kaggle-mcp](https://github.com/arrismo/kaggle-mcp)** - ⭐ 33
   MCP server for Kaggle

3339. **[mcp-launcher](https://github.com/moeru-ai/mcp-launcher)** - ⭐ 33
   🐳🧩 Easy to use MCP builder & launcher for all possible MCP servers, just like Ollama for models!

3340. **[mcp-server](https://github.com/membranehq/mcp-server)** - ⭐ 33
   MCP Server for Membrane

3341. **[devduck](https://github.com/cagataycali/devduck)** - ⭐ 33
   Minimalist AI agent that fixes itself when things break.

3342. **[fastmcp-threatintel](https://github.com/4R9UN/fastmcp-threatintel)** - ⭐ 33
   AI-Powered Threat Intelligence MCP tool

3343. **[bitrise-mcp](https://github.com/bitrise-io/bitrise-mcp)** - ⭐ 33
   MCP Server for the Bitrise API, enabling app management, build operations, artifact management and more.

3344. **[prediction-market-mcp](https://github.com/JamesANZ/prediction-market-mcp)** - ⭐ 33
   A simple MCP server that grabs prediction market data from polymarket, PredictIt, & Kalshi. 

3345. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 33
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

3346. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 33
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

3347. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 33
...
3348. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 33
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

3349. **[awesome-finance-mcp](https://github.com/BlockRunAI/awesome-finance-mcp)** - ⭐ 33
   A curated list of MCP servers for AI finance agents

3350. **[ue5-mcp-bridge](https://github.com/Natfii/ue5-mcp-bridge)** - ⭐ 33
   MCP server bridging AI assistants to Unreal Engine 5 editor

3351. **[apipost-mcp](https://github.com/jlcodes99/apipost-mcp)** - ⭐ 33
...
3352. **[mcp-gateway](https://github.com/openziti/mcp-gateway)** - ⭐ 33
...
3353. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 33
...
3354. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 33
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

3355. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 33
...
3356. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 33
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with OpenAI and 🌐 web browser control via Playwright.

3357. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 33
   Asterisk Model Context Protocol (MCP) server.

3358. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 33
   A Curated List of MCP Servers, Clients and Toolkits

3359. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 33
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

3360. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 33
...
3361. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 33
...
3362. **[tally-mcp-server](https://github.com/dhananjay1405/tally-mcp-server)** - ⭐ 33
...
3363. **[hass-mcp-server](https://github.com/ganhammar/hass-mcp-server)** - ⭐ 33
...
3364. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 33
...
3365. **[mcp-mesh](https://github.com/dhyansraj/mcp-mesh)** - ⭐ 33
...
3366. **[google-researcher-mcp](https://github.com/zoharbabin/google-researcher-mcp)** - ⭐ 33
...
3367. **[unplugin-devpilot](https://github.com/zcf0508/unplugin-devpilot)** - ⭐ 33
...
3368. **[meshy-ai-mcp-server](https://github.com/pasie15/meshy-ai-mcp-server)** - ⭐ 33
...
3369. **[rss-mcp](https://github.com/veithly/rss-mcp)** - ⭐ 33
...
3370. **[opencode-mcp](https://github.com/AlaeddineMessadi/opencode-mcp)** - ⭐ 33
...
3371. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 32
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

3372. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 32
...
3373. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

3374. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 32
...
3375. **[Direwolf](https://github.com/Framebuffers/Direwolf)** - ⭐ 32
   Distributed Data Processing Pipeline for MCP.

3376. **[imagegen-mcp](https://github.com/spartanz51/imagegen-mcp)** - ⭐ 32
   MCP server for OpenAI Image Generation & Editing — text-to-image, image-to-image (with mask), no extra plugins.

3377. **[ptt_mcp_server](https://github.com/PyPtt/ptt_mcp_server)** - ⭐ 32
   The best PTT MCP server

3378. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 32
...
3379. **[mcp-server](https://github.com/HuaweiCloudDeveloper/mcp-server)** - ⭐ 32
   Provide different cloud products  MCP Server tools to  help developers  manage cloud resources  with AI-agent

3380. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 32
   A Model Context Protocol server starter template

3381. **[mcp-java-sdk-examples](https://github.com/thought2code/mcp-java-sdk-examples)** - ⭐ 32
   A collection of MCP server examples developed by various Java SDKs

3382. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 32
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

3383. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 32
...
3384. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 32
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

3385. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 32
...
3390. **[orionbelt-semantic-layer](https://github.com/ralfbecher/orionbelt-semantic-layer)** - ⭐ 32
...
3391. **[dassian-adt](https://github.com/DassianInc/dassian-adt)** - ⭐ 32
...
3392. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 32
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

3393. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 32
   Model Context Protocol Server of Rod

3394. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 32
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

3395. **[douyin-mcp-server](https://github.com/lancelin111/douyin-mcp-server)** - ⭐ 32
   🎥 Douyin (TikTok China) MCP Server - Automated video upload service via Model Context Protocol for AI integration

3396. **[drafts-mcp-server](https://github.com/agiletortoise/drafts-mcp-server)** - ⭐ 32
   Model Context Protocol for Drafts

3397. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 32
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

3398. **[minimal-godot-mcp](https://github.com/ryanmazzolini/minimal-godot-mcp)** - ⭐ 32
   Lightweight MCP server bridging Godot LSP to MCP clients for GDScript validation

3399. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 32
   Query model running with Ollama from within Claude Desktop or other MCP clients

3400. **[mcp.zig](https://github.com/muhammad-fiaz/mcp.zig)** - ⭐ 32
   A Model Context Protocol (MCP) library for the Zig ecosystem.

3401. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 31
...
3402. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 31
...
3403. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
3404. **[myBrAIn](https://github.com/lilium360/myBrAIn)** - ⭐ 31
...
3405. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

3406. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 31
...
3407. **[jlcpcb-parts-mcp](https://github.com/nvsofts/jlcpcb-parts-mcp)** - ⭐ 31
   JLCPCB PCBA向けの、部品探しを補助するためのMCPサーバー

3408. **[unplugin-mcp](https://github.com/situ2001/unplugin-mcp)** - ⭐ 31
...
3409. **[ez-mcp](https://github.com/intellectronica/ez-mcp)** - ⭐ 31
   The easiest path to getting an MCP server going

3410. **[ESP32MCPServer](https://github.com/navado/ESP32MCPServer)** - ⭐ 31
   Allow AI models connect to ESP32 exposed interfaces. AI generated MCP server for ESP32. 

3411. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 31
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

3412. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

3413. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 31
   一個簡單易用的網頁工具，用於管理 GitHub Copilot Coding Agent 的 MCP (Model Context Protocol) 設定

3414. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 31
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

3415. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 31
   MCP (Model Context Protocol) server for biothings

3416. **[mcp-klever-vm](https://github.com/klever-io/mcp-klever-vm)** - ⭐ 31
   MCP server for Klever blockchain smart contract development

3417. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 31
   Convert source code to LLM ready knowledge base

3418. **[apifox-mcp](https://github.com/iwen-conf/apifox-mcp)** - ⭐ 31
   Apifox MCP 服务器 - 让 Claude 等 AI 助手通过自然语言管理你的 Apifox 项目，轻松创建、更新和审计 API 接口

3419. **[codingbuddy](https://github.com/JeremyDev87/codingbuddy)** - ⭐ 31
...
3420. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 31
   PowerPlatform Model Context Protocol server

3421. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 31
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

3422. **[mcp-marketplace](https://github.com/aiagenta2z/mcp-marketplace)** - ⭐ 31
   OpenSource MCP Marketplace | MCP Servers Tools Meta Dataset | Web API | Web Client Integration

3423. **[stitch-mcp-auto](https://github.com/GreenSheep01201/stitch-mcp-auto)** - ⭐ 31
   Automated installer for Stitch MCP - The easiest way to set up your Universal MCP server for Google Stitch.

3424. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 31
...
3425. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 31
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

3426. **[pubnub-mcp-server](https://github.com/pubnub/pubnub-mcp-server)** - ⭐ 31
   PubNub MCP Model Context Protocol Server for use in Cursor, Windsurf, Claude Desktop, Claude Code and OpenAI Codex and more!

3427. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 31
   A Model Context Protocol server for 3D Slicer integration

3428. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 31
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

3429. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 31
...
3430. **[listmonk-mcp](https://github.com/rhnvrm/listmonk-mcp)** - ⭐ 31
   MCP (Model Context Protocol) server for Listmonk newsletter management

3431. **[binance-mcp-server](https://github.com/ethancod1ng/binance-mcp-server)** - ⭐ 31
...
3437. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 31
   An implementation of Giphy integration with Model Context Protocol

3438. **[zscaler-mcp-server](https://github.com/zscaler/zscaler-mcp-server)** - ⭐ 31
...
3439. **[mcp-mail-server](https://github.com/yunfeizhu/mcp-mail-server)** - ⭐ 31
...
3440. **[mitmproxy-mcp](https://github.com/snapspecter/mitmproxy-mcp)** - ⭐ 31
...
3441. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 30
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

3442. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 30
   MCP (Model Context Protocol) Server for postgres Database

3443. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 30
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

3444. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 30
...
3450. **[airflow-mcp-server](https://github.com/abhishekbhakat/airflow-mcp-server)** - ⭐ 30
   MCP Server for Apache Airflow

3451. **[kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp)** - ⭐ 30
   A comprehensive Message Control Protocol (MCP) server for Kafka Schema Registry.

3452. **[itential-mcp](https://github.com/itential/itential-mcp)** - ⭐ 30
   🔌 Itential Platform MCP Server

3453. **[ros-mcp](https://github.com/Yutarop/ros-mcp)** - ⭐ 30
   MCP server for ROS to control robots via topics, services, and actions.

3454. **[chrome-extension-bridge-mcp](https://github.com/Oanakiaja/chrome-extension-bridge-mcp)** - ⭐ 30
   A chrome extension bridge that allows you to connect to a mcp server to use global window object.

3455. **[turbovault](https://github.com/Epistates/turbovault)** - ⭐ 30
   MCP server that transforms your Obsidian vault into an intelligent knowledge system

3456. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 30
   A simple Model Context Protocol (MCP) server for Clay.

3457. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 30
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

3458. **[mcp-loxone](https://github.com/avrabe/mcp-loxone)** - ⭐ 30
   An opinionated Model Context Protocol (MCP) server for controlling Loxone home automation systems.

3459. **[AI-Tracker](https://github.com/twwch/AI-Tracker)** - ⭐ 30
   本仓库旨在整理关于大语言模型（LLM）底层逻辑、**上下文工程 (Context Engineering)** 以及 **Model Context Protocol (MCP)** 协议的核心学习资源与实战路径。

3460. **[dockashell](https://github.com/anzax/dockashell)** - ⭐ 30
...
3461. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 30
   ESPN Fantasy API with LLMs!

3462. **[kratos-mcp](https://github.com/ceorkm/kratos-mcp)** - ⭐ 30
...
3467. **[aura](https://github.com/mezmo/aura)** - ⭐ 30
...
3468. **[OmniClip-RAG](https://github.com/msjsc001/OmniClip-RAG)** - ⭐ 30
...
3469. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 30
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

3470. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 30
   MCP (Model Context Protocol) server for Dumpling AI

3471. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 30
...
3472. **[mdk-mcp-server](https://github.com/SAP/mdk-mcp-server)** - ⭐ 30
   Model Context Protocol (MCP) server for AI-assisted development ("vibe coding") of MDK applications.

3473. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 30
   Fast rust MCP proxy between stdio and SSE

3474. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 30
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

3475. **[mcp](https://github.com/yandex-cloud/mcp)** - ⭐ 30
   Yandex Cloud MCP Servers

3476. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 30
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

3477. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 30
   Azure AI Foundry - Agents related sample code

3478. **[overleaf-mcp-server](https://github.com/YounesBensafia/overleaf-mcp-server)** - ⭐ 30
...
3479. **[MCP-Scorecard](https://github.com/aak204/MCP-Scorecard)** - ⭐ 29
   Deterministic CI scanner and surface-risk scoring for MCP (Model Context Protocol) servers.

3480. **[mcp-inception](https://github.com/tanevanwifferen/mcp-inception)** - ⭐ 29
   Call another MCP client from your MCP client. Offload context windows, delegate tasks, split between models

3481. **[demo-mcp-server-client-implementation](https://github.com/mschwarzmueller/demo-mcp-server-client-implementation)** - ⭐ 29
   A demo implementation of a MCP server (consuming a dummy API) and basic client.

3482. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

3483. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

3484. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

3485. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

3486. **[telegram-mcp-server](https://github.com/kfastov/telegram-mcp-server)** - ⭐ 29
   MCP server implementation for Telegram

3487. **[agent-pm](https://github.com/gannonh/agent-pm)** - ⭐ 29
   MCP server for the planning and execution of AI-assisted development projects.

3488. **[mcp-notify](https://github.com/aahl/mcp-notify)** - ⭐ 29
   💬  MCP Server for notify to Weixin, Telegram, Bark, Lark, 飞书, 钉钉

3489. **[rdkit-mcp-server](https://github.com/tandemai-inc/rdkit-mcp-server)** - ⭐ 29
   MCP server that enables language models to interact with RDKit through natural language

3490. **[robinhood-mcp-server](https://github.com/rohitsingh-iitd/robinhood-mcp-server)** - ⭐ 29
...
3491. **[alibabacloud-dms-mcp-server](https://github.com/aliyun/alibabacloud-dms-mcp-server)** - ⭐ 29
...
3492. **[tgcli](https://github.com/kfastov/tgcli)** - ⭐ 29
   Telegram user console client and archiver

3493. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 29
...
3494. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 29
...
3495. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 29
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

3496. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 29
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

3497. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 29
...
3498. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 29
...
3499. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 29
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

3500. **[izan.io](https://github.com/ekingunoncu/izan.io)** - ⭐ 29
   Turn Any Browser Action & Data Extraction into an AI Tool in 60 Seconds

3501. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 29
   Testing framework for Model Context Protocol (MCP)

3502. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 29
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

3503. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 29
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

3504. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 29
...
3505. **[drawio-mcp-extension](https://github.com/lgazo/drawio-mcp-extension)** - ⭐ 29
   Draw.io Model Context Protocol (MCP) Browser Extension

3506. **[emcp](https://github.com/PJUllrich/emcp)** - ⭐ 29
   A Model Context Protocol (MCP) Server for Elixir

3507. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 29
...
3508. **[autotask-mcp](https://github.com/wyre-technology/autotask-mcp)** - ⭐ 29
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3509. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 29
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

3510. **[Go-High-Level-MCP-2026-Complete](https://github.com/BusyBee3333/Go-High-Level-MCP-2026-Complete)** - ⭐ 29
...
3511. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 29
...
3512. **[claude-mcp-trello](https://github.com/hrs-asano/claude-mcp-trello)** - ⭐ 29
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

3513. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 29
   Antrophics Model context protocol to edit powerpoint files

3514. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 29
   a web logging proxy for MCP client-server communication

3515. **[engram-memory-community](https://github.com/EngramMemory/engram-memory-community)** - ⭐ 29
...
3516. **[DecisionNode](https://github.com/decisionnode/DecisionNode)** - ⭐ 29
...
3517. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 29
...
3518. **[NiFiMCP](https://github.com/ms82119/NiFiMCP)** - ⭐ 29
   An MCP Server and client for communicating with Nifi (v1.28)

3519. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 29
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

3520. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 29
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

3521. **[rootcause](https://github.com/yindia/rootcause)** - ⭐ 29
...
3522. **[coworker](https://github.com/Array-Ventures/coworker)** - ⭐ 29
...
3523. **[congressMCP](https://github.com/amurshak/congressMCP)** - ⭐ 29
   An MCP server allowing AI agents and MCP clients to interface with the Congress.gov API

3524. **[stata-workbench](https://github.com/tmonk/stata-workbench)** - ⭐ 29
...
3525. **[local-skills-mcp](https://github.com/kdpa-llc/local-skills-mcp)** - ⭐ 29
   Universal MCP server enabling any LLM or AI agent to utilize expert skills from your local filesystem. Reduces context consumption through lazy loading. Works with Claude, Cline, and any MCP-compatible client.

3526. **[Palmos](https://github.com/ClayPulse/Palmos)** - ⭐ 28
...
3531. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

3532. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

3533. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 28
...
3534. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 28
...
3535. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 28
...
3536. **[tempo-mcp-server](https://github.com/ivelin-web/tempo-mcp-server)** - ⭐ 28
   MCP server for managing Tempo worklogs in Jira

3537. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 28
...
3538. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 28
   Model Context Protocol to bridge in Substack writings to Claude.

3539. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 28
...
3540. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 28
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

3541. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 28
...
3542. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 28
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

3543. **[mcp-wireshark](https://github.com/khuynh22/mcp-wireshark)** - ⭐ 28
...
3544. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 28
...
3545. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 28
...
3546. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 28
...
3547. **[chat](https://github.com/repaera/chat)** - ⭐ 28
   Chat Client for Your Service's MCP Server

3548. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 28
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

3549. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 28
...
3550. **[computeruseprotocol](https://github.com/computeruseprotocol/computeruseprotocol)** - ⭐ 28
   Computer Use Protocol is a universal schema for AI agents to perceive and interact with any desktop UI.

3551. **[UCAI](https://github.com/nirholas/UCAI)** - ⭐ 28
...
3552. **[qdrant-mcp-server](https://github.com/mhalder/qdrant-mcp-server)** - ⭐ 28
   MCP server for semantic search using local Qdrant vector database and OpenAI embeddings

3553. **[Unity-AI-ParticleSystem](https://github.com/IvanMurzak/Unity-AI-ParticleSystem)** - ⭐ 28
   AI-powered tools for Unity Particle System. Create and modify Particle System directly through natural language commands.

3554. **[mcp-anything](https://github.com/Type-MCP/mcp-anything)** - ⭐ 28
   One command to turn any codebase into an MCP server

3555. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 28
   MCP to LangChain Tools Conversion Utility / Python

3556. **[raybridge](https://github.com/jlokos/raybridge)** - ⭐ 28
   MCP server that bridges Raycast extensions to any MCP-compatible client

3557. **[leanmcp-sdk](https://github.com/LeanMCP/leanmcp-sdk)** - ⭐ 28
   Production-ready TypeScript SDK for MCP servers: auth, multi-tenant, observability. Build enterprise AI agents fast.

3558. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 28
   The Runtime Where AI Agents Build, Ship, and Evolve. Pulse Editor is a modular, cross-platform, AI-powered productivity platform with federated app collaboration and extensible workflows. 

3559. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 28
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3560. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 28
   An MCP server and client for LLMs to interact with Unity Projects

3561. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 28
...
3562. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 27
...
3563. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

3564. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

3565. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

3566. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

3567. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

3568. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

3569. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

3570. **[mcp-local-dev](https://github.com/txbm/mcp-local-dev)** - ⭐ 27
   Let LLMs manage your local dev environments

3571. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 27
   Model Context Protocol Server for NebulaGraph 3.x

3572. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 27
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

3573. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

3574. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 27
...
3575. **[janee](https://github.com/rsdouglas/janee)** - ⭐ 27
   Secrets management for AI agents via MCP • @janeesecure

3576. **[openzeppelin-mcp](https://github.com/OpenZeppelin/openzeppelin-mcp)** - ⭐ 27
   Model Context Protocol Servers Repository for OpenZeppelin products

3577. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 27
   Educational repo for MCP streamable HTTP servers and clients

3578. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 27
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

3579. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

3580. **[novyx-mcp](https://github.com/novyxlabs/novyx-mcp)** - ⭐ 27
...
3581. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 27
...
3582. **[universal-crypto-mcp](https://github.com/nirholas/universal-crypto-mcp)** - ⭐ 27
...
3583. **[ChatSpatial](https://github.com/cafferychen777/ChatSpatial)** - ⭐ 27
...
3584. **[codex-claude-bridge](https://github.com/abhishekgahlot2/codex-claude-bridge)** - ⭐ 27
...
3585. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 27
   Simple MCP SDK in Java

3586. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 27
...
3587. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 27
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

3588. **[suse-ai-up](https://github.com/SUSE/suse-ai-up)** - ⭐ 27
...
3589. **[zotero-mcp-server](https://github.com/swairshah/zotero-mcp-server)** - ⭐ 27
   MCP server to expose local zotero repository to MCP clients 

3590. **[twincat-validator-mcp](https://github.com/agenticcontrolio/twincat-validator-mcp)** - ⭐ 27
...
3591. **[mcp-server-zotero-dev](https://github.com/introfini/mcp-server-zotero-dev)** - ⭐ 27
...
3592. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 26
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

3593. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 26
...
3594. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

3595. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

3596. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

3597. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 26
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

3598. **[mcp-auth](https://github.com/famma-ai/mcp-auth)** - ⭐ 26
   MCP Auth via Reverse Proxy 

3599. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server for GreptimeDB

3600. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 26
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

3601. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 26
   Model Context Protocol server for Github Repo // Reading Github Repo

3602. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 26
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

3603. **[mcp-desktop-automation](https://github.com/tanob/mcp-desktop-automation)** - ⭐ 26
   A Model Context Protocol server that provides desktop automation capabilities using RobotJS and screenshot capabilities

3604. **[markview](https://github.com/paulhkang94/markview)** - ⭐ 26
   Native macOS markdown preview + MCP server for Claude Code. Swift/SwiftUI, GFM, Mermaid, syntax highlighting. No Electron.

3605. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 26
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

3606. **[MCPHammer](https://github.com/praetorian-inc/MCPHammer)** - ⭐ 26
   MCP security testing framework for evaluating Model Context Protocol server vulnerabilities

3607. **[local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp)** - ⭐ 26
   Local FAISS vector store as an MCP server – Agent Memory, drop-in local semantic search for Claude / Copilot / Agents.

3608. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 26
   A Fastify plugin to run Model Context Protocol (MCP) servers

3609. **[ue5-mcp](https://github.com/mirno-ehf/ue5-mcp)** - ⭐ 26
   Let AI edit your Unreal Engine Blueprints. MCP server plugin for Claude Code — describe what you want in plain English.

3610. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 26
...
3611. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 26
...
3612. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 26
...
3613. **[Unreal-MCP](https://github.com/aadeshrao123/Unreal-MCP)** - ⭐ 26
...
3614. **[plux](https://github.com/milisp/plux)** - ⭐ 26
   💡AI finder/explorer. One click @files via a visual filetree and save insights in a notepad. build with Tauri

3615. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 26
   Contemplative reasoning MCP server — Lotus Sutra wisdom framework with interactive ext-apps journey visualization.

3616. **[mcp-server](https://github.com/Decodo/mcp-server)** - ⭐ 26
   The Decodo MCP server which enables MCP clients to interface with services.

3617. **[Risuai-NodeOnly](https://github.com/mrbart3885/Risuai-NodeOnly)** - ⭐ 26
   Make your own story. User-friendly software for LLM roleplaying, forked from Risuai

3618. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 26
   Model Context Protocol server for Rollbar

3619. **[webmcp-bridge](https://github.com/holon-run/webmcp-bridge)** - ⭐ 25
...
3620. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
3621. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

3622. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

3623. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

3624. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

3625. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

3626. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

3627. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

3628. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 25
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

3629. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 25
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

3630. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 25
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

3631. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 25
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

3632. **[json2video-mcp-server](https://github.com/omergocmen/json2video-mcp-server)** - ⭐ 25
   Message Communication Protocol server for json2video API integration

3633. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 25
   Simple MCP Client for remote MCP Servers 🌐

3634. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 25
   An MCP server enabling CFBD API queries within Claude Desktop.

3635. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 25
   MCP server wrapping around the Fabric Rest API

3636. **[azure-diagram-mcp](https://github.com/dminkovski/azure-diagram-mcp)** - ⭐ 25
...
3637. **[gemini-webapi-mcp](https://github.com/AndyShaman/gemini-webapi-mcp)** - ⭐ 25
   MCP server for Google Gemini — free image generation, editing & chat via browser cookies. No API keys needed.

3638. **[Screenhand](https://github.com/manushi4/Screenhand)** - ⭐ 25
...
3642. **[asc-mcp](https://github.com/zelentsov-dev/asc-mcp)** - ⭐ 25
...
3643. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

3644. **[MCP-OpenStack-Ops](https://github.com/call518/MCP-OpenStack-Ops)** - ⭐ 25
...
3645. **[MCP-DB-Client](https://github.com/DitriXNew/MCP-DB-Client)** - ⭐ 25
   MCP layer for 1C

3646. **[localwp-agent-tools](https://github.com/10up/localwp-agent-tools)** - ⭐ 25
...
3647. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 25
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API)

3648. **[atxp](https://github.com/atxp-dev/atxp)** - ⭐ 25
...
3649. **[askr](https://github.com/Sweatent/askr)** - ⭐ 25
   MCP Q&A Assistant - Async Q&A capabilities for AI clients via MCP protocol

3650. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 24
   Memory Cache Server for use with supported MCP API Clients.

3651. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 24
...
3652. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 24
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

3653. **[GenomeMCP](https://github.com/Eldergenix/GenomeMCP)** - ⭐ 24
...
3654. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

3655. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
3656. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
3657. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3658. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
3659. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

3660. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
3661. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

3662. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

3663. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
3664. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
3665. **[k6-mcp-server](https://github.com/QAInsights/k6-mcp-server)** - ⭐ 24
   k6 MCP server

3666. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 24
   Official BlazeMeter MCP Server for AI-driven performance testing

3667. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 24
   CLI that uses DSPy to interact with MCP servers.

3668. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 24
   An MCP server for logging activity in Roo Code/Cline.

3669. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 24
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

3670. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 24
   Model Context Protocol server for querying Cursor chat history

3671. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 24
   Model Context Protocol SDK implemented in Lua for OpenResty

3672. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 24
...
3673. **[Claude-Code-MCP-Manager](https://github.com/qdhenry/Claude-Code-MCP-Manager)** - ⭐ 24
    A comprehensive tool to manage Model Context Protocol (MCP) configurations for Claude code

3674. **[metmuseum-mcp](https://github.com/mikechao/metmuseum-mcp)** - ⭐ 24
   Met Museum MCP integration to discover the art collection at The Metropolitan Museum of Art in New York

3675. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 24
...
3676. **[agentgate](https://github.com/agentkitai/agentgate)** - ⭐ 24
   Approval workflows for AI agents

3677. **[WikidataMCP](https://github.com/philippesaade-wmde/WikidataMCP)** - ⭐ 24
   Model Context Protocol for Wikidata

3678. **[WikidataMCP](https://github.com/wmde/WikidataMCP)** - ⭐ 24
   Model Context Protocol for Wikidata

3679. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 24
   CLI for calling successive MCP Server tools

3680. **[Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine](https://github.com/cortexaiofficial/Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine)** - ⭐ 24
...
3681. **[Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine](https://github.com/Cortex-AI-Software/Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine)** - ⭐ 24
   🧠 Autonomous AI Trading Agent & Multi-Chain Flash-Arb Engine (v2.0 Beta). Powered by MCP-Protocol & LLM reasoning. High-frequency arbitrage on Solana, Base, and EVM L2s. Built by Cortex Software Labs.

3682. **[codemesh](https://github.com/kiliman/codemesh)** - ⭐ 24
   The Self-Improving MCP Server - Agents write code to orchestrate multiple MCP servers with intelligent TypeScript execution and auto-augmentation

3683. **[mcp-rss-aggregator](https://github.com/imprvhub/mcp-rss-aggregator)** - ⭐ 24
   Model Context Protocol Server for aggregating RSS feeds in Claude Desktop

3684. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 24
   Tanzu Platform Chat

3685. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 24
...
3686. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 24
   MCP server and client for running Linux commands

3687. **[MCP-Mastery-with-Claude-and-Langchain](https://github.com/laxmimerit/MCP-Mastery-with-Claude-and-Langchain)** - ⭐ 24
   Build MCP servers & clients with Python, Streamlit, ChromaDB, LangChain, LangGraph agents, and Ollama integrations

3688. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 24
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

3689. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 23
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

3690. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 23
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

3691. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 23
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

3692. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

3693. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

3694. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
3695. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

3696. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
3697. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
3698. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

3699. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

3700. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

3701. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 23
   A MCP(Model Context Protocol) server that accesses to Lightdash

3702. **[balldontlie-mcp](https://github.com/mikechao/balldontlie-mcp)** - ⭐ 23
   An MCP Server implementation that integrates the Balldontlie API, to provide information about players, teams and games for the NBA, NFL and MLB

3703. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 23
   An MCP client for slack in Typescript

3704. **[autotask-mcp](https://github.com/asachs01/autotask-mcp)** - ⭐ 23
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3705. **[nix-mcp-servers](https://github.com/ismail-kattakath/nix-mcp-servers)** - ⭐ 23
   A nix flake for configuring Model Context Protocol (MCP) servers across supported AI assistant clients

3706. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 23
...
3707. **[agent-studio-starter](https://github.com/nsphung/agent-studio-starter)** - ⭐ 23
   Stop building AI agents from scratch. Bootstrap starter Agent app with LangGraph, CopilotKit, and beautiful Generative UIs.

3708. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 23
   MCP to LangChain Tools Conversion Utility / TypeScript

3709. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 23
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

3710. **[mcp-web-scraper](https://github.com/Decodo/mcp-web-scraper)** - ⭐ 23
   The Decodo MCP server which enables MCP clients to interface with services.

3711. **[mcp-scan](https://github.com/rodolfboctor/mcp-scan)** - ⭐ 23
...
3712. **[awesome-agent-skills-mcp](https://github.com/shadowrootdev/awesome-agent-skills-mcp)** - ⭐ 23
...
3713. **[manceps](https://github.com/zarpay/manceps)** - ⭐ 23
   Ruby client for the Model Context Protocol (MCP). Latin: one who takes in hand.

3714. **[room-mcp](https://github.com/agree-able/room-mcp)** - ⭐ 23
   Allow MCP clients like claude-desktop to use rooms to coordinate with other agents

3715. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 23

3716. **[flutter-ai-labs](https://github.com/theshivamlko/flutter-ai-labs)** - ⭐ 23
   A curated collection of LLM-powered Flutter apps built using RAG, AI Agents, Multi-Agent Systems, MCP, and Voice Agents.

3717. **[your-money-left-the-chat](https://github.com/Rayato159/your-money-left-the-chat)** - ⭐ 23
   A Rust + MCP powered financial tracker that knows exactly where your money ghosted you.

3718. **[aws-s3-mcp](https://github.com/samuraikun/aws-s3-mcp)** - ⭐ 23
   MCP server to integrate AWS S3 and LLM

3719. **[GUI-MCP](https://github.com/PhialsBasement/GUI-MCP)** - ⭐ 23
...
3720. **[bruno-mcp](https://github.com/macarthy/bruno-mcp)** - ⭐ 23
...
3721. **[emilie](https://github.com/veronica-builds/emilie)** - ⭐ 23
...
3722. **[zebbern-kali-mcp](https://github.com/zebbern/zebbern-kali-mcp)** - ⭐ 23
...
3723. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 22
...
3735. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
3736. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

3737. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

3738. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

3739. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 22
   Rust MCP framework for building AI agents

3740. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 22
   A collection of mcp servers/client/sdks

3741. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 22
...
3742. **[mcp-knowledge-base](https://github.com/hjlee94/mcp-knowledge-base)** - ⭐ 22
   MCP agent/client/server implementation for private knowledge base

3743. **[mcp-observer-server](https://github.com/hesreallyhim/mcp-observer-server)** - ⭐ 22
   An MCP server that provides server-to-client notifications for file changes that the client subscribes to

3744. **[Zammad-MCP](https://github.com/basher83/Zammad-MCP)** - ⭐ 22
...
3745. **[teamcity-mcp](https://github.com/Daghis/teamcity-mcp)** - ⭐ 22
...
3746. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 22
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

3747. **[perplexity-mcp-server](https://github.com/cyanheads/perplexity-mcp-server)** - ⭐ 22
...
3748. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 22
...
3749. **[IoT-Edge-MCP-Server](https://github.com/poly-mcp/IoT-Edge-MCP-Server)** - ⭐ 22
...
3750. **[spectrawl](https://github.com/Pyx-Corp/spectrawl)** - ⭐ 22
...
3751. **[mcp-superset](https://github.com/bintocher/mcp-superset)** - ⭐ 22
   MCP server for managing Apache Superset — 128+ tools for dashboards, charts, datasets, SQL Lab, access control

3752. **[Jiva](https://github.com/KarmaloopAI/Jiva)** - ⭐ 22
...
3753. **[slack-mcp-server](https://github.com/jtalk22/slack-mcp-server)** - ⭐ 22
   Session-based Slack MCP for Claude and MCP clients: local-first workflows, secure-default HTTP.

3754. **[csv-editor](https://github.com/santoshray02/csv-editor)** - ⭐ 22
...
3755. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 22
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

3756. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 22
...
3757. **[gumroad-mcp](https://github.com/rmarescu/gumroad-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation for Gumroad API

3758. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 22
...
3759. **[mcp-server](https://github.com/paperinvest/mcp-server)** - ⭐ 21
   Official MCP server for Paper's trading platform - enables AI assistants to interact with Paper's API

3760. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 21
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

3761. **[pixelpanda-mcp](https://github.com/RyanKramer/pixelpanda-mcp)** - ⭐ 21
   MCP server for PixelPanda — 31 AI image processing tools for Claude Desktop, Cursor & other MCP clients

3762. **[ffmpeg-mcp-lite](https://github.com/kevinwatt/ffmpeg-mcp-lite)** - ⭐ 21
   MCP server for video/audio processing via FFmpeg - convert, compress, trim, extract audio, add subtitles

3763. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 21
   Supabase MCP client react app with Tambo

3764. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 21
...
3765. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 21
   Let the grumpy senior dev review your code with this MCP server

3766. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
3767. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

3768. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

3769. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

3770. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

3771. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

3772. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

3773. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
3774. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) server for providing code context from git repositories

3775. **[mcp-deepseek-demo](https://github.com/Ulanxx/mcp-deepseek-demo)** - ⭐ 21
   deepseek 结合 mcp 场景，最小用例，包括 client and server

3776. **[hs-mcp](https://github.com/buecking/hs-mcp)** - ⭐ 21
   Haskell server/client for MCP (Model Context Protocol)

3777. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 21
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

3778. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 21
...
3779. **[heuristic-mcp](https://github.com/softerist/heuristic-mcp)** - ⭐ 21
...
3780. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 21
...
3781. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 21
...
3782. **[codex-mcp-tool](https://github.com/x51xxx/codex-mcp-tool)** - ⭐ 21

3783. **[mcp-diagnostics-extension](https://github.com/newbpydev/mcp-diagnostics-extension)** - ⭐ 21
   VS Code extension that exposes diagnostic problems via Model Context Protocol (MCP) for AI agents and tools

3784. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 21
   The BioContextAI Registry for biomedical MCP servers

3785. **[archmcp](https://github.com/dejo1307/archmcp)** - ⭐ 21
   archmcp - MCP Architectural Snapshot Server and Knowledge Graph

3786. **[agentidentityprotocol](https://github.com/openagentidentityprotocol/agentidentityprotocol)** - ⭐ 21
...
3790. **[knowledgebase-mcp](https://github.com/biocontext-ai/knowledgebase-mcp)** - ⭐ 21
   BioContextAI Knowledgebase MCP server for biomedical agentic AI 

3791. **[mcp-kling](https://github.com/199-mcp/mcp-kling)** - ⭐ 21
   🎬 The FIRST MCP server for Kling AI video generation! Generate stunning AI videos directly from Claude.

3792. **[skill-to-mcp](https://github.com/biocontext-ai/skill-to-mcp)** - ⭐ 21
   Convert AI Skills (Claude Skills format) to MCP server resources - Part of BioContextAI

3793. **[dsers-mcp-product](https://github.com/lofder/dsers-mcp-product)** - ⭐ 21
...
3794. **[agentic-tools](https://github.com/meta-quest/agentic-tools)** - ⭐ 21
   Agent Tool and Skills for VR Development on Meta Quest 

3795. **[ARBuilder](https://github.com/Quantum3-Labs/ARBuilder)** - ⭐ 21
   AI-powered code generator for Arbitrum Stylus, SDK bridging, dApps & Orbit chains — 19 MCP tools with RAG

3796. **[MicrosoftGraph_Transcript_MCP](https://github.com/ITSpecialist111/MicrosoftGraph_Transcript_MCP)** - ⭐ 21
...
3797. **[mcp_documents_reader](https://github.com/xt765/mcp_documents_reader)** - ⭐ 21
...
3798. **[swift-mcp](https://github.com/DePasqualeOrg/swift-mcp)** - ⭐ 21
   Full-featured Swift SDK for Model Context Protocol servers and clients

3799. **[muster](https://github.com/giantswarm/muster)** - ⭐ 21
   MCP tool management and workflow proxy

3800. **[mcp-file-operations-server](https://github.com/bsmi021/mcp-file-operations-server)** - ⭐ 21
   A Model Context Protocol (MCP) server that provides enhanced file operation capabilities with streaming, patching, and change tracking support.

3801. **[mcp](https://github.com/zuplo/mcp)** - ⭐ 21
   A fetch API based TypeScript SDK for MCP

3802. **[open-code-review](https://github.com/raye-deng/open-code-review)** - ⭐ 21
...
3803. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 21
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

3804. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 21
...
3805. **[Mobus](https://github.com/mobus-ai/Mobus)** - ⭐ 21
   Search, preview, and analyze datasets from 20+ platforms via a single MCP connector. Works with Claude instantly.

3806. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 20
...
3807. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
3815. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 20
   HasMCP Community Edition

3816. **[gh-mcp](https://github.com/shuymn/gh-mcp)** - ⭐ 20
...
3817. **[mcp-server-amazon](https://github.com/rigwild/mcp-server-amazon)** - ⭐ 20
   🛍📦 Unofficial Amazon Model Context Protocol Server (MCP) - Search products and purchase directly from Claude AI! ✨

3818. **[starbase](https://github.com/metorial/starbase)** - ⭐ 20
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

3819. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 20
   a Nushell cross.stream extension to interact with LLMs and MCP servers

3820. **[lyra-tool-discovery](https://github.com/nirholas/lyra-tool-discovery)** - ⭐ 20
...
3821. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 20

3822. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 20
   苹果 MCP 工具 ✅

3823. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 20
...
3824. **[llmqore](https://github.com/Palm1r/llmqore)** - ⭐ 20
   Qt C++ library for working with AI/LLM Providers and MCP

3825. **[emceepee](https://github.com/eastlondoner/emceepee)** - ⭐ 20
...
3826. **[strategy-mcp](https://github.com/sohaibt/strategy-mcp)** - ⭐ 20
...
3830. **[cdp-bridge-mcp](https://github.com/Unagi-cq/cdp-bridge-mcp)** - ⭐ 20
   MCP server that bridges clients to a real browser through CDP and a companion extension.

3831. **[mcp-yfinance](https://github.com/9nate-drake/mcp-yfinance)** - ⭐ 19
   MCP Server for fething yfinance financial data into Claude Desktop

3832. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 19
   A high performance MCP client sdk for python

3833. **[mcp](https://github.com/EmilLindfors/mcp)** - ⭐ 19
    A crate for making MCP (Model Context Protocol) compatible programs with rust

3834. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

3835. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 19
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

3836. **[openapi2mcptools](https://github.com/2013xile/openapi2mcptools)** - ⭐ 19
   OpenAPI specifications => MCP (Model Context Protocol) tools

3837. **[termlink](https://github.com/chu2bard/termlink)** - ⭐ 19
   MCP server for shell and terminal operations

3838. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 19
...
3839. **[short-url](https://github.com/fengzhongsen/short-url)** - ⭐ 19
   简单易用的短链接生成工具，完全开源、免费、无需登录，可私有化部署，链接永久有效！

3840. **[bonnard](https://github.com/bonnard-data/bonnard)** - ⭐ 19
...
3841. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 19
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

3842. **[spectrawl](https://github.com/FayAndXan/spectrawl)** - ⭐ 19
   The unified web layer for AI agents. Search (8 engines), stealth browse, auth, and act on 24 platforms. One npm install, self-hosted.

3843. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 19
...
3844. **[unified-gateway-mcp](https://github.com/mcp360/unified-gateway-mcp)** - ⭐ 19
   Unified MCP Gateway Platform, Marketplace & Custom MCPs

3845. **[subcog](https://github.com/zircote/subcog)** - ⭐ 19
...
3846. **[builtwith-api](https://github.com/zcaceres/builtwith-api)** - ⭐ 19
   TypeScript library, MCP, and agent-friendly CLI for the BuiltWith API.

3847. **[better-notion-mcp](https://github.com/n24q02m/better-notion-mcp)** - ⭐ 19
   Markdown-first MCP server for Notion API - composite tools optimized for AI agents

3848. **[mcp-anything](https://github.com/gabrielekarra/mcp-anything)** - ⭐ 19
   One command to turn any codebase into an MCP server

3849. **[nanobanana-mcp](https://github.com/YCSE/nanobanana-mcp)** - ⭐ 19
   Gemini Vision & Image Generation MCP for Claude Desktop and Claude Code

3850. **[awesome-mcp-security](https://github.com/AgentSeal/awesome-mcp-security)** - ⭐ 19
...
3851. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 19
...
3852. **[resonant](https://github.com/codependentai/resonant)** - ⭐ 19
...
3853. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 19
   MCP server to manage Spotify from MCP clients

3854. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 19
...
3855. **[brightspace-mcp-server](https://github.com/RohanMuppa/brightspace-mcp-server)** - ⭐ 19
...
3856. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 19
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

3857. **[mcp-server-codegraph](https://github.com/CartographAI/mcp-server-codegraph)** - ⭐ 19
   MCP server for graph representation of a codebase

3858. **[bambu-printer-mcp](https://github.com/DMontgomery40/bambu-printer-mcp)** - ⭐ 19
   MCP server for Bambu Lab 3D printers — STL manipulation, BambuStudio slicing, and direct printer control

3859. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 19
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

3860. **[SimpleMcp.Demo](https://github.com/hassanhabib/SimpleMcp.Demo)** - ⭐ 19
   Simplest Possible Demo for Building MCP Server & Client

3861. **[daiv](https://github.com/srtab/daiv)** - ⭐ 19
   Your AI-powered SWE teammate, built into your git workflow

3862. **[nexo](https://github.com/wazionapps/nexo)** - ⭐ 19
...
3863. **[sufetch](https://github.com/productdevbook/sufetch)** - ⭐ 18
   Type-safe OpenAPI clients with MCP server for AI-driven API exploration

3864. **[mcp-copilot](https://github.com/tshu-w/mcp-copilot)** - ⭐ 18
   A meta MCP server that seamlessly scales LLMs to 1000+ MCP servers through automatic routing.

3865. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
3866. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

3867. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
3868. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 18
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

3869. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 18
...
3870. **[titanmind-whatsapp-mcp](https://github.com/TitanmindAGI/titanmind-whatsapp-mcp)** - ⭐ 18
...
3871. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 18
...
3872. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 18
   A command-line utility for interacting with MCP servers.

3873. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 18
...
3874. **[toolhive-catalog](https://github.com/stacklok/toolhive-catalog)** - ⭐ 18
   ToolHive's registry catalog of MCP servers

3875. **[rigour](https://github.com/rigour-labs/rigour)** - ⭐ 18
   The immune system for AI coding agents

3876. **[robotmem](https://github.com/robotmem/robotmem)** - ⭐ 18
   Robot Memory - Persistent memory system for AI robots. MCP Server + hybrid search + spatial retrieval.

3877. **[speclock](https://github.com/sgroy10/speclock)** - ⭐ 18
...
3878. **[agentify](https://github.com/koriyoshi2041/agentify)** - ⭐ 18
...
3879. **[arxiv-mcp-server](https://github.com/anuj0456/arxiv-mcp-server)** - ⭐ 18
...
3880. **[mcp-gateway](https://github.com/unrelated-ai/mcp-gateway)** - ⭐ 18
...
3881. **[scopus-mcp](https://github.com/qwe4559999/scopus-mcp)** - ⭐ 18
...
3882. **[mcp-obsidian](https://github.com/Piotr1215/mcp-obsidian)** - ⭐ 18
   simple mcp server for interacting with local obsidian notes

3883. **[ContextOS](https://github.com/itallstartedwithaidea/ContextOS)** - ⭐ 18
...
3884. **[local-mcp-gateway](https://github.com/DXHeroes/local-mcp-gateway)** - ⭐ 18
   Aggregate multiple MCP servers into a single endpoint with web UI, OAuth 2.1, and profile-based tool management

3885. **[openrouter-mcp-multimodal](https://github.com/stabgan/openrouter-mcp-multimodal)** - ⭐ 18
   MCP server for OpenRouter providing text chat and image analysis tools

3886. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 18

3887. **[XcodeMCPWrapper](https://github.com/SoundBlaster/XcodeMCPWrapper)** - ⭐ 18
   MCP that makes Xcode 26.3's MCP compatible with Cursor and other strict MCP-spec-compliant clients

3888. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 18
   An MCP client that uses signal for sending and receiving messages.

3889. **[mcp-client-and-proxy](https://github.com/appsecco/mcp-client-and-proxy)** - ⭐ 18
   A universal MCP client with proxying feature to interact with MCP Servers which support STDIO transport.

3890. **[mendeley-mcp](https://github.com/pallaprolus/mendeley-mcp)** - ⭐ 18
...
3893. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 18
...
3894. **[kiro-professional-toolkit](https://github.com/gkhantyln/kiro-professional-toolkit)** - ⭐ 18
...
3895. **[codesearch](https://github.com/flupkede/codesearch)** - ⭐ 18
...
3896. **[mcp-dashboards](https://github.com/KyuRish/mcp-dashboards)** - ⭐ 18
   Turn your data into interactive dashboards inside any AI client - MCP Apps powered

3897. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 18
...
3898. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 17
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

3899. **[model-context-protocol-survey](https://github.com/asinghcsu/model-context-protocol-survey)** - ⭐ 17
   Model Context Protocol (MCP)

3900. **[GUARDRAIL](https://github.com/nshkrdotcom/GUARDRAIL)** - ⭐ 17
   GUARDRAIL - MCP Security - Gateway for Unified Access, Resource Delegation, and Risk-Attenuating Information Limits

3901. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 17
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

3902. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

3903. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

3904. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

3905. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

3906. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

3907. **[mcp-server-prometheus](https://github.com/loglmhq/mcp-server-prometheus)** - ⭐ 17
   MCP server for interacting with Prometheus

3908. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 17
   MCP Server for Teenage Engineering EP-133 KO-II

3909. **[context-engineering](https://github.com/timothywarner-org/context-engineering)** - ⭐ 17
...
3910. **[docmole](https://github.com/Vigtu/docmole)** - ⭐ 17
   Dig through any documentation with AI - MCP server for Claude, Cursor, and other AI assistants

3911. **[autowpmcp](https://github.com/Njengah/autowpmcp)** - ⭐ 17
...
3912. **[mcpforge](https://github.com/lorenzosaraiva/mcpforge)** - ⭐ 17

3913. **[mcp-ecosystem](https://github.com/SynkraAI/mcp-ecosystem)** - ⭐ 17
   MCP Ecosystem: Docker MCP Toolkit, IDE Configs & Presets for AIOS

3914. **[lightdash_mcp](https://github.com/poddubnyoleg/lightdash_mcp)** - ⭐ 17
   mcp server for lightdash

3915. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 17
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

3916. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 17
...
3917. **[osmmcp](https://github.com/NERVsystems/osmmcp)** - ⭐ 17
...
3918. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 17
   A model-agnostic MCP Client-Server for .Net and Unity

3919. **[github-to-mcp](https://github.com/nirholas/github-to-mcp)** - ⭐ 17
   Convert GitHub repositories to MCP servers automatically. Extract tools from OpenAPI, GraphQL & REST APIs for Claude Desktop, Cursor, Windsurf, Cline & VS Code. AI-powered code generation creates type-safe TypeScript/Python MCP servers. Zero config setup - just paste a repo URL. Built for AI assistants & LLM tool integration.

3920. **[FocusRelayMCP](https://github.com/deverman/FocusRelayMCP)** - ⭐ 17
...
3921. **[extract-llms-docs](https://github.com/nirholas/extract-llms-docs)** - ⭐ 17
...
3922. **[video-research-mcp](https://github.com/Galbaz1/video-research-mcp)** - ⭐ 17
...
3923. **[opencode-browser](https://github.com/michaljach/opencode-browser)** - ⭐ 17
...
3924. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 17
   MCP server and client for Frontapp

3925. **[nasa](https://github.com/peteretelej/nasa)** - ⭐ 17
...
3926. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 17

3927. **[ia-na-pratica](https://github.com/Code4Delphi/ia-na-pratica)** - ⭐ 17
   IA na Prática: LLM, RAG, MCP, Agents, Function Calling, Multimodal, TTS/STT e mais

3928. **[videocapture-mcp](https://github.com/13rac1/videocapture-mcp)** - ⭐ 17
   Model Context Protocol (MCP) server to capture images from an OpenCV-compatible webcam or video source

3929. **[qmt-mcp-server](https://github.com/jm12138/qmt-mcp-server)** - ⭐ 17
   基于 QMT 平台股票行情的 MCP 服务器，用于提供股票市场数据下载和查询的功能。

3930. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 17
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

3931. **[obsidian-http-mcp](https://github.com/NasAndNora/obsidian-http-mcp)** - ⭐ 17
   First HTTP-native MCP server for Obsidian - Compatible with any MCP client (Claude Code, Codex, Gemini, etc.) without stdio bugs

3932. **[conductor](https://github.com/aryabyte21/conductor)** - ⭐ 17
   Manage MCP server configs across AI coding clients

3933. **[originlab-mcp](https://github.com/garethbeaumo/originlab-mcp)** - ⭐ 17
    MCP Server for OriginLab  Control OriginLab with natural language through AI clients via the Model Context Protocol.

3934. **[mcp-client-cli](https://github.com/addity3/mcp-client-cli)** - ⭐ 16
   cli-based program to run llm prompt and mcp

3935. **[claude-vigil-mcp](https://github.com/Vvkmnn/claude-vigil-mcp)** - ⭐ 16
   🏺 An MCP server for checkpointing and file recovery in Claude Code

3936. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

3937. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

3938. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
3939. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

3940. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
3941. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

3942. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
3943. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

3944. **[aica](https://github.com/dotneet/aica)** - ⭐ 16
   aica(AI Code Analyzer) reviews your code using AI. Supports CLI and GitHub Actions.

3945. **[go-mcp](https://github.com/dstotijn/go-mcp)** - ⭐ 16
   Go library for implementing the Model Context Protocol (MCP).

3946. **[QCX](https://github.com/QueueLab/QCX)** - ⭐ 16
   Language to Maps

3947. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 16
   MCP server for xAI Grok — read and serve .faf project context. npm: grok-faf-mcp

3948. **[mcp-jest](https://github.com/josharsh/mcp-jest)** - ⭐ 16
   Automated testing for Model Context Protocol servers. Ship MCP Servers with confidence.

3949. **[mcp-client-gen](https://github.com/kriasoft/mcp-client-gen)** - ⭐ 16
   Turn any MCP server into a type-safe TypeScript SDK in seconds - with    OAuth 2.1 and multi-provider support

3950. **[penpot-mcp-server](https://github.com/zcube/penpot-mcp-server)** - ⭐ 16
   MCP server for Penpot - Connect AI assistants to Penpot design platform via Model Context Protocol

3951. **[pentest-mcp-server](https://github.com/LayeSec006/pentest-mcp-server)** - ⭐ 16
   MCP server for penetration testing

3952. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 16
   An MCP server to read MCP logs to debug directly inside the client

3953. **[drf-mcp-docs](https://github.com/Abdulkhalek-1/drf-mcp-docs)** - ⭐ 16
   API documentation via MCP for AI coding agents

3954. **[LSP4J-MCP](https://github.com/stephanj/LSP4J-MCP)** - ⭐ 16
...
3955. **[outlook-mcp](https://github.com/XenoXilus/outlook-mcp)** - ⭐ 16
...
3956. **[mcpdog](https://github.com/kinhunt/mcpdog)** - ⭐ 16
...
3957. **[puppeteer-mcp-server](https://github.com/sultannaufal/puppeteer-mcp-server)** - ⭐ 16
...
3958. **[mcp-salesforce](https://github.com/AiondaDotCom/mcp-salesforce)** - ⭐ 16
...
3959. **[shodan-mcp](https://github.com/Vorota-ai/shodan-mcp)** - ⭐ 16
...
3960. **[webmcp-react](https://github.com/MCPCat/webmcp-react)** - ⭐ 16
...
3961. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 16
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

3962. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 16
...
3963. **[openapi-to-mcp](https://github.com/EvilFreelancer/openapi-to-mcp)** - ⭐ 16
...
3964. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 16
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

3965. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 16
   A web-based client for connecting to MCP servers with OAuth support

3966. **[reporelay](https://github.com/chwoerz/reporelay)** - ⭐ 16
   A self-hosted code context engine for MCP.

3967. **[vibeshell](https://github.com/veithly/vibeshell)** - ⭐ 16
...
3968. **[mcp-server-unitycatalog](https://github.com/ognis1205/mcp-server-unitycatalog)** - ⭐ 16
   Unity Catalog AI Model Context Protocol Server

3969. **[claude-mcp-scheduler](https://github.com/tonybentley/claude-mcp-scheduler)** - ⭐ 16
   Use Claude API to prompt remote agents on a cron interval but use local MCPs to handle tool calls for context

3970. **[google-mcp](https://github.com/vakharwalad23/google-mcp)** - ⭐ 16
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3971. **[atm](https://github.com/sfox38/atm)** - ⭐ 16
   Create secure and scoped Home Assistant API tokens for AI assistants and other MCP clients

3972. **[mcpmate](https://github.com/loocor/mcpmate)** - ⭐ 16
...
3973. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 16
...
3974. **[herald-mail-app](https://github.com/herald-email/herald-mail-app)** - ⭐ 16
...
3975. **[mcp-add](https://github.com/paoloricciuti/mcp-add)** - ⭐ 16
   Universal cli to add an MCP server to a variety of clients

3976. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 16
...
3977. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 16
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

3978. **[mcp-unifi-applications](https://github.com/KallistoX/mcp-unifi-applications)** - ⭐ 16
...
3979. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 15
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

3980. **[faf](https://github.com/Wolfe-Jam/faf)** - ⭐ 15
   FAF specification — IANA-registered AI context format (application/vnd.faf+yaml)

3981. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

3982. **[django-firebase-mcp](https://github.com/raghavdasila/django-firebase-mcp)** - ⭐ 15
...
3983. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
3984. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

3985. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

3986. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 15
   MCP host app w/ textual user interface, in Python

3987. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 15
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

3988. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 15
...
3989. **[cursor-feedback-extension](https://github.com/jianger666/cursor-feedback-extension)** - ⭐ 15
   Save your Cursor monthly quota! Unlimited AI interactions in one conversation via MCP feedback loop.

3990. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 15
   A Socratic dialogue engine for AI agents. 

3991. **[mcp](https://github.com/local-falcon/mcp)** - ⭐ 15
...
3992. **[opentargets-mcp](https://github.com/nickzren/opentargets-mcp)** - ⭐ 15
   MCP server for Open Targets Data

3993. **[Convert-Markdown-PDF-MCP](https://github.com/seanivore/Convert-Markdown-PDF-MCP)** - ⭐ 15
   Markdown To PDF Conversion MCP

3994. **[mcp-server-subagent](https://github.com/dvcrn/mcp-server-subagent)** - ⭐ 15
   MCP for letting agents delegate tasks to sub-agents (Claude Code, Aider, Q)

3995. **[automagik-tools](https://github.com/namastexlabs/automagik-tools)** - ⭐ 15
   From API to AI in 30 Seconds - Transform any API into an intelligent MCP agent that learns, adapts, and speaks human

3996. **[hive-crypto-mcp](https://github.com/hive-intel/hive-crypto-mcp)** - ⭐ 15
...
3997. **[companies-house-mcp](https://github.com/stefanoamorelli/companies-house-mcp)** - ⭐ 15
...
3998. **[chatgpt-app-typescript-template](https://github.com/pomerium/chatgpt-app-typescript-template)** - ⭐ 15
...
3999. **[ultrathink](https://github.com/husniadil/ultrathink)** - ⭐ 15
...
4000. **[django-mcp](https://github.com/hyperb1iss/django-mcp)** - ⭐ 15
...
4001. **[gsd-task-manager](https://github.com/vscarpenter/gsd-task-manager)** - ⭐ 15
...
4002. **[agent-board](https://github.com/quentintou/agent-board)** - ⭐ 15
...
4003. **[cuba-memorys](https://github.com/LeandroPG19/cuba-memorys)** - ⭐ 15
...
4004. **[opentrace](https://github.com/adham90/opentrace)** - ⭐ 15
...
4012. **[mcp-server](https://github.com/configcat/mcp-server)** - ⭐ 15
   Official ConfigCat Model Context Protocol (MCP) Server 

4013. **[mcp-time](https://github.com/TheoBrigitte/mcp-time)** - ⭐ 15
...
4014. **[salesforce-mcp-lib](https://github.com/Damecek/salesforce-mcp-lib)** - ⭐ 15
...
4015. **[arxiv-mcp-server](https://github.com/1Dark134/arxiv-mcp-server)** - ⭐ 15
...
4016. **[ai-cli-mcp](https://github.com/mkXultra/ai-cli-mcp)** - ⭐ 15
   MCP server to run Claude, Codex, and Gemini CLI agents in the background from any MCP client.

4017. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

4018. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
4019. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

4020. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

4021. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

4022. **[mcp-ipfs](https://github.com/alexbakers/mcp-ipfs)** - ⭐ 14
   🪐 MCP IPFS Server 

4023. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 14
...
4024. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 14
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

4025. **[mcp-config-editor](https://github.com/kaichen/mcp-config-editor)** - ⭐ 14
   A simple GUI for managing MCP servers, for easy toggle mcp servers.

4026. **[deep-directory-tree-mcp](https://github.com/andredezzy/deep-directory-tree-mcp)** - ⭐ 14
...
4027. **[dx-toolkit](https://github.com/youdotcom-oss/dx-toolkit)** - ⭐ 14
   Open-source toolkit enabling developers to integrate You.com's AI capabilities into their workflows

4028. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 14
...
4029. **[jadx-mcp-server](https://github.com/Qtty/jadx-mcp-server)** - ⭐ 14
   A Pure-Java MCP Server for JaDX Android Reverse Engineering Tool

4030. **[vmware-esxi-mcp](https://github.com/uldyssian-sh/vmware-esxi-mcp)** - ⭐ 14
...
4031. **[webfetch-mcp](https://github.com/manooll/webfetch-mcp)** - ⭐ 14
   Live Web Access for Your Local AI — Tunable Search & Clean Content Extraction

4032. **[domain-search-mcp](https://github.com/dorukardahan/domain-search-mcp)** - ⭐ 14
...
4033. **[dav-mcp](https://github.com/PhilflowIO/dav-mcp)** - ⭐ 14
   Transform AI agents into orchestrating assistants managing calendars, contacts, and tasks

4034. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 14
...
4035. **[phabricator-mcp](https://github.com/freelancer/phabricator-mcp)** - ⭐ 14
   MCP server for Phabricator

4036. **[openalex-research-mcp](https://github.com/oksure/openalex-research-mcp)** - ⭐ 14
...
4037. **[claude-praetorian-mcp](https://github.com/Vvkmnn/claude-praetorian-mcp)** - ⭐ 14
   ⚜️ An MCP server for context compaction and recycling in Claude Code

4038. **[servicenow-mcp](https://github.com/aartiq/servicenow-mcp)** - ⭐ 14
...
4039. **[swift-skeleton](https://github.com/1amageek/swift-skeleton)** - ⭐ 14
...
4040. **[mcp-windows-automation](https://github.com/mukul975/mcp-windows-automation)** - ⭐ 14
...
4041. **[memory-visualizer](https://github.com/mjherich/memory-visualizer)** - ⭐ 14
...
4042. **[WAIaaS](https://github.com/minhoyoo-iotrust/WAIaaS)** - ⭐ 14
   Wallet-as-a-Service for all AI agents in the world

4043. **[x402-deploy](https://github.com/nirholas/x402-deploy)** - ⭐ 14
   Turn any API or MCP server into a paid service with x402 

4044. **[ai-mate](https://github.com/symfony/ai-mate)** - ⭐ 14
   AI development assistant MCP server for Symfony projects

4045. **[mcp-security-checklist](https://github.com/Helixar-AI/mcp-security-checklist)** - ⭐ 14
...
4046. **[llms-txt-generator](https://github.com/aircodelabs/llms-txt-generator)** - ⭐ 14
   The ultimate AI-powered generator for llms.txt and llms-full.txt files. 

4047. **[mcp-graph-workflow](https://github.com/DiegoNogueiraDev/mcp-graph-workflow)** - ⭐ 14
...
4048. **[MCPScan](https://github.com/sahiloj/MCPScan)** - ⭐ 14
...
4049. **[toolhive-registry-server](https://github.com/stacklok/toolhive-registry-server)** - ⭐ 14
...
4050. **[KunAvatar](https://github.com/KunLabAI/KunAvatar)** - ⭐ 14
...
4051. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 14
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

4052. **[Rube](https://github.com/dorucioclea/Rube)** - ⭐ 14
   Rube is a Model Context Protocol (MCP) server that connects your AI tools to 500+ apps like Gmail, Slack, GitHub, and Notion. Simply install it in your AI client, authenticate once with your apps, and start asking your AI to perform real actions like "Send an email" or "Create a task."

4053. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 14
...
4054. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 14
...
4055. **[java-xiaohongshu-mcp](https://github.com/bzlrj/java-xiaohongshu-mcp)** - ⭐ 14
   Java 实现的小红书 Model Context Protocol (MCP) 工具服务  为 AI Agent / MCP Client 提供标准化接口，实现： 登录、发图文、发视频、搜索、评论、推荐内容、用户主页 等核心功能

4056. **[SRE-agent](https://github.com/martinimarcello00/SRE-agent)** - ⭐ 14
...
4057. **[istat_mcp_server](https://github.com/ondata/istat_mcp_server)** - ⭐ 14
   MCP server to query Italian statistics (ISTAT) via SDMX API — compatible with any MCP client

4058. **[ex_mcp](https://github.com/azmaveth/ex_mcp)** - ⭐ 14
   Model Context Protocol (MCP) and Agent Client Protocol (ACP) client/server library for Elixir

4059. **[google-mcp-remote](https://github.com/vakharwalad23/google-mcp-remote)** - ⭐ 14
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

4060. **[obsidian-cli-rest](https://github.com/dsebastien/obsidian-cli-rest)** - ⭐ 14
...
4061. **[mcp-toggl](https://github.com/verygoodplugins/mcp-toggl)** - ⭐ 14
   MCP server for Toggl Track integration with intelligent caching and reporting tools

4062. **[ai-memory-mcp](https://github.com/alphaonedev/ai-memory-mcp)** - ⭐ 14
...
4063. **[mcpskills-cli](https://github.com/dhanababum/mcpskills-cli)** - ⭐ 14
...
4064. **[ux-mcp-server](https://github.com/elsahafy/ux-mcp-server)** - ⭐ 14
...
4065. **[bookmark-manager-mcp](https://github.com/infinitepi-io/bookmark-manager-mcp)** - ⭐ 14
...
4066. **[lexis](https://github.com/R0MADEV/lexis)** - ⭐ 14
...
4067. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 13

4068. **[nest-mcp](https://github.com/btwld/nest-mcp)** - ⭐ 13
   Build Model Context Protocol (MCP) servers, clients, and gateways using the NestJS ecosystem you already know.

4069. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

4070. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

4071. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

4072. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
4073. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

4074. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
4075. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

4076. **[mongo-mcp](https://github.com/1RB/mongo-mcp)** - ⭐ 13
   MCP server that provide tools to LLMs such as claude in cursor to interact with MongoDB

4077. **[memory-mcp-server](https://github.com/hpkv-io/memory-mcp-server)** - ⭐ 13
   A MCP (Model Context Protocol) server providing long-term memory for LLMs

4078. **[mcp-web-search-tool](https://github.com/gabrimatic/mcp-web-search-tool)** - ⭐ 13
   A MCP server providing real-time web search capabilities to any AI model.

4079. **[prompt-engineer-mcp-server](https://github.com/hireshBrem/prompt-engineer-mcp-server)** - ⭐ 13
   Write 10x better prompts using Prompt Engineer MCP server.

4080. **[mcp_review_code_tool](https://github.com/wenkil/mcp_review_code_tool)** - ⭐ 13
...
4081. **[sherpa](https://github.com/CartographAI/sherpa)** - ⭐ 13
   Chat with any codebase with MCP servers in a single command

4082. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 13
   A multi-agent CLI tool powered by Swarms-rs and Composio

4083. **[openwebui-mcp-setup](https://github.com/sonzentherevolution/openwebui-mcp-setup)** - ⭐ 13
...
4084. **[mcp-meme-sticky](https://github.com/nkapila6/mcp-meme-sticky)** - ⭐ 13
...
4085. **[AgentStack](https://github.com/ssdeanx/AgentStack)** - ⭐ 13
...
4090. **[taiga-ui-mcp](https://github.com/taiga-family/taiga-ui-mcp)** - ⭐ 13
   Taiga UI MCP server providing documentation search and scaffolding tools.

4091. **[owl-mcp](https://github.com/ai4curation/owl-mcp)** - ⭐ 13
   MCP server for OWL applications

4092. **[mcp-delphi](https://github.com/flydev-fr/mcp-delphi)** - ⭐ 13
   Delphi and Lazarus/FPC MCP server: build/clean pascal projects via MCP tools.

4093. **[mcp-server-weather-js](https://github.com/hideya/mcp-server-weather-js)** - ⭐ 13
   Simple Weather MCP Server Example

4094. **[inspector](https://github.com/mcp-use/inspector)** - ⭐ 13
   Modern MCP Inspector for remote mcp servers with support for Apps SDK

4095. **[istek](https://github.com/istekapp/istek)** - ⭐ 13
   The API client built for AI agents. HTTP, GraphQL, gRPC, WebSocket, MQTT + MCP."

4096. **[mcp-server-template](https://github.com/BearHuddleston/mcp-server-template)** - ⭐ 13
   Spec-driven Go MCP server template for building domain MCPs with AI-agent onboarding.

4097. **[obsidian-mcp-server](https://github.com/smith-and-web/obsidian-mcp-server)** - ⭐ 13
   MCP server for Obsidian vault management - enables Claude and other AI assistants to read, write, search, and organize your notes

4098. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 13
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

4099. **[claude-tools-mcp](https://github.com/mathematic-inc/claude-tools-mcp)** - ⭐ 13
...
4100. **[sift-gateway](https://github.com/lourencomaciel/sift-gateway)** - ⭐ 13
   Reliability gateway for AI tool output: schema-stable, secret-safe, pagination-complete JSON for MCP and CLI agents.

4101. **[temple-bridge](https://github.com/templetwo/temple-bridge)** - ⭐ 13
...
4102. **[lm](https://github.com/houtini-ai/lm)** - ⭐ 13
...
4103. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 13
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

4104. **[cie](https://github.com/kraklabs/cie)** - ⭐ 13
...
4105. **[claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp)** - ⭐ 13
   Anthropic MCP server for .faf — 33 tools, IANA-registered format. npm: claude-faf-mcp. MCP Registry #2759

4106. **[credit-optimizer-v5](https://github.com/rafsilva85/credit-optimizer-v5)** - ⭐ 13
...
4107. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 13
...
4108. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 13
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

4109. **[GitLab-CICD-Agent](https://github.com/shalwin04/GitLab-CICD-Agent)** - ⭐ 13
...
4110. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 13
   Documentation

4111. **[agent-hub](https://github.com/nathangtg/agent-hub)** - ⭐ 13
...
4112. **[Cortex](https://github.com/cdeust/Cortex)** - ⭐ 13
   C.O.R.T.E.X. — Cognitive profiling system for Claude Code

4113. **[docdex](https://github.com/bekirdag/docdex)** - ⭐ 13
   A document index with MCP, http and client support. https://docdex.org/ 

4114. **[claude-qdrant-mcp](https://github.com/marlian/claude-qdrant-mcp)** - ⭐ 13
   Local-first TypeScript MCP server for Qdrant with client isolation, LM Studio integration, and scalable document workflows.

4115. **[magento-coding-standard-mcp](https://github.com/Midhun-edv/magento-coding-standard-mcp)** - ⭐ 13
...
4116. **[XcodeMCPKit](https://github.com/lynnswap/XcodeMCPKit)** - ⭐ 13
   Xcode MCP proxy with multi-client sessions

4117. **[pentest-mcp-server](https://github.com/exjskdjsdfks/pentest-mcp-server)** - ⭐ 13
...
4118. **[langgraph-mcp-dataanalysis](https://github.com/gongwon-nayeon/langgraph-mcp-dataanalysis)** - ⭐ 13
   DataAnalysis Agent using LangGraph & MCP server and client

4119. **[locus](https://github.com/Magnifico4625/locus)** - ⭐ 13
...
4120. **[SQL_MCP_Server](https://github.com/pawankumar94/SQL_MCP_Server)** - ⭐ 13
...
4121. **[vault-sync](https://github.com/alexjbarnes/vault-sync)** - ⭐ 13
   Headless Obsidian Sync client with MCP server for AI assistants

4122. **[league-client-mcp](https://github.com/rumi-chan/league-client-mcp)** - ⭐ 13
   Connect Claude, Antigravity to League Client via MCP & Pengu Loader.

4123. **[godot-dotnet-mcp](https://github.com/LuoxuanLove/godot-dotnet-mcp)** - ⭐ 13
...
4124. **[mcpup](https://github.com/mohammedsamin/mcpup)** - ⭐ 13
   MCP configuration manager — enable, disable, and sync MCP servers across AI clients from one place

4125. **[DevoChat](https://github.com/gws8820/DevoChat)** - ⭐ 13
   Unified Web AI Chat UI & MCP Client

4126. **[bexio-mcp-server](https://github.com/PromptPartner/bexio-mcp-server)** - ⭐ 13
...
4127. **[stackchan-mcp](https://github.com/kisaragi-mochi/stackchan-mcp)** - ⭐ 13
   MCP gateway for StackChan (xiaozhi-esp32): bridge any MCP client to a CoreS3 + servo + camera robot

4128. **[sarvam-mcp-server](https://github.com/Shobhit-Nagpal/sarvam-mcp-server)** - ⭐ 12
   talk to sarvam APIs directly, without code.

4129. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

4130. **[mcp-server-manager](https://github.com/infinitimeless/mcp-server-manager)** - ⭐ 12
   A tool to create, build, and manage MCP servers for use with Claude and other MCP clients

4131. **[MCP-Client-Server-for-agents](https://github.com/qmatteoq/MCP-Client-Server-for-agents)** - ⭐ 12
   This project demonstrates a Model Context Protocol (MCP) server and client implementation in .NET

4132. **[xcf](https://github.com/CodeFreezeAI/xcf)** - ⭐ 12
   Xcode MCP Server xcf is a 100% Swift based allowing you to integrate Xcode with your favorite AI IDE or MCP Client

4133. **[CursorMCPMonitor](https://github.com/willibrandon/CursorMCPMonitor)** - ⭐ 12
...
4134. **[proxy-base-agent](https://github.com/TheProxyCompany/proxy-base-agent)** - ⭐ 12
   A stateful agent with 100% reliable tool use. Build custom agents on any LLM with guaranteed state consistency.

4135. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 12
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

4136. **[MIST](https://github.com/CLoaKY233/MIST)** - ⭐ 12
...
4137. **[PackageFlow](https://github.com/runkids/PackageFlow)** - ⭐ 12
   A visual DevOps hub for npm scripts, Git, workflows, and deploy — controllable by AI via MCP.

4138. **[snowflake-mcp-server](https://github.com/dynamike/snowflake-mcp-server)** - ⭐ 12
   MCP Server for connecting to Snowflake with read-only questions

4139. **[mcp-server-webscan](https://github.com/bsmi021/mcp-server-webscan)** - ⭐ 12
   A Model Context Protocol (MCP) server for web content scanning and analysis. This server provides tools for fetching, analyzing, and extracting information from web pages.

4140. **[agent-identity-protocol](https://github.com/ArangoGutierrez/agent-identity-protocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

4141. **[_b00t_](https://github.com/elasticdotventures/_b00t_)** - ⭐ 12
   🥾 _b00t_:  state of the art agentic harness tooling & dynamic context initialization

4142. **[jenkins-mcp-server](https://github.com/AshwiniGhuge3012/jenkins-mcp-server)** - ⭐ 12
...
4143. **[openagentidentityprotocol](https://github.com/openagentidentityprotocol/openagentidentityprotocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

4144. **[cv-resume-builder-mcp](https://github.com/eyaab/cv-resume-builder-mcp)** - ⭐ 12
...
4145. **[MCPGateway](https://github.com/abdullah1854/MCPGateway)** - ⭐ 12
   Open-source MCP server — progressive tool discovery, code execution, intelligent routing & token optimization across 50+ tools

4146. **[mcp-interactive-terminal](https://github.com/amol21p/mcp-interactive-terminal)** - ⭐ 12
...
4147. **[kiro-powers](https://github.com/praveenc/kiro-powers)** - ⭐ 12
   Repository of custom kiro powers. https://kiro.dev/docs/powers/

4148. **[guildbridge](https://github.com/dend/guildbridge)** - ⭐ 12
   🏰 Remotely hosted MCP server for Discord

4149. **[porkbun-mcp-server](https://github.com/miraclebakelaser/porkbun-mcp-server)** - ⭐ 12
   MCP server implementation for managing domains, DNS, and SSL via the Porkbun API.

4150. **[local-history-mcp](https://github.com/xxczaki/local-history-mcp)** - ⭐ 12
   MCP server for accessing VS Code/Cursor's Local History

4151. **[claude-context-local](https://github.com/MikeO-AI/claude-context-local)** - ⭐ 12
...
4152. **[biomed-agent](https://github.com/nickzren/biomed-agent)** - ⭐ 12
   Connecting AI agent to biomedical data

4153. **[nodebench-ai](https://github.com/HomenShum/nodebench-ai)** - ⭐ 12
...
4154. **[mcp-for-woocommerce](https://github.com/iOSDevSK/mcp-for-woocommerce)** - ⭐ 12
...
4155. **[asap-protocol](https://github.com/adriannoes/asap-protocol)** - ⭐ 12
...
4156. **[scorable-mcp](https://github.com/root-signals/scorable-mcp)** - ⭐ 12
   MCP for Scorable Evaluation Platform

4157. **[Hoofy](https://github.com/HendryAvila/Hoofy)** - ⭐ 12
...
4158. **[wamcp](https://github.com/delltrak/wamcp)** - ⭐ 12
...
4159. **[actual-mcp-server](https://github.com/agigante80/actual-mcp-server)** - ⭐ 12
...
4160. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 12
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

4161. **[ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode)** - ⭐ 12
   Google Gemini Model Context Protocol (MCP) Client for VS Code. Connect AI assistants to local context & tools.

4162. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 12
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

4163. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 12
...
4164. **[Opencollab-mcp](https://github.com/prakhar1605/Opencollab-mcp)** - ⭐ 12
   AI-powered open source contribution matchmaker — finds perfect "good first issues" matched to YOUR skills

4165. **[openclaw-mcp-server](https://github.com/Helms-AI/openclaw-mcp-server)** - ⭐ 12
   MCP server exposing OpenClaw Gateway tools to Claude Code and other MCP-compatible clients

4166. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 12
   A TUI to probe the calls between MCP client and server

4167. **[openclaw-mcp-bridge](https://github.com/AIWerk/openclaw-mcp-bridge)** - ⭐ 12
   OpenClaw MCP Client Plugin - bridges MCP servers into OpenClaw via registerTool

4168. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 12

4169. **[robotmcp_client](https://github.com/robotmcp/robotmcp_client)** - ⭐ 12
   Connect AI models like Claude & GPT with robots using MCP and ROS.

4170. **[mcp-mux](https://github.com/mcpmux/mcp-mux)** - ⭐ 12
   Configure MCP servers once, connect every AI client through a single local gateway

4171. **[nestjs-mcp](https://github.com/orbit-codes/nestjs-mcp)** - ⭐ 11
   An opinionated MCP module for NestJS

4172. **[mcp-server-kintone](https://github.com/macrat/mcp-server-kintone)** - ⭐ 11
   MCP server for kintone

4173. **[md2confluence-mcp](https://github.com/Gyeom/md2confluence-mcp)** - ⭐ 11
   MCP server to upload Markdown to Confluence. Auto-converts Mermaid diagrams, code blocks, images, and tables.

4174. **[swift-context-protocol](https://github.com/1amageek/swift-context-protocol)** - ⭐ 11
...
4175. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 11
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

4176. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

4177. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

4178. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
4179. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

4180. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

4181. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
4182. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

4183. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 11
   tool management service for performing vector tool calling at scale.

4184. **[mcpconnect](https://github.com/rocket-connect/mcpconnect)** - ⭐ 11
   Inspect and debug Model Context Protocol servers directly in your browser.

4185. **[locust-mcp-server](https://github.com/QAInsights/locust-mcp-server)** - ⭐ 11
   A Model Context Protocol (MCP) server implementation for running Locust load tests. This server enables seamless integration of Locust load testing capabilities with AI-powered development environments.

4186. **[mcp-boilerplate](https://github.com/iamsrikanthnani/mcp-boilerplate)** - ⭐ 11
...
4187. **[emcp](https://github.com/joeymeere/emcp)** - ⭐ 11
   A framework for building simple MCP servers with custom middleware

4188. **[polaris](https://github.com/octu0/polaris)** - ⭐ 11
   Distributed AI Agent Framework

4189. **[glm5-mcp](https://github.com/Arkya-AI/glm5-mcp)** - ⭐ 11
...
4190. **[french-tax-mcp](https://github.com/cornelcroi/french-tax-mcp)** - ⭐ 11
   MCP server for French tax calculations and information - enables AI assistants to provide accurate French tax guidance

4191. **[springboot-ai-mcp-example](https://github.com/duongminhhieu/springboot-ai-mcp-example)** - ⭐ 11
   Example Spring AI Model Context Protocol (MCP)

4192. **[mcp-space](https://github.com/tharuneshwar-s/mcp-space)** - ⭐ 11
...
4193. **[druid-mcp-server](https://github.com/iunera/druid-mcp-server)** - ⭐ 11
...
4194. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 11
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

4195. **[prometheus-protocol](https://github.com/prometheus-protocol/prometheus-protocol)** - ⭐ 11
...
4202. **[miro-mcp-server](https://github.com/olgasafonova/miro-mcp-server)** - ⭐ 11
   MCP server for controlling Miro whiteboards with AI assistants

4203. **[qurio](https://github.com/irahardianto/qurio)** - ⭐ 11
...
4204. **[fathom-mcp](https://github.com/Dot-Fun/fathom-mcp)** - ⭐ 11
   Model Context Protocol server for Fathom AI - access meeting recordings, transcripts, summaries, teams, and webhooks

4205. **[auto-mcp-client](https://github.com/down-to-earth1994/auto-mcp-client)** - ⭐ 11
...
4206. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 11
   Simple template project for controlling Unity via MCP

4207. **[keycloak-mcp](https://github.com/HaithamOumerzoug/keycloak-mcp)** - ⭐ 11
...
4208. **[AMS](https://github.com/LastEld/AMS)** - ⭐ 11
   Audit Memory System (AMS): Durable orchestration and memory layer for MCP clients.

4209. **[mcp-oidc-provider](https://github.com/tigrisdata/mcp-oidc-provider)** - ⭐ 11
...
4210. **[openmessage](https://github.com/MaxGhenis/openmessage)** - ⭐ 11
   Open-source Google Messages client with AI tools (MCP). SMS + RCS from your desktop.

4211. **[lol-client-mcp](https://github.com/johnnyinlee/lol-client-mcp)** - ⭐ 11
   League of Legends Game Client API MCP Server

4212. **[mcp-optimizer](https://github.com/StacklokLabs/mcp-optimizer)** - ⭐ 11
   MCP server that acts as an intelligent intermediary between AI clients and multiple MCP servers

4213. **[llmcore](https://github.com/Palm1r/llmcore)** - ⭐ 11
   Qt C++ library for working with AI/LLM Providers and MCP

4214. **[mcp-shopline](https://github.com/asgard-ai-platform/mcp-shopline)** - ⭐ 11
...
4215. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 11
...
4216. **[mcp-bibliotheque_nationale_de_France](https://github.com/Kryzo/mcp-bibliotheque_nationale_de_France)** - ⭐ 11
...
4217. **[GitIntel-MCP-Server](https://github.com/hoangsonww/GitIntel-MCP-Server)** - ⭐ 11
...
4229. **[kroki-mcp](https://github.com/utain/kroki-mcp)** - ⭐ 10
...
4230. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 10
   MCP server to give client the ability to access Wikipedia pages

4231. **[taskboard](https://github.com/tcarac/taskboard)** - ⭐ 10
...
4232. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

4233. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

4234. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

4235. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

4236. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
4237. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

4238. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

4239. **[mcp-kit](https://github.com/shaharia-lab/mcp-kit)** - ⭐ 10
   MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

4240. **[CodeCompass](https://github.com/alvinveroy/CodeCompass)** - ⭐ 10
...
4241. **[mode-manager-mcp](https://github.com/NiclasOlofsson/mode-manager-mcp)** - ⭐ 10
   MCP Memory Agent Server - A VS Code chatmode and instruction manager with library integration

4242. **[mcp-reporter](https://github.com/cyanheads/mcp-reporter)** - ⭐ 10
...
4243. **[mcp-starter-template-ts](https://github.com/onamfc/mcp-starter-template-ts)** - ⭐ 10
...
4244. **[rec-us-mcp-server](https://github.com/elizabethsiegle/rec-us-mcp-server)** - ⭐ 10
   Book a San Francisco tennis court via MCP server w/ auth

4245. **[mcp-demo](https://github.com/sshh12/mcp-demo)** - ⭐ 10
...
4246. **[AgentX-mcp-servers](https://github.com/AgentX-ai/AgentX-mcp-servers)** - ⭐ 10
   List of open sourced MCP servers. MIT license. Managed by AgentX with love.

4247. **[mcp-tradovate](https://github.com/0xjmp/mcp-tradovate)** - ⭐ 10
   MCP server for the Tradovate platform

4248. **[mcp-claude-hackernews](https://github.com/imprvhub/mcp-claude-hackernews)** - ⭐ 10
   An integration that allows Claude Desktop to interact with Hacker News using the Model Context Protocol (MCP).

4249. **[glasses-mcp](https://github.com/gourraguis/glasses-mcp)** - ⭐ 10
   Glasses MCP is a simple MCP server that lets your AI agent see and capture the web 👓

4250. **[ObsidianMCPServer](https://github.com/otaviocc/ObsidianMCPServer)** - ⭐ 10
   A Model Context Protocol (MCP) server that enables AI assistants to interact with your Obsidian vault 

4251. **[mcp-sys-bridge](https://github.com/leynier/mcp-sys-bridge)** - ⭐ 10
...
4252. **[sec-edgar-agentkit](https://github.com/stefanoamorelli/sec-edgar-agentkit)** - ⭐ 10
...
4253. **[context-engineering-mcp](https://github.com/bralca/context-engineering-mcp)** - ⭐ 10
...
4254. **[mcp-sqlite-server](https://github.com/prayanks/mcp-sqlite-server)** - ⭐ 10
...
4255. **[mcp-go](https://github.com/XiaoConstantine/mcp-go)** - ⭐ 10
   Golang impl of mcp protocol

4256. **[mcpet](https://github.com/shreyaskarnik/mcpet)** - ⭐ 10
...
4257. **[mcp-spring-ai-mcp-client](https://github.com/chaozai0304/mcp-spring-ai-mcp-client)** - ⭐ 10
   使用java实现mcp client了解底层的调用机制，demo示例

4258. **[awesome-mcp](https://github.com/timunbasah3/awesome-mcp)** - ⭐ 10
...
4259. **[Simple_MCP_Client](https://github.com/Avento/Simple_MCP_Client)** - ⭐ 10
   Simple MCP Client for OpenAI/Deepseek R1/V3

4260. **[awesome-mcp](https://github.com/gauravfs-14/awesome-mcp)** - ⭐ 10
...
4261. **[openapi-mcp-swagger](https://github.com/salacoste/openapi-mcp-swagger)** - ⭐ 10
...
4262. **[mcp-chaos-rig](https://github.com/Typewise/mcp-chaos-rig)** - ⭐ 10
...
4268. **[Azure-Foundry-Webinar](https://github.com/ShivamGoyal03/Azure-Foundry-Webinar)** - ⭐ 10
...
4269. **[Cognio](https://github.com/0xReLogic/Cognio)** - ⭐ 10
...
4270. **[systemprompt-template](https://github.com/systempromptio/systemprompt-template)** - ⭐ 10
   Production AI agent mesh in 3 commands. MCP servers, playbooks, and multi-agent orchestration built on systemprompt-core.

4271. **[cheatengine-mcp-bridge](https://github.com/beamstar/cheatengine-mcp-bridge)** - ⭐ 10
   🔗 Connect AI to Cheat Engine for fast memory analysis, enabling quick mods and audits without the tedious manual work.

4272. **[toolhive-cloud-ui](https://github.com/stacklok/toolhive-cloud-ui)** - ⭐ 10
...
4273. **[mcpd](https://github.com/pouriya/mcpd)** - ⭐ 10
   A ~3MB MCP daemon that exposes any script as a tool for Claude, Cursor & AI assistants

4274. **[whatsapp-mcp-extended](https://github.com/FelixIsaac/whatsapp-mcp-extended)** - ⭐ 10
...
4275. **[chessmata](https://github.com/jonradoff/chessmata)** - ⭐ 10
   Chessmata: chess game for humans and AI agents

4276. **[storybook-mcp-server](https://github.com/stefanoamorelli/storybook-mcp-server)** - ⭐ 10
...
4277. **[dbt-core-mcp](https://github.com/NiclasOlofsson/dbt-core-mcp)** - ⭐ 10
   dbt Core MCP Server: Interact with dbt projects via Model Context Protocol

4278. **[chatgpt2md](https://github.com/NextStat/chatgpt2md)** - ⭐ 10
   Convert ChatGPT export to Markdown with full-text search and MCP server for Claude

4279. **[mini_claude](https://github.com/20alexl/mini_claude)** - ⭐ 10
...
4280. **[statelessagent](https://github.com/sgx-labs/statelessagent)** - ⭐ 10
   Your AI forgets everything between sessions. SAME fixes that. Local-first, no API keys, single binary.

4281. **[MCP-Penetration-testing](https://github.com/Mr-Infect/MCP-Penetration-testing)** - ⭐ 10
...
4282. **[caltrain-mcp](https://github.com/davidyen1124/caltrain-mcp)** - ⭐ 10
...
4283. **[shellguard](https://github.com/fawdyinc/shellguard)** - ⭐ 10
   MCP server that gives LLM agents read-only shell access over SSH

4284. **[PsMCP-MCP-Server-for-Photoshop](https://github.com/Chandrahas455/PsMCP-MCP-Server-for-Photoshop)** - ⭐ 10
...
4285. **[ollama-mcp-example](https://github.com/kirillsaidov/ollama-mcp-example)** - ⭐ 10
   Ollama MCP example for dummies. 

4286. **[civitai-mcp-server](https://github.com/Cicatriiz/civitai-mcp-server)** - ⭐ 10
   A Model Context Protocol server for browsing and discovering AI models on Civitai

4287. **[openapi-to-mcp](https://github.com/agentic-community/openapi-to-mcp)** - ⭐ 10
...
4288. **[world-intel-mcp](https://github.com/marc-shade/world-intel-mcp)** - ⭐ 10
...
4289. **[ILSpy-Mcp](https://github.com/bivex/ILSpy-Mcp)** - ⭐ 10
...
4290. **[aichat](https://github.com/Hayashi-Yudai/aichat)** - ⭐ 10
   A customizable AI chat application powered by Flet.

4291. **[mcp-document-converter](https://github.com/xt765/mcp-document-converter)** - ⭐ 10
...
4292. **[simple-mcp-server](https://github.com/dataworkshop/simple-mcp-server)** - ⭐ 10
...
4293. **[cubbi](https://github.com/Monadical-SAS/cubbi)** - ⭐ 10
   Monadical container CLI tool for running sandboxed MCP clients & servers

4294. **[team-memory-mcp](https://github.com/gustavolira/team-memory-mcp)** - ⭐ 10
...
4295. **[ai-assistant-vui](https://github.com/mgoltzsche/ai-assistant-vui)** - ⭐ 10
   Experimental voice user interface (VUI) to interact with an agentic AI assistant

4296. **[mcp-client](https://github.com/CopilotKit/mcp-client)** - ⭐ 10

4297. **[tupac](https://github.com/tkellogg/tupac)** - ⭐ 10
   A terminal MCP client based on the OpenAI responses API.

4298. **[ai-mcp-bridge](https://github.com/xiaozhug/ai-mcp-bridge)** - ⭐ 10
   rest to mcp & mcp Registry & mcp Loadbalancer & ai mcp & Multiple Registries & 多注册中心 

4299. **[cli](https://github.com/inboxapi/cli)** - ⭐ 10
   🤖 Your Agents' personal email 📧  

4300. **[mcp-shell](https://github.com/Prat011/mcp-shell)** - ⭐ 10
   terminal based MCP Client 

4301. **[mcp-google-calendar](https://github.com/guinacio/mcp-google-calendar)** - ⭐ 10
...
4302. **[discogs-mcp](https://github.com/rianvdm/discogs-mcp)** - ⭐ 10
...
4303. **[capacities-mcp-bridge-unofficial](https://github.com/natkitten/capacities-mcp-bridge-unofficial)** - ⭐ 10
   Unofficial MCP tools and bridges for Capacities.io, for use with Claude Desktop, Genspark, and other clients.

4304. **[local-voice-mcp](https://github.com/CodeCraftersLLC/local-voice-mcp)** - ⭐ 10
   Give your MCP clients the ability to speak by running local voice models

4305. **[ctx-sys](https://github.com/david-franz/ctx-sys)** - ⭐ 10
...
4306. **[auxilia](https://github.com/keurcien/auxilia)** - ⭐ 10
...
4307. **[laravel-release-changelog-generator](https://github.com/lightszentip/laravel-release-changelog-generator)** - ⭐ 10
   Generate a changelog and releases with version management with artisan

4308. **[mistral-ai-docs-mcp-server](https://github.com/nikhilbhima/mistral-ai-docs-mcp-server)** - ⭐ 10
   Unofficial MCP server for Mistral AI developer docs and API reference. One public URL, no auth, works in every MCP client.

4309. **[flipper-mcp](https://github.com/roostercoopllc/flipper-mcp)** - ⭐ 10
...
4310. **[mcp-server](https://github.com/finmap-org/mcp-server)** - ⭐ 10
...
1. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 46,170
   LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any hardware. No GPU required.

2. **[CowAgent](https://github.com/zhayujie/CowAgent)** - ⭐ 44,257
...
4. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 10,596
   ValueCell is a community-driven, multi-agent platform for financial applications.

5. **[evolver](https://github.com/EvoMap/evolver)** - ⭐ 7,342
   The GEP-powered self-evolving engine for AI agents. Auditable evolution with Genes, Capsules, and Events. | evomap.ai

6. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,781
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

7. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,811
...
8. **[koog](https://github.com/JetBrains/koog)** - ⭐ 4,173
...
9. **[shippie](https://github.com/mattzcarey/shippie)** - ⭐ 2,357
   extendable code review and QA agent 🚢

10. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,346
...
11. **[nono](https://github.com/always-further/nono)** - ⭐ 2,326
...
12. **[ragent](https://github.com/nageoffer/ragent)** - ⭐ 1,973
...
14. **[open-mcp-client](https://github.com/CopilotKit/open-mcp-client)** - ⭐ 1,640

15. **[lime](https://github.com/limecloud/lime)** - ⭐ 1,405
...
16. **[openinference](https://github.com/Arize-ai/openinference)** - ⭐ 957
   OpenTelemetry Instrumentation for AI Observability

17. **[VectorCode](https://github.com/Davidyz/VectorCode)** - ⭐ 857
   A code repository indexing tool to supercharge your LLM experience.

18. **[openyak](https://github.com/openyak/openyak)** - ⭐ 777
...
26. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 444
...
27. **[pwno-mcp](https://github.com/pwno-io/pwno-mcp)** - ⭐ 260
   MCP for Pwn
...
29. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 221
...
34. **[uxc](https://github.com/holon-run/uxc)** - ⭐ 104
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 187,266
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[goose](https://github.com/aaif-goose/goose)** - ⭐ 44,876
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

3. **[kong](https://github.com/Kong/kong)** - ⭐ 43,347
   🦍 The API and AI Gateway

4. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 39,142
   AI Data Vault - A query engine for AI Agents to securely query data from any datasource

5. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 27,964
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

6. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,667
   Your ultimate Go microservices framework for the cloud-native era.

7. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,564
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

8. **[hyperframes](https://github.com/heygen-com/hyperframes)** - ⭐ 16,584
   Write HTML. Render video. Built for agents.

9. **[plate](https://github.com/udecode/plate)** - ⭐ 16,240
...
11. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 13,866
...
13. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 11,917
   LangChain4j is an idiomatic, open-source Java library for building LLM-powered applications on the JVM. It offers a unified API over popular LLM providers and vector stores, and makes implementing tool calling (including MCP support), agents and RAG easy. It integrates seamlessly with enterprise Java frameworks like Quarkus and Spring Boot.

14. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,871
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

15. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 11,806
   A cross-platform Markdown AI note-taking software.

16. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 8,617
   💻 vibe coding 2026 | Your first modern programming course for beginners to master step by step.

17. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 8,302
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

18. **[adk-go](https://github.com/google/adk-go)** - ⭐ 7,860
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

19. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,777
    The most powerful Android RPA agent framework, next generation mobile automation.

20. **[codefather](https://github.com/liyupi/codefather)** - ⭐ 7,310
...
21. **[holaOS](https://github.com/holaboss-ai/holaOS)** - ⭐ 5,428
   An Open Agent Computer for ANY digital work.

22. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 5,233
...
23. **[Yuxi](https://github.com/xerrors/Yuxi)** - ⭐ 5,126
...
24. **[API-mega-list](https://github.com/cporter202/API-mega-list)** - ⭐ 5,095
...
25. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 5,038
   Adversary simulation and Red teaming platform with AI

26. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 4,941
...
28. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,524
   AG2 (formerly AutoGen): The Open-Source AgentOS.Join us at: https://discord.gg/sNGSwQME3x

29. **[nexent](https://github.com/ModelEngine-Group/nexent)** - ⭐ 4,420
   Nexent is a zero-code platform for auto-generating production-grade AI agents using Harness Engineering principles — unified tools, skills, memory, and orchestration with built-in constraints, feedback loops, and control planes.

30. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,385
   一款基于各大企业信息API的工具，解决在遇到的各种针对国内企业信息收集难题。一键收集控股公司ICP备案、APP、小程序、微信公众号等信息聚合导出。支持MCP接入

31. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 4,129
   System Level Intelligent Router for Mixture-of-Models at Cloud, Data Center and Edge

32. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,103
   Bulk port forwarding Kubernetes services for local development.

33. **[manifest](https://github.com/mnfst/manifest)** - ⭐ 3,309
   A shadcn/ui library for building ChatGPT Apps and MCP Apps

34. **[claude-code-book](https://github.com/lintsinghua/claude-code-book)** - ⭐ 3,169
   《御舆：解码 Agent Harness》42万字拆解 AI Agent 的Harness骨架与神经 —— Claude Code 架构深度剖析，15 章从对话循环到构建你自己的 Agent Harness。在线阅读网站：

35. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,927
   A highly opinionated, zero-configuration linter and formatter.

36. **[solon](https://github.com/opensolon/solon)** - ⭐ 2,725
...
37. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 2,266
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

38. **[md2wechat-skill](https://github.com/geekjourneyx/md2wechat-skill)** - ⭐ 2,133
   Markdown to WeChat CLI | 一键排版发布到微信公众号：支持 40+ 排版样式和专业主题 、AI 配图 、批量发布

39. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 2,073
...
40. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,949
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

41. **[DataDesigner](https://github.com/NVIDIA-NeMo/DataDesigner)** - ⭐ 1,824
   🎨 NeMo Data Designer: Generate high-quality synthetic data from scratch or from seed data.

42. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,749
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

43. **[Klee](https://github.com/signerlabs/Klee)** - ⭐ 1,734
   A native macOS AI chat app powered by MLX. 100% local inference on Apple Silicon, no cloud required. Built with ShipSwift.

44. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,675
...
46. **[MultiAgentPPT](https://github.com/johnson7788/MultiAgentPPT)** - ⭐ 1,593
...
47. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,516
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

48. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,454
   A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing

49. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,413
...
50. **[mcpp-standard](https://github.com/Sunrisepeak/mcpp-standard)** - ⭐ 1,372
   D2X | Modern C++ Core Language Features - "A C++ tutorial project focused on practical"

51. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 1,359
   Korea Investment & Securities Open API Github

52. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,335
...
54. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 1,330
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

55. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,325
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

56. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,268
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

57. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 1,249
...
59. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,229
   [Acquired by The Guild] The Grafbase GraphQL Federation Gateway

60. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,191
   Search, understand, reproduce, and improve an idea with ease

61. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,162
   A single interface to use and evaluate different agent frameworks 

62. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 1,161
   Natural (2-way) voice conversations with Claude Code

63. **[rulesync](https://github.com/dyoshikawa/rulesync)** - ⭐ 1,087
   A Utility CLI for AI Coding Agents

64. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,084
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

65. **[openops](https://github.com/openops-cloud/openops)** - ⭐ 1,021
   The batteries-included, No-Code FinOps automation platform, with the AI you trust.

66. **[arduino-mcp2515](https://github.com/autowp/arduino-mcp2515)** - ⭐ 992
   Arduino MCP2515 CAN interface library

67. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 967
...
68. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 960
...
71. **[markitdown](https://github.com/DuanYan007/markitdown)** - ⭐ 818
   markitdown：CLI；MCP

72. **[eDBG](https://github.com/ShinoLeah/eDBG)** - ⭐ 810
   eBPF-based lightweight debugger for Android with MCP support

73. **[axi](https://github.com/kunchenguid/axi)** - ⭐ 789
...
75. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 769
   Solidity Static Analyzer that easily integrates into your editor

76. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 754
   Open-source platform that unifies AI agent orchestration and workflow automation — autonomy and precision in one platform.

77. **[MCPELauncher](https://github.com/zhuowei/MCPELauncher)** - ⭐ 737
   Source code for BlockLauncher, a launcher that patches Minecraft for Android

78. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 716
...
79. **[how-to-vibecoding](https://github.com/1EchA/how-to-vibecoding)** - ⭐ 685
   Vibecoding 系列教程：从环境搭建到多智能体协作，涵盖 MCP、Skills、Agent 分工治理

80. **[Sentient](https://github.com/existence-master/Sentient)** - ⭐ 680
   A personal AI assistant for everyone

81. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 668
   UI components for AI interfaces

82. **[infio-copilot](https://github.com/infiolab/infio-copilot)** - ⭐ 666
   A Cursor-inspired AI assistant for Obsidian that offers smart autocomplete and interactive chat with your selected notes

83. **[vocotype-cli](https://github.com/233stone/vocotype-cli)** - ⭐ 636
   VocoType 是一款运行在本地端侧的隐私安全语音输入工具，通过快捷键即可将语音实时转换为文字并自动输入到当前应用。支持语音转文字MCP、AI 优化文本、自定义替换词典、录音视频转文字等功能，让语音输入更高效、更安全。

84. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 634
...
85. **[OpenIntegrations](https://github.com/Bayselonarrend/OpenIntegrations)** - ⭐ 605
...
86. **[cloudsword](https://github.com/wgpsec/cloudsword)** - ⭐ 603
   一款帮助云租户发现和测试云上风险、增强云上防护能力的综合性开源工具

87. **[ChattyPlay-Agent](https://github.com/P1kaj1uu/ChattyPlay-Agent)** - ⭐ 601
...
88. **[agent-desktop](https://github.com/lahfir/agent-desktop)** - ⭐ 593
...
89. **[claude-code-cli](https://github.com/huangserva/claude-code-cli)** - ⭐ 577
...
93. **[CookHero](https://github.com/Decade-qiu/CookHero)** - ⭐ 486
...
94. **[spool](https://github.com/spool-lab/spool)** - ⭐ 485
...
95. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 479
   Browser Operator - The AI browser with built in Multi-Agent platform! Open source alternative to ChatGPT Atlas, Perplexity Comet, Dia and Microsoft CoPilot Edge Browser

96. **[machi](https://github.com/qntx/machi)** - ⭐ 477
...
98. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 439
...
103. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 394
   MCP for Unreal Engine 5

104. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 393
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的智能聊天助手

105. **[graphrag-toolkit](https://github.com/awslabs/graphrag-toolkit)** - ⭐ 393
...
109. **[azan-mcp](https://github.com/ahmedeltaher/azan-mcp)** - ⭐ 382
...
128. **[MCP-Defender](https://github.com/MCP-Defender/MCP-Defender)** - ⭐ 253
...
135. **[MCPU](https://github.com/cpldcpu/MCPU)** - ⭐ 233
   MCPU - A Minimal 8Bit CPU in a 32 Macrocell CPLD

136. **[stock-scanner-mcp](https://github.com/wbsu2003/stock-scanner-mcp)** - ⭐ 231
   这是一个基于 FastAPI-MCP 的股票分析服务，旨在通过 MCP 工具函数接口提供股票相关的综合数据和分析能力，包括价格、评分、技术报告和 AI 分析。

137. **[langchain_data_agent](https://github.com/eosho/langchain_data_agent)** - ⭐ 228
   NL2SQL - Ask questions in plain English, get SQL queries and results. Powered by LangGraph.

138. **[LAP](https://github.com/Lap-Platform/LAP)** - ⭐ 223
...
139. **[mcpfp](https://github.com/MauritsWilke/mcpfp)** - ⭐ 221
   A website to generate Minecraft profile pictures

140. **[AuditLuma](https://github.com/Vistaminc/AuditLuma)** - ⭐ 217
   AuditLuma是一个AI+智能体代码审计系统，它利用多个AI代理和先进的技术，包括多代理合作协议（MCP）和Self-RAG（检索增强生成），为代码库提供全面的安全分析，目前已经支持ollama部署的本地大模型

141. **[McPicker-iOS](https://github.com/kmcgill88/McPicker-iOS)** - ⭐ 215
   McPicker is a customizable, closure driven UIPickerView drop-in solution with animations that is rotation ready.

142. **[Toucan](https://github.com/TheAgentArk/Toucan)** - ⭐ 215
   Official repo of Toucan: Synthesizing 1.5M Tool-Agentic Data from Real-World MCP Environments

143. **[weam](https://github.com/weam-ai/weam)** - ⭐ 214
...
144. **[claudemap](https://github.com/QuinnAho/claudemap)** - ⭐ 213
...
147. **[MCP-919](https://github.com/Marcelektro/MCP-919)** - ⭐ 190
   Fully working & decompiled MCP for Minecraft 1.8.9 

148. **[MCPScan](https://github.com/antgroup/MCPScan)** - ⭐ 189

149. **[OnionClaw](https://github.com/christinminor459/OnionClaw)** - ⭐ 180
   Provide AI agents with full Tor network access and dark web data through a zero-config OpenClaw skill or standalone tool.

150. **[structurizr](https://github.com/structurizr/structurizr)** - ⭐ 179
...
157. **[mcp-audit](https://github.com/apisec-inc/mcp-audit)** - ⭐ 148
...
161. **[mcp-toolkit](https://github.com/charIesding/mcp-toolkit)** - ⭐ 137
   utilities for mcp

162. **[Z.ai2api](https://github.com/hmjz100/Z.ai2api)** - ⭐ 134
...
163. **[awesome-ai-repositories](https://github.com/altengineer/awesome-ai-repositories)** - ⭐ 128
   A curated list of open source repositories for AI Engineers

164. **[claude-ipc-mcp](https://github.com/jdez427/claude-ipc-mcp)** - ⭐ 127
   AI-to-AI communication protocol for Claude, Gemini, and other AI assistants

165. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/sdivyanshu90/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 119
   5-Day Gen AI Intensive Course with Google

166. **[agentic-ai](https://github.com/mahmoudrabie/agentic-ai)** - ⭐ 118
...
167. **[coplay-unity-plugin](https://github.com/CoplayDev/coplay-unity-plugin)** - ⭐ 117
   Unity plugin for Coplay

168. **[mcp-in-action](https://github.com/huangjia2019/mcp-in-action)** - ⭐ 116
   极客时间MCP新课已经上线！超2000同学一起开启MCP学习之旅！

169. **[roampal](https://github.com/roampal-ai/roampal)** - ⭐ 116
...
178. **[Manifold](https://github.com/Garume/Manifold)** - ⭐ 102
   Operation-first .NET foundation for generating fast CLI and MCP surfaces from a single definition.

179. **[Squirrel](https://github.com/hakoniwaa/Squirrel)** - ⭐ 92
   ai memory for coding

180. **[yes-ue-mcp](https://github.com/softdaddy-o/yes-ue-mcp)** - ⭐ 84
   Native C++ Model Context Protocol (MCP) plugin for Unreal Engine 5.4+

181. **[TensorBlock-Studio](https://github.com/TensorBlock/TensorBlock-Studio)** - ⭐ 80
   A lightweight, open, and extensible multi-LLM interaction studio.

182. **[Complementarity.jl](https://github.com/chkwon/Complementarity.jl)** - ⭐ 79
   provides a modeling interface for mixed complementarity problems (MCP) and math programs with equilibrium problems (MPEC) via JuMP 

183. **[smart-customer-service-system](https://github.com/traveler-leon/smart-customer-service-system)** - ⭐ 78
   构建一个基于大模型的智能客服系统，可提供静态知识问答(静态数据)、动态知识问答（数据库），业务办理（api调用）等功能，同时系统具有自我学习能力。定期的反思可让系统变得更强大。

184. **[open-skills](https://github.com/besoeasy/open-skills)** - ⭐ 78
   Battle-tested skill library for AI agents. Save 98% of API costs with ready-to-use code for crypto, PDFs, search, web scraping & more. No trial-and-error, no expensive APIs.

185. **[nvim-gemini-companion](https://github.com/gutsavgupta/nvim-gemini-companion)** - ⭐ 77
   A Neovim plugin to integrate Gemini CLI well (+ Qwen-code now)

186. **[quarkus-workshop-langchain4j](https://github.com/quarkusio/quarkus-workshop-langchain4j)** - ⭐ 75
   Quarkus Langchain4J Workshop

187. **[lycoris](https://github.com/solaoi/lycoris)** - ⭐ 75
...
197. **[Wireshark_mcp](https://github.com/jayimu/Wireshark_mcp)** - ⭐ 49
   Wireshark MCP 是一个基于 Model Context Protocol (MCP) 的服务器，允许 AI 助手通过 tshark 命令行工具进行交互。该工具提供了丰富的网络数据分析功能，支持实时抓包和离线分析。

198. **[mcp-java8-sdk](https://github.com/krrr/mcp-java8-sdk)** - ⭐ 48
   Backported Model Context Protocol SDK for Java 8

199. **[velocity](https://github.com/OptimiLabs/velocity)** - ⭐ 41
...
206. **[advanced-reason-mcp](https://github.com/Kuon-dev/advanced-reason-mcp)** - ⭐ 33
   Enhanced version of "Sequential Thinking" MCP

207. **[zentrun](https://github.com/andrewsky-labs/zentrun)** - ⭐ 33
...
210. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

211. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 27
   Build AI Agent using Google ADK , MCP and Gemma 3 model

212. **[shebe](https://github.com/rhobimd-oss/shebe)** - ⭐ 26
   Fast BM25 full-text search for code repositories with MCP integration for AI coding agents.

213. **[codai](https://github.com/codai-agent/codai)** - ⭐ 25
...
214. **[minime-mcp](https://github.com/manujbawa/minime-mcp)** - ⭐ 21
...
215. **[codectx](https://github.com/hey-granth/codectx)** - ⭐ 17
...
216. **[cursor-like-pro](https://github.com/gifflet/cursor-like-pro)** - ⭐ 17
   Cursor IDE like Pro

217. **[n8n-operator](https://github.com/jakub-k-slys/n8n-operator)** - ⭐ 17
   Kubernetes Operator for N8n, a fair-code workflow automation platform with native AI capabilities.

218. **[MCPStack](https://github.com/MCP-Pipeline/MCPStack)** - ⭐ 16
   Stack & Orchestrate MCP Tools — The Scikit-Learn-Pipeline Way , For LLMs

219. **[mcp-labs](https://github.com/thangchung/mcp-labs)** - ⭐ 16
   All things about MCP experiments.⭐️ Star to support our work!

220. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 15
   ai-tools  call your llm based tools through shortcut (ctrl-q) in any application

221. **[ai-agents](https://github.com/rjmurillo/ai-agents)** - ⭐ 14
...
1. **[JavaGuide](https://github.com/Snailclimb/JavaGuide)** - ⭐ 155,522
   Java 面试 & 后端通用面试指南，覆盖计算机基础、数据库、分布式、高并发、系统设计与 AI 应用开发

2. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 13,446
...
3. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 8,059
   Specification and documentation for the Model Context Protocol

4. **[wechatDownload](https://github.com/qiye45/wechatDownload)** - ⭐ 7,582
